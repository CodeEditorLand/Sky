...
import { ChatConfiguration, ChatModeKind, ChatPermissionLevel } from "../../common/constants.js";
...
let ChatWidget = class ChatWidget2 extends Disposable {
  ...
  clickedRequest(item) {
    ...
    if (isRequestVM(currentElement) && !this.viewModel?.editing) {
      ...
      const isEditingSentRequest = currentElement.pendingKind === void 0 ? "s" : currentElement.pendingKind === "queued" ? "q" : "st";
