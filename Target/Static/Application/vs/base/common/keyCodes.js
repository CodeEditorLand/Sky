...
const SCAN_CODE_STR_TO_EVENT_KEY_CODE = {};
const scanCodeIntToStr = [];
const scanCodeStrToInt = /* @__PURE__ */ Object.create(null);
const scanCodeLowerCaseStrToInt = /* @__PURE__ */ Object.create(null);
const ScanCodeUtils = {
  lowerCaseToEnum: /* @__PURE__ */ __name((scanCode) => scanCodeLowerCaseStrToInt[scanCode] || 0, "lowerCaseToEnum"),
  toEnum: /* @__PURE__ */ __name((scanCode) => scanCodeStrToInt[scanCode] || 0, "toEnum"),
...
export {
  ...
  SCAN_CODE_STR_TO_EVENT_KEY_CODE,
  ScanCode,
  ScanCodeUtils,
  isModifierKey
};
