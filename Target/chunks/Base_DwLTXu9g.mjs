import { c as createComponent, s as spreadAttributes, d as renderSlotToString, e as renderAllHeadContent, u as unescapeHTML, r as renderTemplate, a as renderComponent, m as maybeRenderHead, f as renderSlot } from './astro/server_Cdi4o6po.mjs';
import 'kleur/colors';
...
const $$Base = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="en" class="no-js" dir="ltr"> ${renderComponent($$result, "Head", Head, {}, { "default": ($$result2) => renderTemplate`<meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="theme-color" content="#ffffff"><meta name="format-detection" content="telephone=no"><meta name="twitter:dnt" content="on"><link rel="manifest" href="/site.webmanifest" crossorigin="use-credentials">${renderSlot($$result2, $$slots["StyleHead"])}${renderSlot($$result2, $$slots["ScriptHead"])}` })}${maybeRenderHead()}<body aria-label=""> <div class="grow p-5 text-center"> <ul class="flex"> <li class="px-5"> <a href="/Editor">Editor</a> </li> <li class="px-5"> <a href="/VSCode">VSCode</a> </li> </ul> </div> <div class="grow"> ${renderSlot($$result, $$slots["default"])} </div> </body></html>`;
}, "D:/Developer/Application/CodeEditorLand/EcoSystem/Elements/Sky/Source/Layout/Base.astro", void 0);

export { $$Base as $ };
//# sourceMappingURL=Base_DwLTXu9g.mjs.map
