...
import { truncateToFirstSentence } from "./aiCustomizationListWidgetUtils.js";
const $ = DOM.$;
...
${uriLabel}`,
    ...
    const menu = templateData.elementDisposables.add(this.menuService.createMenu(AICustomizationManagementItemMenuId, this.contextKeyService));
...
let AICustomizationListWidget = class AICustomizationListWidget2 extends Disposable {
  ...
  constructor(instantiationService, promptsService, contextViewService, openerService, contextMenuService, menuService, contextKeyService, workspaceContextService, labelService, workspaceService, clipboardService, hoverService, fileService, pathService, telemetryService) {
    super();
    this.instantiationService = instantiationService;
  ...
  onContextMenu(e) {
    ...
    this.contextMenuService.showContextMenu({
      ...
      getActions: /* @__PURE__ */ __name(() => [...secondary, ...copyActions], "getActions")
    });
  }
  /**
