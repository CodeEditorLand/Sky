...
MenuRegistry.appendMenuItem(MenuId.LayoutControlMenu, {
  ...
  when: ContextKeyExpr.and(IsAuxiliaryTitleBarContext.negate(), ContextKeyExpr.equals("config.workbench.layoutControl.type", "menu"))
});
  ...
  constructor() {
    super({
      ...
      menu: [
        ...
        {
          id: MenuId.LayoutControlMenu,
          when: ContextKeyExpr.and(IsAuxiliaryTitleBarContext.toNegated(), ContextKeyExpr.equals("config.workbench.layoutControl.type", "both")),
          group: "1_layout"
        }
      ]
    });
