...
class DOMLineBreaksComputerFactory {
  ...
  createLineBreaksComputer(context, options, tabSize) {
    const lineNumbers = [];
    return {
...
function createLineBreaks(targetWindow, context, lineNumbers, options, tabSize) {
  ...
  const firstLineBreakColumn = options.get(
    166
