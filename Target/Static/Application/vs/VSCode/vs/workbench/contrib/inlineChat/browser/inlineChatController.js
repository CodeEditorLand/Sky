...
let InlineChatController = class InlineChatController2 {
  ...
  async rephraseSession() {
    ...
    const placeholder = selection && !selection.isEmpty() ? localize("placeholderWithSelectionHover", "Describe how to change this") : localize("placeholderNoSelectionHover", "Describe what to generate");
