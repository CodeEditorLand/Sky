...
` +
	...
	function li(e) {
		if (e instanceof Error) {
			...
			return {
				...
				message: n,
				stack: i,
				noTelemetry: Xe.isErrorNoTelemetry(e),
			};
		}
		return e;
	}
	...
	function Aa(e) {
		return e instanceof Sa
			? !0
			: e instanceof Error && e.name === tn && e.message === tn;
	}
	...
	(function (e) {
		...
		function c(R, N) {
			let M = 0;
			for (const _ of R) if (N(_, M++)) return !0;
			return !1;
		}
		e.some = c;
		function d(R, N) {
		...
		e.slice = x;
		function T(R, N = Number.POSITIVE_INFINITY) {
			const M = [];
			if (N === 0) return [M, R];
			const _ = R[Symbol.iterator]();
			for (let p = 0; p < N; p++) {
				const k = _.next();
				if (k.done) return [M, e.empty()];
				M.push(k.value);
			}
			return [
				M,
	...
	ht.None = Object.freeze({ dispose() {} });
	let Q = class ai {
		constructor(t) {
			(this.element = t),
				(this.next = ai.Undefined),
				(this.prev = ai.Undefined);
		}
	};
	...
	(function (e) {
		e.None = () => ht.None;
		function t(v, b) {
			return d(v, () => {}, 0, void 0, !0, void 0, b);
		}
		e.defer = t;
		function n(v) {
			return (b, E = null, y) => {
				...
				return (
					(D = v(
						(I) => {
							if (!S)
								return D ? D.dispose() : (S = !0), b.call(E, I);
						},
						null,
						y,
					)),
		...
		e.once = n;
		function i(v, b, E) {
			return l((y, S = null, D) => v((I) => y.call(S, b(I)), null, D), E);
		}
		e.map = i;
		function r(v, b, E) {
			return l(
		...
		function s(v, b, E) {
			return l(
				(y, S = null, D) => v((I) => b(I) && y.call(S, I), null, D),
				E,
			);
		}
		e.filter = s;
		...
		function u(...v) {
			return (b, E = null, y) => {
				const S = Ca(...v.map((D) => D((I) => b.call(E, I))));
				return c(S, y);
			};
		}
		e.any = u;
		...
		function l(v, b) {
			...
			const y = {
				...
				S = new _e(y);
			return b?.add(S), S.event;
		}
		function c(v, b) {
			return b instanceof Array ? b.push(v) : b && b.add(v), v;
		}
		function d(v, b, E = 100, y = !1, S = !1, D, I) {
			let P,
				U,
				W,
				G = 0,
		...
		e.latch = f;
		function w(v, b, E) {
			return [e.filter(v, b, E), e.filter(v, (y) => !b(y), E)];
		}
		e.split = w;
		function g(v, b = !1, E = [], y) {
			let S = E.slice(),
				D = v((U) => {
					S ? S.push(U) : P.fire(U);
				});
			y && y.add(D);
			const I = () => {
					S?.forEach((U) => P.fire(U)), (S = null);
				},
				P = new _e({
					onWillAddFirstListener() {
						D || ((D = v((U) => P.fire(U))), y && y.add(D));
					},
		...
		class T {
			...
			forEach(b) {
				return this.steps.push((E) => (b(E), E)), this;
			}
			filter(b) {
				return this.steps.push((E) => (b(E) ? E : x)), this;
			}
			reduce(b, E) {
				let y = E;
				return this.steps.push((S) => ((y = b(y, S)), y)), this;
			}
			latch(b = (E, y) => E === y) {
				let E = !0,
					y;
				return (
					this.steps.push((S) => {
						const D = E || !b(S, y);
						return (E = !1), (y = S), D ? S : x;
					}),
					this
				);
			}
			evaluate(b) {
				for (const E of this.steps) if (((b = E(b)), b === x)) break;
				return b;
			}
		}
		function C(v, b, E = (y) => y) {
			const y = (...P) => I.fire(E(...P)),
				S = () => v.on(b, y),
				D = () => v.removeListener(b, y),
				I = new _e({
					onWillAddFirstListener: S,
					onDidRemoveLastListener: D,
				});
			return I.event;
		}
		e.fromNodeEventEmitter = C;
		function R(v, b, E = (y) => y) {
			const y = (...P) => I.fire(E(...P)),
				S = () => v.addEventListener(b, y),
				D = () => v.removeEventListener(b, y),
				I = new _e({
					onWillAddFirstListener: S,
					onDidRemoveLastListener: D,
				});
		...
		class p {
			constructor(b, E) {
				...
				(this.emitter = new _e(y)), E && E.add(this.emitter);
			}
			beginUpdate(b) {
				this._counter++;
			}
		...
		function k(v, b) {
			return new p(v, b).emitter.event;
		}
		e.fromObservable = k;
		function H(v) {
			return (b, E, y) => {
				...
				const I = {
					...
					endUpdate() {
						S--,
							S === 0 &&
								(v.reportChanges(), D && ((D = !1), b.call(E)));
					},
				...
				return (
					y instanceof Je ? y.add(P) : Array.isArray(y) && y.push(P),
					P
				);
			};
		}
	...
	(Qe.all = new Set()), (Qe._idPool = 0);
	let Ma = -1;
	class Et {
		constructor(t, n, i = (Et._idPool++).toString(16).padStart(3, "0")) {
	...
	class rn {
		static create() {
			var t;
			const n = new Error();
			return new rn((t = n.stack) !== null && t !== void 0 ? t : "");
		}
		constructor(t) {
			this.value = t;
		}
...
`),
	...
	class _e {
		constructor(t) {
			...
			(this._size = 0),
				...
				(this._perfMon =
					...
					a._profName
						? new Qe(this._options._profName)
						: void 0),
				(this._deliveryQueue =
				...
				((t = this._event) !== null && t !== void 0) ||
					(this._event = (n, i, r) => {
						...
						if (
							...
							const A =
									(s =
										this._leakageMon.getMostFrequentStack()) !==
										null && s !== void 0
										? s
										: ["UNKNOWN stack", -1],
								x = new Da(
									`${g}. HINT: Stack shows most frequent listener (${A[1]}-times)`,
									A[0],
								);
							return (
								(
						...
						this._leakageMon &&
							...
							((m.stack = rn.create()),
							(f = this._leakageMon.check(
								m.stack,
								this._size + 1,
							))),
							this._listeners
								? this._listeners instanceof sn
									? (((d = this._deliveryQueue) !== null &&
											d !== void 0) ||
							...
							this._size++;
						const w = Lt(() => {
							f?.(), this._removeListener(m);
						});
						return (
							r instanceof Je
								? r.add(w)
								: Array.isArray(r) && r.push(w),
							w
						);
					}),
				this._event
		...
		fire(t) {
			...
			if (
				...
				if (this._listeners instanceof sn)
					this._deliver(this._listeners, t);
				else {
					const a = this._deliveryQueue;
					a.enqueue(this, t, this._listeners.length),
						this._deliverQueue(a);
				}
	...
	typeof Oe.vscode < "u" && typeof Oe.vscode.process < "u"
		? (ae = Oe.vscode.process)
		: typeof process < "u" &&
			typeof ((on = process == null ? void 0 : process.versions) ===
				null || on === void 0
				? void 0
				: on.node) == "string" &&
			(ae = process);
	const qa =
		typeof ((ln = ae?.versions) === null || ln === void 0
			? void 0
			: ln.electron) == "string" && ae?.type === "renderer";
	if (typeof ae == "object") {
		(un = ae.platform === "win32"),
			(cn = ae.platform === "darwin"),
			(hn = ae.platform === "linux"),
			hn && ae.env.SNAP && ae.env.SNAP_REVISION,
		...
		typeof navigator == "object" && !qa
			? ((we = navigator.userAgent),
				...
				(Rt = Ye),
				(dn = Rt),
				(ci = navigator.language))
			: console.error("Unable to resolve platform.");
	const dt = un,
		Oa = cn,
		Se = we,
		Va = typeof Oe.postMessage == "function" && !Oe.importScripts;
	(() => {
		if (Va) {
			const e = [];
	...
	const ja = !!(Se && Se.indexOf("Chrome") >= 0);
	Se && Se.indexOf("Firefox") >= 0,
		!ja && Se && Se.indexOf("Safari") >= 0,
		Se && Se.indexOf("Edg/") >= 0,
		Se && Se.indexOf("Android") >= 0;
	function Ga(e) {
		return e;
	}
	class $a {
	...
	(Ze = Ve),
		(Ve.ambiguousCharacterData = new hi(() =>
			JSON.parse(
		...
		(Ve.cache = new $a({ getCacheKey: JSON.stringify }, (e) => {
			function t(l) {
				const c = new Map();
		...
		(Ve._locales = new hi(() =>
			Object.keys(Ze.ambiguousCharacterData.value).filter(
				(e) => !e.startsWith("_"),
			),
		));
	class De {
		...
		static getData() {
			return (
				this._data || (this._data = new Set(De.getRawData())),
				this._data
			);
		}
	...
	class lo {
		...
		_handleRequestMessage(t) {
			...
			this._handler.handleMessage(t.method, t.args).then(
				(r) => {
					this._send(new mi(this._workerId, n, r, void 0));
				},
				(r) => {
					r.detail instanceof Error && (r.detail = li(r.detail)),
						this._send(new mi(this._workerId, n, void 0, li(r)));
				},
			);
		}
				...
				: (n &&
					...
					new Promise((o, l) => {
						...
						c(
							...
							(d) => {
								if (
									((this._requestHandler = d.create(u)),
									!this._requestHandler)
								) {
	...
	function ho(e, t) {
		t = gi(149417, t);
		for (let n = 0, i = e.length; n < i; n++) t = gi(e.charCodeAt(n), t);
		return t;
	}
	class bi {
		constructor(t) {
	...
	function mo(e, t, n) {
		return new ze(new bi(e), new bi(t)).ComputeDiff(n).changes;
	}
	class Ke {
		static Assert(t, n) {
	...
	class ze {
		constructor(t, n, i = null) {
			...
			const [r, s, a] = ze._getElements(t),
				[u, o, l] = ze._getElements(n);
		...
		ElementsAreStrictEqual(t, n) {
			...
			const i = ze._getStrictElement(this._originalSequence, t),
				r = ze._getStrictElement(this._modifiedSequence, n);
			return i === r;
		}
		...
		_ComputeDiff(t, n, i, r, s) {
			...
			return (
				s && (u = this.PrettifyChanges(u)),
				{ quitEarly: a[0], changes: u }
			);
		}
		ComputeDiffRecursive(t, n, i, r, s) {
			...
			return [new Ie(t, n - t + 1, i, r - i + 1)];
		}
		WALKTRACE(t, n, i, r, s, a, u, o, l, c, d, m, f, w, g, A, x, T) {
			let C = null,
				R = null,
				N = new _i(),
				M = n,
			...
			if (((C = N.getReverseChanges()), T[0])) {
				let v = f[0] + 1,
					b = A[0] + 1;
				if (C !== null && C.length > 0) {
					const E = C[C.length - 1];
					(v = Math.max(v, E.getOriginalEnd())),
						(b = Math.max(b, E.getModifiedEnd()));
				}
				R = [new Ie(v, m - v + 1, b, g - b + 1)];
			} else {
				(N = new _i()),
					(M = a),
					(_ = u),
			...
			return this.ConcatenateChanges(C, R);
		}
		ComputeRecursionPoint(t, n, i, r, s, a, u) {
			...
			for (let p = 1; p <= w / 2 + 1; p++) {
				...
				for (let b = c; b <= d; b += 2) {
					...
					for (
						;
						o < n && l < r && this.ElementsAreEqual(o + 1, l + 1);
					)
						o++, l++;
					if (
						((A[b] = o),
						o + l > k + H && ((k = o), (H = l)),
						!_ && Math.abs(b - C) <= p - 1 && o >= x[b])
					)
						return (
							(s[0] = o),
							(a[0] = l),
				...
				if (
					...
					return (
						...
						v > 0 && p <= 1448
							...
							: (t++, i++, [new Ie(t, n - t + 1, i, r - i + 1)])
					);
				(m = this.ClipDiagonalBound(C - p, p, C, g)),
					(f = this.ClipDiagonalBound(C + p, p, C, g));
				for (let b = m; b <= f; b += 2) {
					b === m || (b < f && x[b - 1] >= x[b + 1])
						? (o = x[b + 1] - 1)
						: (o = x[b - 1]),
					...
					for (; o > t && l > i && this.ElementsAreEqual(o, l); )
						o--, l--;
					if (((x[b] = o), _ && Math.abs(b - T) <= p && o <= A[b]))
						return (
							(s[0] = o),
							(a[0] = l),
							E >= A[b] && p <= 1448
				...
				if (p <= 1447) {
					let b = new Int32Array(d - c + 2);
					(b[0] = T - c + 1),
						et.Copy2(A, c, b, 1, d - c + 1),
						this.m_forwardHistory.push(b),
						(b = new Int32Array(f - m + 2)),
						(b[0] = C - m + 1),
						et.Copy2(x, m, b, 1, f - m + 1),
		...
		PrettifyChanges(t) {
			for (let n = 0; n < t.length; n++) {
				...
				if (
					n < t.length - 1 &&
					this.ChangesOverlap(t[n], t[n + 1], o)
				) {
		...
		ConcatenateChanges(t, n) {
			...
			if (this.ChangesOverlap(t[t.length - 1], n[0], i)) {
				...
				return (
					et.Copy(t, 0, r, 0, t.length - 1),
					(r[t.length - 1] = i[0]),
					et.Copy(n, 1, r, t.length, n.length - 1),
					r
				);
			} else {
				const r = new Array(t.length + n.length);
				return (
					et.Copy(t, 0, r, 0, t.length),
					et.Copy(n, 0, r, t.length, n.length),
					r
				);
			}
		}
	...
	if (typeof fn < "u" && typeof fn.process < "u") {
		...
		typeof process < "u"
			? (tt = {
					...
					cwd() {
						return wi.VSCODE_CWD || process.cwd();
					},
				})
			: (tt = {
					get platform() {
						return dt ? "win32" : Oa ? "darwin" : "linux";
					},
					get arch() {},
					get env() {
						return {};
	...
	function yo(e, t) {
		if (e === null || typeof e != "object") throw new vi(t, "Object", e);
	}
	function K(e, t) {
		if (typeof e != "string") throw new vi(t, "string", e);
	}
	const We = po === "win32";
	function q(e) {
		return e === re || e === ue;
				...
				if (!(a === l - 1 || u === 1))
					if (u === 2) {
						if (
							r.length < 2 ||
							s !== 2 ||
							r.charCodeAt(r.length - 1) !== He ||
							r.charCodeAt(r.length - 2) !== He
						) {
							if (r.length > 2) {
	...
	const oe = {
			...
			parse(e) {
				...
				} else if (Fe(r) && e.charCodeAt(1) === Ue) {
	...
	(ce.win32 = oe.win32 = oe),
		...
		We ? oe.normalize : ce.normalize,
		We ? oe.resolve : ce.resolve,
		We ? oe.relative : ce.relative,
		We ? oe.dirname : ce.dirname,
		We ? oe.basename : ce.basename,
		We ? oe.extname : ce.extname,
		We ? oe.sep : ce.sep;
	const To = /^\w[\w\d+.-]*$/,
		ko = /^\//,
		Ao = /^\/\//;
	...
	let gn = class en {
		...
		static file(t) {
			let n = J;
			if (
				(dt && (t = t.replace(/\\/g, ve)), t[0] === ve && t[1] === ve)
			) {
		...
		static joinPath(t, ...n) {
			...
			return (
				dt && t.scheme === "file"
					? (i = en.file(oe.join(bn(t, !0), ...n)).path)
					: (i = ce.join(t.path, ...n)),
				t.with({ path: i })
			);
		}
	...
	class nt extends gn {
		...
		toString(t = !1) {
			return t
				? _n(this, !0)
				: (this._formatted || (this._formatted = _n(this, !1)),
					this._formatted);
		}
		toJSON() {
			const t = { $mid: 1 };
			return (
				this._fsPath && ((t.fsPath = this._fsPath), (t._sep = xi)),
	...
	function Ro(e) {
		...
		for (let n = 0; n < e.length; n++) {
			const i = e.charCodeAt(n);
			i === 35 || i === 63
				? (t === void 0 && (t = e.substr(0, n)), (t += Ti[i]))
				: t !== void 0 && (t += e[n]);
		}
		return t !== void 0 ? t : e;
	}
	...
	function Ai(e) {
		try {
			...
			return e.length > 3 ? e.substr(0, 3) + Ai(e.substr(3)) : e;
		}
	}
	const Si = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
	function Dt(e) {
		return e.match(Si) ? e.replace(Si, (t) => Ai(t)) : e;
	}
	let Le = class $e {
			constructor(t, n) {
	...
	class Uo {
		...
		getPrefixSum(t) {
			return t < 0 ? 0 : ((t = it(t)), this._getPrefixSum(t));
		}
		_getPrefixSum(t) {
			...
			for (const i of n)
				this._acceptDeleteRange(i.range),
					this._acceptInsertText(
						new Le(i.range.startLineNumber, i.range.startColumn),
						i.text,
					);
	...
	const Mi = new Ea();
	Mi.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
	function wn(e, t, n, i, r) {
		if (((t = Ri(t)), r || (r = St.first(Mi)), n.length > r.maxLen)) {
			let l = e - r.maxLen / 2;
			return (
				l < 0 ? (l = 0) : (i += l),
	...
	class vn {
		constructor(t) {
			...
			(this._defaultValue = n),
				(this._asciiMap = vn._createAsciiMap(n)),
				(this._map = new Map());
		}
	...
	function Go() {
		if (mt === null) {
			mt = new vn(0);
			const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`;
			for (let n = 0; n < e.length; n++) mt.set(e.charCodeAt(n), 1);
			const t = ".,;:";
			for (let n = 0; n < t.length; n++) mt.set(t.charCodeAt(n), 2);
		}
		return mt;
	}
	class Ht {
			...
			for (let s = 1, a = t.getLineCount(); s <= a; s++) {
				...
				for (; l < o; ) {
					...
					if (m === 13) {
						...
						C === 1 &&
							(r.push(Ht._createLink(i, u, s, c, l)), (x = !0));
					} else if (m === 12) {
						let C;
						T === 91 ? ((w = !0), (C = 0)) : (C = i.get(T)),
							C === 1 ? (x = !0) : (m = 13);
				...
				m === 13 && r.push(Ht._createLink(i, u, s, c, o));
			}
			return r;
		}
	}
	...
	xn.INSTANCE = new xn();
	const Ni = Object.freeze(function (e, t) {
	...
	(function (e) {
		function t(n) {
			return n === e.None || n === e.Cancelled || n instanceof Wt
				? !0
				: !n || typeof n != "object"
					? !1
	...
	class Wt {
		...
		get onCancellationRequested() {
			return this._isCancelled
				? Ni
				: (this._emitter || (this._emitter = new _e()),
					this._emitter.event);
		}
		dispose() {
	...
	class Xo {
		...
		cancel() {
			this._token
				? this._token instanceof Wt && this._token.cancel()
				: (this._token = Ut.Cancelled);
		}
		dispose(t = !1) {
			var n;
			t && this.cancel(),
				(n = this._parentListener) === null ||
					n === void 0 ||
					n.dispose(),
				this._token
					? this._token instanceof Wt && this._token.dispose()
					: (this._token = Ut.None);
		}
	}
	class Tn {
	...
	(function () {
		...
		for (const r of t) {
			...
			if (
				(i[a] || ((i[a] = !0), (Qo[u] = a), (Yo[u.toLowerCase()] = a)),
				!n[o])
			) {
				if (((n[o] = !0), !l))
					throw new Error(
	...
	(function (e) {
		function t(u) {
			return Ft.keyCodeToStr(u);
		}
		e.toString = t;
		function n(u) {
			return Ft.strToKeyCode(u);
		}
		e.fromString = n;
		function i(u) {
		...
		function s(u) {
			return kn.strToKeyCode(u) || An.strToKeyCode(u);
		}
			...
			do {
				...
				if (
					...
					!this._wordSeparators ||
						hl(this._wordSeparators, t, n, r, s))
				)
					return i;
			} while (i);
			return null;
	...
	class fl {
		static computeUnicodeHighlights(t, n, i) {
			...
			let d = !1,
				...
				w = 0,
				g = 0;
			e: for (let A = r, x = s; A <= x; A++) {
				const T = t.getLineContent(A),
					C = T.length;
				l.reset(0);
				do
					if (((m = l.next(T)), m)) {
						...
						if (N + 1 < C) {
							const k = T.charCodeAt(N - 1);
							mn(k) && N++;
						}
						const M = T.substring(R, N);
						let _ = wn(R + 1, Ei, T, 0);
						_ && _.endColumn <= R + 1 && (_ = null);
						const p = a.shouldHighlightNonBasicASCII(
							M,
							_ ? _.word : null,
						);
						if (p !== 0) {
			...
			switch (i.shouldHighlightNonBasicASCII(t, null)) {
				...
				case 3: {
					const s = t.codePointAt(0),
						...
						u = Ve.getLocales().filter(
							(o) =>
								!Ve.getInstance(
									new Set([...n.allowedLocales, o]),
								).isAmbiguous(s),
						);
					return {
						kind: 0,
	...
	class Pr {
		constructor(t) {
			(this.options = t),
				...
				(this.ambiguousCharacters = Ve.getInstance(
		...
		getCandidateCodePoints() {
			...
			if (this.options.invisibleCharacters)
				for (const n of De.codePoints)
					Br(String.fromCodePoint(n)) || t.add(n);
...
` ||
	...
	function pt(e, t, n = 0, i = e.length) {
		let r = n,
			s = i;
		for (; r < s; ) {
	...
	function Rn(e, t, n = 0, i = e.length) {
		let r = n,
			s = i;
		for (; r < s; ) {
			const a = Math.floor((r + s) / 2);
	...
	class gt {
		...
		findLastMonotonous(t) {
			...
			const n = pt(this._array, t, this._findLastMonotonousLastIdx);
			return (
		...
		getIntersection(t) {
			...
			for (
				...
				u && !u.isEmpty && n.push(u),
					s.endLineNumberExclusive < a.endLineNumberExclusive
						? i++
						: r++;
			}
			return new Ce(n);
	...
	class Re extends ye {
		static fromRangeMappings(t) {
			const n = O.join(
					t.map((r) => O.fromRangeInclusive(r.originalRange)),
				),
		...
		withInnerChangesFromLineRanges() {
			return new Re(this.original, this.modified, [
				this.toRangeMapping(),
			]);
		}
	}
	...
	class vl {
		computeDiff(t, n, i) {
			...
			return (
				...
				new Bt(u, [], a.quitEarly)
			);
		}
	}
	function qr(e, t, n, i) {
		return new ze(e, t, n).ComputeDiff(i);
	}
	let Or = class {
		constructor(t) {
			const n = [],
		...
		createCharSequence(t, n, i) {
			...
			for (let o = n; o <= i; o++) {
				...
				for (let m = c; m < d; m++)
					(r[u] = l.charCodeAt(m - 1)),
						(s[u] = o + 1),
						(a[u] = m),
						u++;
				!t &&
					o < i &&
					((r[u] = 10), (s[u] = o + 1), (a[u] = l.length + 1), u++);
			}
			return new yl(r, s, a);
		}
	};
		...
		static createFromDiffResult(t, n, i, r, s, a, u) {
			...
			if (
				...
				if (f.getElements().length > 0 && w.getElements().length > 0) {
					...
					u && (g = xl(g)), (m = []);
					for (let A = 0, x = g.length; A < x; A++)
						m.push(st.createFromDiffChange(g[A], f, w));
				}
			}
			return new bt(o, l, c, d, m);
		}
	}
	class Tl {
		constructor(t, n, i) {
			(this.shouldComputeCharChanges = i.shouldComputeCharChanges),
				...
				(this.original = new Or(t)),
				(this.modified = new Or(n)),
				(this.continueLineDiff = Vr(i.maxComputationTime)),
				(this.continueCharDiff = Vr(
		...
		_pushTrimWhitespaceCharChange(t, n, i, r, s, a, u) {
			...
			let o;
			this.shouldComputeCharChanges &&
				(o = [new st(n, i, n, r, s, a, s, u)]),
				t.push(new bt(n, n, s, s, o));
		}
		_mergeTrimWhitespaceCharChange(t, n, i, r, s, a, u) {
			const o = t.length;
			if (o === 0) return !1;
			const l = t[o - 1];
			return l.originalEndLineNumber === 0 ||
				l.modifiedEndLineNumber === 0
				? !1
				: l.originalEndLineNumber === n && l.modifiedEndLineNumber === s
					? (this.shouldComputeCharChanges &&
							l.charChanges &&
							l.charChanges.push(new st(n, i, n, r, s, a, s, u)),
						!0)
	...
	class Me {
		static trivial(t, n) {
			return new Me(
				[new Z(V.ofLength(t.length), V.ofLength(n.length))],
				!1,
			);
		}
...
`);
	...
	at.chrKeys = new Map();
	class Al {
		compute(t, n, i = _t.instance, r) {
			if (t.length === 0 || n.length === 0) return Me.trivial(t, n);
			const s = new Dn(t.length, n.length),
				a = new Dn(t.length, n.length),
				u = new Dn(t.length, n.length);
			for (let w = 0; w < t.length; w++)
				for (let g = 0; g < n.length; g++) {
					if (!i.isValid()) return Me.trivialTimedOut(t, n);
					const A = w === 0 ? 0 : s.get(w - 1, g),
						x = g === 0 ? 0 : s.get(w, g - 1);
					let T;
					t.getElement(w) === n.getElement(g)
						? (w === 0 || g === 0
							...
							(T += r ? r(w, g) : 1))
						: (T = -1);
					const C = Math.max(A, x, T);
					if (C === T) {
						const R = w > 0 && g > 0 ? u.get(w - 1, g - 1) : 0;
						u.set(w, g, R + 1), a.set(w, g, 3);
					} else
						C === A
							? (u.set(w, g, 0), a.set(w, g, 1))
							: C === x && (u.set(w, g, 0), a.set(w, g, 2));
					s.set(w, g, C);
				}
			const o = [];
			let l = t.length,
			...
			for (; m >= 0 && f >= 0; )
				a.get(m, f) === 3
					...
					: a.get(m, f) === 1
						? m--
						: f--;
			return d(-1, -1), o.reverse(), new Me(o, !1);
		}
	}
	class jr {
		compute(t, n, i = _t.instance) {
			if (t.length === 0 || n.length === 0) return Me.trivial(t, n);
			const r = t,
				s = n;
			function a(g, A) {
			...
			o.set(0, a(0, 0));
			const l = new Ll();
			l.set(0, o.get(0) === 0 ? null : new Gr(null, 0, 0, o.get(0)));
			let c = 0;
			e: for (;;) {
				if ((u++, !i.isValid())) return Me.trivialTimedOut(r, s);
				const g = -Math.min(u, s.length + (u % 2)),
					A = Math.min(u, r.length + (u % 2));
				for (c = g; c <= A; c += 2) {
					const x = c === A ? -1 : o.get(c + 1),
						T = c === g ? -1 : o.get(c - 1) + 1,
						C = Math.min(Math.max(x, T), r.length),
						R = C - c;
					if (C > r.length || R > s.length) continue;
					const N = a(C, R);
					o.set(c, N);
					const M = C === x ? l.get(c + 1) : l.get(c - 1);
					if (
						(l.set(c, N !== C ? new Gr(M, C, R, N - C) : M),
			...
			for (;;) {
				...
				if (
					((g !== f || A !== w) &&
						m.push(new Z(new V(g, f), new V(A, w))),
					!d)
				)
					break;
				(f = d.x), (w = d.y), (d = d.prev);
			}
			return m.reverse(), new Me(m, !1);
		}
	}
	class Gr {
		constructor(t, n, i, r) {
	...
	class qt {
		...
		getBoundaryScore(t) {
			const n = Xr(t > 0 ? this.elements[t - 1] : -1),
				i = Xr(t < this.elements.length ? this.elements[t] : -1);
			if (n === 7 && i === 8) return 0;
			if (n === 8) return 150;
			let r = 0;
			return (
		...
		translateOffset(t) {
			if (this.lineRange.isEmpty)
				return new Le(this.lineRange.start + 1, 1);
			const n = pt(this.firstCharOffsetByLine, (i) => i <= t);
			return new Le(
				this.lineRange.start + n + 1,
				t -
					this.firstCharOffsetByLine[n] +
					this.additionalOffsetByLine[n] +
					1,
			);
		}
		translateRange(t) {
		...
		findWordContaining(t) {
			if (t < 0 || t >= this.elements.length || !zn(this.elements[t]))
				return;
			let n = t;
			for (; n > 0 && zn(this.elements[n - 1]); ) n--;
			let i = t;
			for (; i < this.elements.length && zn(this.elements[i]); ) i++;
			return new V(n, i);
		}
		countLinesIn(t) {
			return (
...
`).length >= 15 && Rl(d, (f) => f.length >= 2) >= 2
	...
	function Ml(e, t, n, i) {
		const r = [],
			s = e
				...
				.map((o) => new at(o.original, t, o)),
			a = new Set(
				e
					.filter((o) => o.original.isEmpty && o.modified.length >= 3)
					.map((o) => new at(o.modified, n, o)),
			),
			u = new Set();
		for (const o of s) {
			let l = -1,
	...
	function Nl(e, t, n, i, r, s) {
		...
		const o = [];
		e.sort(It((m) => m.modified.startLineNumber, zt));
		for (const m of e) {
			let f = [];
			for (
				...
				u.forEach(g, ({ range: T }) => {
					for (const R of f)
						if (
							...
							(R.originalLineRange = new O(
								R.originalLineRange.startLineNumber,
								T.endLineNumberExclusive,
							)),
								(R.modifiedLineRange = new O(
					...
					const C = { modifiedLineRange: A, originalLineRange: T };
					o.push(C), x.push(C);
				}),
					(f = x);
			}
		...
		o.sort(Ho(It((m) => m.modifiedLineRange.length, zt)));
		const l = new Ce(),
			c = new Ce();
		for (const m of o) {
			const f =
				...
				A = w.getIntersection(g);
			for (const x of A.ranges) {
				if (x.length < 3) continue;
				const T = x,
					C = x.delta(-f);
				a.push(new ye(C, T)), l.addRange(T), c.addRange(C);
			}
		}
		a.sort(It((m) => m.original.startLineNumber, zt));
		const d = new gt(e);
		for (let m = 0; m < a.length; m++) {
			...
			for (R = 0; R < A; R++) {
				const M = f.original.startLineNumber - R - 1,
					_ = f.modified.startLineNumber - R - 1;
				if (
					M > i.length ||
					_ > r.length ||
					l.contains(_) ||
			...
			for (N = 0; N < C; N++) {
				const M = f.original.endLineNumberExclusive + N,
					_ = f.modified.endLineNumberExclusive + N;
				if (
					M > i.length ||
					_ > r.length ||
					l.contains(_) ||
	...
	function Jr(e, t, n) {
		...
		const r = new jr().compute(
			new qt([e], new V(0, 1), !1),
			new qt([t], new V(0, 1), !1),
			n,
		);
		let s = 0;
		...
		function u(c) {
			let d = 0;
			for (let m = 0; m < e.length; m++) In(c.charCodeAt(m)) || d++;
			return d;
		}
	...
	function Dl(e) {
		...
		e.sort(It((n) => n.original.startLineNumber, zt));
		const t = [e[0]];
	...
	function Qr(e, t, n) {
		let i = n;
		return (i = Yr(e, t, i)), (i = Yr(e, t, i)), (i = zl(e, t, i)), i;
	}
	function Yr(e, t, n) {
	...
	function Ul(e, t, n) {
		...
		function a(o, l) {
			...
			for (; i.length > 0; ) {
				...
				if (
					!(
						A.seq1Range.intersects(m.seq1Range) ||
						A.seq2Range.intersects(m.seq2Range)
					)
				)
					break;
				const T = e.findWordContaining(A.seq1Range.start),
					C = t.findWordContaining(A.seq2Range.start),
					R = new Z(T, C),
					N = R.intersect(A);
				if (
					...
					(m = m.join(R)),
					m.seq1Range.endExclusive >= A.seq1Range.endExclusive)
				)
					i.shift();
				else break;
			}
	...
	function Pl(e, t, n) {
		...
		do {
			...
			for (let o = 1; o < i.length; o++) {
				let d = function (f, w) {
					...
					return (
						Math.pow(
							Math.pow(v(T * 40 + C), 1.5) +
								Math.pow(v(R * 40 + N), 1.5),
							1.5,
						) +
							Math.pow(
								Math.pow(v(M * 40 + _), 1.5) +
									Math.pow(v(p * 40 + k), 1.5),
								1.5,
							) >
						(H ** 1.5) ** 1.5 * 1.3
					);
		...
		return (
			Io(i, (u, o, l) => {
				...
				const w = e.getText(
					new V(o.seq1Range.endExclusive, m.endExclusive),
				);
				...
				const g = Z.fromOffsetPairs(
					...
					A = c.intersect(g);
				a.length > 0 &&
				A.getStarts().equals(a[a.length - 1].getEndExclusives())
					? (a[a.length - 1] = a[a.length - 1].join(A))
					: a.push(A);
			}),
			a
		);
	...
	class Kr {
		...
		getBoundaryScore(t) {
			const n = t === 0 ? 0 : es(this.lines[t - 1]),
				i = t === this.lines.length ? 0 : es(this.lines[t]);
			return 1e3 - (n + i);
		}
		getText(t) {
...
`);
	...
	class Bl {
		...
		computeDiff(t, n, i) {
			...
			if (
				...
				return new Bt(
					[
						new Re(new O(1, t.length + 1), new O(1, n.length + 1), [
							new Pe(
								new Y(
									1,
									1,
			...
			function u(N) {
				let M = a.get(N);
				return M === void 0 && ((M = a.size), a.set(N, M)), M;
			}
			const o = t.map((N) => u(N.trim())),
				l = n.map((N) => u(N.trim())),
				c = new Kr(o, t),
				d = new Kr(l, n),
				m =
			...
			let x = 0,
				T = 0;
			for (const N of f) {
				Pt(() => N.seq1Range.start - x === N.seq2Range.start - T);
				const M = N.seq1Range.start - x;
				A(M),
					(x = N.seq1Range.endExclusive),
					(T = N.seq2Range.endExclusive);
				const _ = this.refineDiff(t, n, N, r, s);
				_.hitTimeout && (w = !0);
				for (const p of _.mappings) g.push(p);
			}
			A(t.length - x);
			const C = ts(g, t, n);
			let R = [];
			return (
				i.computeMoves && (R = this.computeMoves(C, t, n, o, l, r, s)),
				Pt(() => {
					function N(_, p) {
						if (_.lineNumber < 1 || _.lineNumber > p.length)
							return !1;
						const k = p[_.lineNumber - 1];
						return !(_.column < 1 || _.column > k.length + 1);
					}
					function M(_, p) {
						return !(
							_.startLineNumber < 1 ||
							_.startLineNumber > p.length + 1 ||
							_.endLineNumberExclusive < 1 ||
							_.endLineNumberExclusive > p.length + 1
						);
					}
					for (const _ of C) {
						...
						for (const p of _.innerChanges)
							if (
								...
								return !1;
						if (!M(_.modified, n) || !M(_.original, t)) return !1;
					}
					return !0;
				}),
				new Bt(C, R, w)
		...
		computeMoves(t, n, i, r, s, a, u) {
			return El(t, n, i, r, s, a).map((c) => {
				const d = this.refineDiff(
					...
					m = ts(d.mappings, n, i, !0);
				return new gl(c, m);
			});
		}
		refineDiff(t, n, i, r, s) {
			const a = new qt(t, i.seq1Range, s),
				u = new qt(n, i.seq2Range, s),
				o =
	...
	const ns = { getLegacy: () => new vl(), getDefault: () => new Bl() };
	function Be(e, t) {
	...
	class ne {
		constructor(t, n, i, r = 1) {
			(this._rgbaBrand = void 0),
				...
				(this.a = Be(Math.max(Math.min(1, r), 0), 3));
		}
		static equals(t, n) {
	...
	class ge {
		constructor(t, n, i, r) {
			(this._hslaBrand = void 0),
				...
				(this.s = Be(Math.max(Math.min(1, n), 0), 3)),
				(this.l = Be(Math.max(Math.min(1, i), 0), 3)),
				(this.a = Be(Math.max(Math.min(1, r), 0), 3));
		}
		static equals(t, n) {
	...
	class ot {
		constructor(t, n, i, r) {
			(this._hsvaBrand = void 0),
				(this.h = Math.max(Math.min(360, t), 0) | 0),
				(this.s = Be(Math.max(Math.min(1, n), 0), 3)),
				(this.v = Be(Math.max(Math.min(1, i), 0), 3)),
				(this.a = Be(Math.max(Math.min(1, r), 0), 3));
		}
		static equals(t, n) {
				...
				u === 0
					...
					: s === n
						...
						: s === i
							? (l = (r - n) / u + 2)
							: (l = (n - i) / u + 4),
				new ot(Math.round(l * 60), o, s, t.a)
			);
		}
		static toRGBA(t) {
		...
		constructor(t) {
			if (t)
				if (t instanceof ne) this.rgba = t;
					...
					(this._hsla = t), (this.rgba = ge.toRGBA(t));
				...
				(function (n) {
					...
					function l(f, w = !1) {
						return w && f.rgba.a === 1
							...
							: `#${u(f.rgba.r)}${u(f.rgba.g)}${u(f.rgba.b)}${u(Math.round(f.rgba.a * 255))}`;
					}
					n.formatHexA = l;
					function c(f) {
						return f.isOpaque()
						...
						if (w === 9) {
							const g =
								...
								T =
									16 * m(f.charCodeAt(7)) +
									m(f.charCodeAt(8));
							return new e(new ne(g, A, x, T / 255));
						}
						if (w === 4) {
	...
	function rs(e, t, n) {
		...
		const r = t[0].values(),
			s = is(r);
		return { range: e, color: Hn(s[0], s[1], s[2], n ? s[3] : 1) };
	}
	function ss(e, t, n) {
		if (!e || t.length !== 1) return;
		const r = t[0].values(),
		...
		return { range: e, color: Hn(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a) };
	}
	function vt(e, t) {
	...
	function Ql(e, t, n) {
		...
		if (i) {
			...
			if (a.endColumn > a.startColumn) {
				const u = { range: a, ...os(i[1]), shouldBeInComments: !0 };
	...
	class Yl extends Fo {
		...
		findMatches(t) {
			...
			for (let i = 0; i < this._lines.length; i++) {
				const r = this._lines[i],
					s = this.offsetAt(new Le(i + 1, 1)),
					a = r.matchAll(t);
				for (const u of a)
					(u.index || u.index === 0) && (u.index = u.index + s),
						n.push(u);
			}
			return n;
		}
		...
		getWordAtPosition(t, n) {
			const i = wn(t.column, Ri(n), this._lines[t.lineNumber - 1], 0);
			return i
		...
		_validatePosition(t) {
			if (!Le.isIPosition(t)) throw new Error("bad position");
	...
	class je {
		...
		static computeDiff(t, n, i, r) {
			const s = r === "advanced" ? ns.getDefault() : ns.getLegacy(),
				a = t.getLinesContent(),
				u = n.getLinesContent(),
		...
		async computeMoreMinimalEdits(t, n, i) {
			...
			for (let o = 1; o < n.length; o++)
				Y.getEndPosition(n[u].range).equals(
					Y.getStartPosition(n[o].range),
				)
			...
			for (let { range: o, text: l, eol: c } of n) {
				if ((typeof c == "number" && (a = c), Y.isEmpty(o) && !l))
					continue;
		...
		async navigateValueSet(t, n, i, r, s) {
			...
			return xn.INSTANCE.navigateValueSet(n, o, l, c, i);
		}
	 ...
	 * Version: 0.51.0-dev-20240628(c321d0fbecb50ab8a5365fa1965476b0ae63fc87)
	...
	(function (e) {
		function t(i, r) {
			return (
				i === Number.MAX_VALUE && (i = Ot.MAX_VALUE),
				r === Number.MAX_VALUE && (r = Ot.MAX_VALUE),
				{ line: i, character: r }
			);
		}
		e.create = t;
	...
	(function (e) {
		...
		function n(i) {
			let r = i;
			return L.objectLiteral(r) && ie.is(r.start) && ie.is(r.end);
		}
		e.is = n;
	})(j || (j = {}));
	var Vt;
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.objectLiteral(r) &&
				j.is(r.range) &&
				(L.string(r.uri) || L.undefined(r.uri))
			);
		}
		e.is = n;
	})(Vt || (Vt = {}));
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.objectLiteral(r) &&
				j.is(r.targetRange) &&
				L.string(r.targetUri) &&
				j.is(r.targetSelectionRange) &&
				(j.is(r.originSelectionRange) ||
					L.undefined(r.originSelectionRange))
			);
		}
		e.is = n;
	})(hs || (hs = {}));
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.objectLiteral(r) &&
				L.numberRange(r.red, 0, 1) &&
				L.numberRange(r.green, 0, 1) &&
				L.numberRange(r.blue, 0, 1) &&
				L.numberRange(r.alpha, 0, 1)
			);
		}
		e.is = n;
	})(Fn || (Fn = {}));
	...
	(function (e) {
		...
		function n(i) {
			const r = i;
			return L.objectLiteral(r) && j.is(r.range) && Fn.is(r.color);
		}
		e.is = n;
	})(ds || (ds = {}));
	var ms;
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.objectLiteral(r) &&
				L.string(r.label) &&
				(L.undefined(r.textEdit) || se.is(r)) &&
				(L.undefined(r.additionalTextEdits) ||
					L.typedArray(r.additionalTextEdits, se.is))
			);
		}
		e.is = n;
	})(ms || (ms = {}));
	...
	(function (e) {
		function t(i, r, s, a, u, o) {
			...
			return (
				L.defined(s) && (l.startCharacter = s),
				L.defined(a) && (l.endCharacter = a),
				L.defined(u) && (l.kind = u),
				L.defined(o) && (l.collapsedText = o),
				l
			);
		}
		e.create = t;
		function n(i) {
			...
			return (
				L.objectLiteral(r) &&
				L.uinteger(r.startLine) &&
				L.uinteger(r.startLine) &&
				(L.undefined(r.startCharacter) ||
					L.uinteger(r.startCharacter)) &&
				(L.undefined(r.endCharacter) || L.uinteger(r.endCharacter)) &&
				(L.undefined(r.kind) || L.string(r.kind))
			);
		}
		e.is = n;
	})(fs || (fs = {}));
	...
	(function (e) {
		...
		function n(i) {
			let r = i;
			return L.defined(r) && Vt.is(r.location) && L.string(r.message);
		}
		e.is = n;
	})(Pn || (Pn = {}));
	var ps;
	...
	(function (e) {
		function t(n) {
			const i = n;
			return L.objectLiteral(i) && L.string(i.href);
		}
		e.is = t;
	})(bs || (bs = {}));
	var Gt;
	(function (e) {
		function t(i, r, s, a, u, o) {
			...
			return (
				L.defined(s) && (l.severity = s),
				L.defined(a) && (l.code = a),
				L.defined(u) && (l.source = u),
				L.defined(o) && (l.relatedInformation = o),
				l
			);
		}
		e.create = t;
		function n(i) {
			...
			return (
				...
				(L.undefined(s.relatedInformation) ||
					L.typedArray(s.relatedInformation, Pn.is))
			);
		}
		e.is = n;
	})(Gt || (Gt = {}));
	...
	(function (e) {
		function t(i, r, ...s) {
			...
			return L.defined(s) && s.length > 0 && (a.arguments = s), a;
		}
		e.create = t;
		function n(i) {
			let r = i;
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.objectLiteral(r) &&
				L.string(r.label) &&
				(L.boolean(r.needsConfirmation) ||
					r.needsConfirmation === void 0) &&
				(L.string(r.description) || r.description === void 0)
			);
		}
		e.is = n;
	})(Bn || (Bn = {}));
	...
	(function (e) {
		...
		function r(s) {
			const a = s;
			return se.is(a) && (Bn.is(a.annotationId) || ut.is(a.annotationId));
		}
		e.is = r;
	})(_s || (_s = {}));
	var qn;
	(function (e) {
		...
		function n(i) {
			let r = i;
			return (
				L.defined(r) && $n.is(r.textDocument) && Array.isArray(r.edits)
			);
		}
		e.is = n;
	})(qn || (qn = {}));
			...
			return (
				...
				(r.options === void 0 ||
					((r.options.overwrite === void 0 ||
						L.boolean(r.options.overwrite)) &&
						(r.options.ignoreIfExists === void 0 ||
							L.boolean(r.options.ignoreIfExists)))) &&
				(r.annotationId === void 0 || ut.is(r.annotationId))
			);
		}
		e.is = n;
	})(On || (On = {}));
			...
			return (
				...
				(r.options === void 0 ||
					((r.options.recursive === void 0 ||
						L.boolean(r.options.recursive)) &&
						(r.options.ignoreIfNotExists === void 0 ||
							L.boolean(r.options.ignoreIfNotExists)))) &&
				(r.annotationId === void 0 || ut.is(r.annotationId))
			);
		}
		e.is = n;
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.defined(r) &&
				L.string(r.uri) &&
				(r.version === null || L.integer(r.version))
			);
		}
		e.is = n;
	})($n || ($n = {}));
	...
	(function (e) {
		function t(n) {
			const i = n;
			return L.objectLiteral(n) && Ne.is(i.kind) && L.string(i.value);
		}
		e.is = t;
	})(yt || (yt = {}));
	var he;
	...
	(function (e) {
		...
		function n(i) {
			const r = i;
			return (
				r && L.string(r.newText) && j.is(r.insert) && j.is(r.replace)
			);
		}
		e.is = n;
	})(Ts || (Ts = {}));
	...
	(function (e) {
		function t(n) {
			...
			return (
				i &&
				(L.string(i.detail) || i.detail === void 0) &&
	...
	(function (e) {
		function t(n, i, ...r) {
			let s = { label: n };
			return (
				L.defined(i) && (s.documentation = i),
				L.defined(r) ? (s.parameters = r) : (s.parameters = []),
				s
			);
		}
		e.create = t;
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				...
				(r.detail === void 0 || L.string(r.detail)) &&
				(r.deprecated === void 0 || L.boolean(r.deprecated)) &&
	...
	(function (e) {
		function t(i, r, s) {
			let a = { diagnostics: i };
			return (
				r != null && (a.only = r), s != null && (a.triggerKind = s), a
			);
		}
		e.create = t;
		function n(i) {
			...
			return (
				L.defined(r) &&
				L.typedArray(r.diagnostics, Gt.is) &&
				(r.only === void 0 || L.typedArray(r.only, L.string)) &&
				(r.triggerKind === void 0 ||
					r.triggerKind === Jt.Invoked ||
					r.triggerKind === Jt.Automatic)
			);
		}
		e.is = n;
	})(zs || (zs = {}));
		...
		function n(i) {
			...
			return (
				...
				(r.diagnostics === void 0 ||
					L.typedArray(r.diagnostics, Gt.is)) &&
				(r.kind === void 0 || L.string(r.kind)) &&
				(r.edit !== void 0 || r.command !== void 0) &&
				(r.command === void 0 || lt.is(r.command)) &&
				(r.isPreferred === void 0 || L.boolean(r.isPreferred)) &&
				(r.edit === void 0 || Gn.is(r.edit))
			);
		}
		e.is = n;
	})(Hs || (Hs = {}));
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.defined(r) &&
				j.is(r.range) &&
				(L.undefined(r.command) || lt.is(r.command))
			);
		}
		e.is = n;
	})(Us || (Us = {}));
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.defined(r) &&
				L.uinteger(r.tabSize) &&
				L.boolean(r.insertSpaces)
			);
		}
		e.is = n;
	})(Ws || (Ws = {}));
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				L.defined(r) &&
				j.is(r.range) &&
				(L.undefined(r.target) || L.string(r.target))
			);
		}
		e.is = n;
	})(Fs || (Fs = {}));
	...
	(function (e) {
		...
		function n(i) {
			const r = i;
			return r != null && j.is(r.range) && L.string(r.text);
		}
		e.is = n;
	})(Os || (Os = {}));
	var Vs;
	(function (e) {
		...
		function n(i) {
			...
			return (
				r != null &&
				j.is(r.range) &&
				L.boolean(r.caseSensitiveLookup) &&
				(L.string(r.variableName) || r.variableName === void 0)
			);
		}
		e.is = n;
	})(Vs || (Vs = {}));
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				r != null &&
				j.is(r.range) &&
				(L.string(r.expression) || r.expression === void 0)
			);
		}
		e.is = n;
	})(js || (js = {}));
	...
	(function (e) {
		...
		function n(i) {
			const r = i;
			return L.defined(r) && j.is(i.stoppedLocation);
		}
		e.is = n;
	})(Gs || (Gs = {}));
	var Yn;
		...
		function n(i) {
			...
			return (
				...
				(r.tooltip === void 0 ||
					L.string(r.tooltip) ||
					yt.is(r.tooltip)) &&
				(r.location === void 0 || Vt.is(r.location)) &&
				(r.command === void 0 || lt.is(r.command))
			);
		}
		e.is = n;
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				(L.objectLiteral(r) &&
					ie.is(r.position) &&
					(L.string(r.label) || L.typedArray(r.label, Zn.is)) &&
					(r.kind === void 0 || Yn.is(r.kind)) &&
					r.textEdits === void 0) ||
				(L.typedArray(r.textEdits, se.is) &&
					(r.tooltip === void 0 ||
						L.string(r.tooltip) ||
						yt.is(r.tooltip)) &&
					(r.paddingLeft === void 0 || L.boolean(r.paddingLeft)) &&
					(r.paddingRight === void 0 || L.boolean(r.paddingRight)))
			);
		}
		e.is = n;
	})($s || ($s = {}));
	...
	(function (e) {
		function t(n) {
			const i = n;
			return L.objectLiteral(i) && Wn.is(i.uri) && L.string(i.name);
		}
		e.is = t;
	})(ea || (ea = {}));
	var ta;
...
` &&
	...
	var na = class oi {
						...
						if (o - u === c.length)
							...
							c.length < 1e4
								...
								: (this._lineOffsets = l =
										l
											.slice(0, u + 1)
											.concat(c, l.slice(o + 1)));
						const d = i.text.length - (a - s);
						if (d !== 0)
							for (
								let m = u + 1 + c.length, f = l.length;
								m < f;
								m++
							)
								l[m] = l[m] + d;
			...
			getLineOffsets() {
				return (
					this._lineOffsets === void 0 &&
						(this._lineOffsets = ia(this._content, !0)),
					this._lineOffsets
				);
			}
			positionAt(t) {
	...
	(function (e) {
		function t(r, s, a, u) {
			return new na(r, s, a, u);
		}
		e.create = t;
		function n(r, s, a) {
			if (r instanceof na) return r.update(s, a), r;
			throw new Error(
		...
		function x() {
			...
			switch (s) {
				case B.WithinComment:
					return r.advanceIfChars([ct, ct, Ee])
						? ((s = B.WithinContent), g(T, z.EndCommentTag))
						: (r.advanceUntilChars([ct, ct, Ee]), g(T, z.Comment));
				case B.WithinDoctype:
					return r.advanceIfChar(Ee)
						? ((s = B.WithinContent), g(T, z.EndDoctypeTag))
						: (r.advanceUntilChar(Ee), g(T, z.Doctype));
				case B.WithinContent:
					if (r.advanceIfChar(Yt)) {
						if (!r.eos() && r.peekChar() === aa) {
							if (r.advanceIfChars([aa, ct, ct]))
								return (
									(s = B.WithinComment),
									g(T, z.StartCommentTag)
								);
							if (r.advanceIfRegExp(/^!doctype/i))
								return (
									(s = B.WithinDoctype),
									g(T, z.StartDoctypeTag)
								);
						}
						return r.advanceIfChar(ni)
							? ((s = B.AfterOpeningEndTag), g(T, z.EndTagOpen))
							: ((s = B.AfterOpeningStartTag),
								g(T, z.StartTagOpen));
					}
					return r.advanceUntilChar(Yt), g(T, z.Content);
				case B.AfterOpeningEndTag:
					return f().length > 0
						...
						: r.skipWhitespace()
							...
							: ((s = B.WithinEndTag),
								r.advanceUntilChar(Ee),
								T < r.pos()
									? g(
											T,
											z.Unknown,
											xe("End tag name expected."),
										)
									: x());
				case B.WithinEndTag:
					if (r.skipWhitespace()) return g(T, z.Whitespace);
					if (r.advanceIfChar(Ee))
					...
					return r.skipWhitespace()
						...
						: l && ((d = w()), d.length > 0)
							? ((s = B.AfterAttributeName),
								(l = !1),
								g(T, z.AttributeName))
							: r.advanceIfChars([ni, Ee])
								? ((s = B.WithinContent),
									g(T, z.StartTagSelfClose))
								: r.advanceIfChar(Ee)
									? (c === "script"
											? m && hu[m]
												? (s = B.WithinContent)
				...
				case B.BeforeAttributeValue:
					...
					if (
						...
						return (
							(s = B.WithinTag), (l = !1), g(T, z.AttributeValue)
						);
					const M = r.peekChar();
					return M === su || M === ru
						? (r.advance(1),
			...
			return r.advance(1), (s = B.WithinContent), g(T, z.Unknown, C);
		}
		return {
			scan: A,
			getTokenType: () => u,
	...
	var la = class {
			...
			findNodeBefore(e) {
				const t = oa(this.children, (n) => e <= n.start) - 1;
				if (t >= 0) {
...
`))),
	...
	function Su(e, t, n) {
		...
		if (r === -1) i = Cu(n, 1, -1);
			...
			const s = t.slice(r + 1),
				a = kt(n.end, -1 - s.length),
				u = s.indexOf(" ");
			let o;
			u !== -1 ? (o = kt(a, u)) : (o = kt(n.end, -1)),
				(i = j.create(a, o));
		}
		return i;
	}
	...
	var Eu = class {
		...
		_doComplete(e, t, n, i) {
			...
			function g(y, S = c) {
				return (
					y > c && (y = c),
					{ start: e.positionAt(y), end: e.positionAt(S) }
				);
			}
			function A(y, S) {
				const D = g(y, S);
					...
					a.forEach((I) => {
						I.provideTags().forEach((P) => {
							r.items.push({
								label: P.name,
								kind: he.Property,
								documentation: Ge(P, void 0, o),
								textEdit: se.replace(D, P.name),
...
\r`.indexOf(D) >= 0
			...
			function T(y, S, D = c) {
				const I = g(y, D),
					P = ha(l, D, B.WithinEndTag, z.EndTagClose) ? "" : ">";
				let U = d;
				for (S && (U = U.parent); U; ) {
					const W = U.tag;
					if (
						W &&
						(!U.closed || (U.endTagStart && U.endTagStart > c))
					) {
						const G = {
								label: "/" + W,
								kind: he.Property,
			...
			const C = (y, S) => {
				...
				if (!this.dataManager.isVoidElement(S, u)) {
					const D = e.positionAt(y);
					r.items.push({
						label: "</" + S + ">",
						kind: he.Property,
						filterText: "</" + S + ">",
						textEdit: se.insert(D, "$0</" + S + ">"),
			...
			function M(y, S = c) {
				let D = c;
				for (; D < S && l[D] !== "<"; ) D++;
				const I = l.substring(y, S),
					P = g(y, D);
				let U = "";
				if (!ha(l, S, B.AfterAttributeName, z.DelimiterAssign)) {
					const G = i?.attributeDefaultValue ?? "doublequotes";
					G === "empty"
						? (U = "=$1")
						: G === "singlequotes"
							? (U = "='$1'")
			...
			function p(y, S = c) {
				...
				if (c > y && c <= S && Ru(l[y])) {
					...
					(D = g(G, $)),
						...
						(I = !1);
				} else (D = g(y, S)), (P = l.substring(y, c)), (I = !0);
				if (s.length > 0) {
					...
					a.forEach((U) => {
						U.provideValues(f, w).forEach((W) => {
							...
							r.items.push({
								...
								filterText: G,
								kind: he.Unit,
								documentation: Ge(W, void 0, o),
								textEdit: se.replace(D, G),
								insertTextFormat: Te.PlainText,
							});
						});
					}),
			...
			function k(y) {
				return c === m.getTokenEnd() &&
					((E = m.scan()), E === y && m.getTokenOffset() === c)
					? m.getTokenEnd()
					: c;
			}
			function H() {
				for (const y of s)
					y.onHtmlContent &&
						y.onHtmlContent({ document: e, position: t });
				return v();
			}
			function v() {
				let y = c - 1,
				...
				for (; y >= 0 && Tt(l, y); ) y--, S--;
				if (y >= 0 && l[y] === "&") {
					const D = j.create(ie.create(t.line, S - 1), t);
					for (const I in xt)
						if (fu(I, ";")) {
							const P = "&" + I;
							r.items.push({
			...
			function b(y, S) {
				...
				r.items.push({
					...
					textEdit: se.replace(D, "!DOCTYPE html>"),
					insertTextFormat: Te.PlainText,
				});
			}
			let E = m.scan();
			for (; E !== z.EOS && m.getTokenOffset() <= c; ) {
				switch (E) {
					case z.StartTagOpen:
						if (m.getTokenEnd() === c) {
							const y = k(z.StartTag);
							return t.line === 0 && b(c, y), R(c, y);
						}
						break;
					case z.StartTag:
						if (m.getTokenOffset() <= c && c <= m.getTokenEnd())
							return A(m.getTokenOffset(), m.getTokenEnd());
						f = m.getTokenText();
						break;
					case z.AttributeName:
						if (m.getTokenOffset() <= c && c <= m.getTokenEnd())
					...
					case z.EndTag:
						if (c <= m.getTokenEnd()) {
							...
							for (; y >= 0; ) {
								const S = l.charAt(y);
								if (S === "/") return T(y, !1, m.getTokenEnd());
								if (!Kt(S)) break;
								y--;
							}
						}
		...
		doesSupportMarkdown() {
			if (!Zt(this.supportsMarkdown)) {
				...
				this.supportsMarkdown =
					Array.isArray(e) && e.indexOf(Ne.Markdown) !== -1;
			}
		...
		doHover(e, t, n, i) {
				...
				for (const k of l) {
					...
					if (
						(k.provideTags().forEach((v) => {
							if (v.name.toLowerCase() === M.toLowerCase()) {
								let b = Ge(v, i, s);
								b ||
									(b = {
			...
			function d(M, _, p) {
				for (const k of l) {
					let H = null;
					if (
						(k.provideAttributes(M).forEach((v) => {
							if (_ === v.name && v.description) {
								const b = Ge(v, i, s);
								b
									? (H = { contents: b, range: p })
									: (H = null);
							}
						}),
						H)
			...
			function m(M, _, p, k) {
				for (const H of l) {
					let v = null;
					if (
						(H.provideValues(M, _).forEach((b) => {
							if (p === b.name && b.description) {
								const E = Ge(b, i, s);
								E
									? (v = { contents: E, range: k })
									: (v = null);
							}
						}),
						v)
			...
			function f(M, _) {
				...
				for (const k in xt) {
					...
					const v = "&" + k;
					if (p === v) {
						let b = xt[k].charCodeAt(0).toString(16).toUpperCase(),
							E = "U+";
						if (b.length < 4) {
							const S = 4 - b.length;
							let D = 0;
			...
			function w(M, _) {
				const p = fe(e.getText(), _);
				let k = p.scan();
				for (
					;
					k !== z.EOS &&
					(p.getTokenEnd() < a || (p.getTokenEnd() === a && k !== M));
				)
					k = p.scan();
				return k === M && a <= p.getTokenEnd()
					? {
			...
			function A(M) {
				let _ = a - 1,
					p = "&";
				for (; _ >= 0 && Tt(M, _); ) _--;
				for (_ = _ + 1; Tt(M, _); ) (p += M[_]), (_ += 1);
				return (p += ";"), p;
			}
			if (u.endTagStart && a >= u.endTagStart) {
				const M = w(z.EndTag, u.endTagStart);
				return M ? c(u.tag, M) : null;
			}
			...
			if (C) return f(o, C);
			function R(M, _) {
				const p = fe(e.getText(), M);
				let k = p.scan(),
					H;
				for (; k !== z.EOS && p.getTokenEnd() <= _; )
					(k = p.scan()),
						k === z.AttributeName && (H = p.getTokenText());
				return H;
			}
			const N = w(z.AttributeValue, u.start);
			if (N) {
				const M = u.tag,
					_ = Iu(e.getText(N)),
					p = R(u.start, e.offsetAt(N.start));
				if (p) return m(M, p, _, N);
			}
			return null;
		}
		convertContents(e) {
							...
							if (this._should_wrap()) {
								...
								return (
									...
									(this.__character_count =
										this.__wrap_point_character_count),
									o.__items[0] === " " &&
										(o.__items.splice(0, 1),
										(o.__character_count -= 1)),
									!0
								);
							}
							return !1;
...
`);
					...
					function a(o, l) {
						(this.__cache = [""]),
							...
							(l = l || ""),
							o.indent_level > 0 &&
								(l = new Array(o.indent_level + 1).join(
...
You passed in: '` +
				...
				function (r) {
					...
					(s.prototype.get_directives = function (a) {
						...
						for (var o = this.__directive_pattern.exec(a); o; )
							(u[o[1]] = o[2]),
								(o = this.__directive_pattern.exec(a));
						return u;
					}),
						(s.prototype.readIgnored = function (a) {
							return a.readUntilAfter(
				...
				function (r, s, a) {
					...
					(T.prototype.eatString = function (C) {
						var R = "";
...
`
						...
						(T.prototype.eatWhitespace = function (C) {
							for (
...
` &&
						...
						(T.prototype.foundNestedPseudoClass = function () {
							for (
								var C = 0, R = 1, N = this._input.peek(R);
								N;
							) {
								if (N === "{") return !0;
								if (N === "(") C += 1;
						...
						(T.prototype.print_string = function (C) {
							this._output.set_indent(this._indentLevel),
								(this._output.non_breaking_space = !0),
								this._output.add_token(C);
						}),
						(T.prototype.preserveSingleSpace = function (C) {
...
` &&
							...
							var si = this._output.get_code(R);
							return si;
						}),
...
You passed in: '` +
				...
				function (r, s, a) {
					...
					(o.prototype = new u()),
						(o.prototype.__set_whitespace_patterns = function (
							l,
							c,
						) {
							(l += "\\t "),
						...
						(o.prototype.matching = function (l, c) {
							var d = this._create();
							return (
								d.__set_whitespace_patterns(l, c),
								d._update(),
								d
							);
						}),
				...
				function (r) {
					...
					(s.prototype.read = function () {
						...
						(s.prototype.starting_with = function (a) {
							var u = this._create();
							return (
								(u._starting_pattern = this._input.get_regexp(
									a,
									!0,
								)),
								u._update(),
						...
						(s.prototype.matching = function (a) {
							var u = this._create();
							return (
								(u._match_pattern = this._input.get_regexp(
									a,
									!0,
								)),
								u._update(),
				...
				function (r, s, a) {
						...
						f = function (_, p) {
							(this.indent_level = 0),
								...
								(this.max_preserve_newlines =
									_.max_preserve_newlines),
								(this.preserve_newlines = _.preserve_newlines),
								(this._output = new o(_, p));
						};
					(f.prototype.current_line_has_match = function (_) {
						...
						(f.prototype.traverse_whitespace = function (_) {
							return _.whitespace_before || _.newlines
								? (this.print_preserved_newlines(_) ||
										(this._output.space_before_token = !0),
									!0)
								: !1;
						}),
						...
						(f.prototype.get_full_indent = function (_) {
							return (
								(_ = this.indent_level + (_ || 0)),
								_ < 1 ? "" : this._output.get_indent_string(_)
							);
						});
					var w = function (_) {
							for (
								var p = null, k = _.next;
								k.type !== c.EOF && _.closed !== k;
							) {
								if (
									k.type === c.ATTRIBUTE &&
									k.text === "type"
					...
					(T.prototype.get_parser_token = function () {
						...
						(T.prototype.record_tag = function (_) {
							var p = new x(
								this._current_frame,
								_,
						...
						(T.prototype._try_pop_frame = function (_) {
							var p = null;
							return (
								_ &&
									((p = _.parser_token),
									(this._printer.indent_level =
										_.indent_level),
									(this._current_frame = _.parent)),
								p
							);
						}),
						(T.prototype._get_frame = function (_, p) {
							for (
						...
						(T.prototype.try_pop = function (_, p) {
							var k = this._get_frame([_], p);
							return this._try_pop_frame(k);
						}),
						(T.prototype.indent_to_tag = function (_) {
					...
					(C.prototype.beautify = function () {
						...
						var _ = this._source_text,
							p = this._options.eol;
						this._options.eol === "auto" &&
							((p = `
`),
							_ && d.test(_) && (p = _.match(d)[0])),
							(_ = _.replace(
								m,
								`
`,
						...
						var k = _.match(/^[\t ]*/)[0],
							H = { text: "", type: "" },
							v = new R(),
							b = new f(this._options, k),
							E = new l(_, this._options).tokenize();
						this._tag_stack = new T(b);
						for (var y = null, S = E.next(); S.type !== c.EOF; )
							S.type === c.TAG_OPEN || S.type === c.COMMENT
								? ((y = this._handle_tag_open(b, S, v, H, E)),
									(v = y))
								: S.type === c.ATTRIBUTE ||
										S.type === c.EQUALS ||
										S.type === c.VALUE ||
										(S.type === c.TEXT && !v.tag_complete)
									? (y = this._handle_inside_tag(b, S, v, H))
									: S.type === c.TAG_CLOSE
										? (y = this._handle_tag_close(b, S, v))
										: S.type === c.TEXT
											? (y = this._handle_text(b, S, v))
								...
								(H = y),
								(S = E.next());
						var D = b._output.get_code(p);
						return D;
					}),
						(C.prototype._handle_control_flow_open = function (
							_,
							p,
						) {
							var k = { text: p.text, type: p.type };
							return (
								_.set_space_before_token(
									p.newlines || p.whitespace_before !== "",
									!0,
								),
								p.newlines
									? _.print_preserved_newlines(p)
									: _.set_space_before_token(
											p.newlines ||
												p.whitespace_before !== "",
											!0,
						...
						(C.prototype._handle_control_flow_close = function (
							_,
							p,
						) {
							var k = { text: p.text, type: p.type };
						...
						(C.prototype._handle_tag_close = function (_, p, k) {
							...
							return (
								...
								k.indent_content &&
									!(
										k.is_unformatted ||
										k.is_content_unformatted
									) &&
									(_.indent(), (k.indent_content = !1)),
								!k.is_inline_element &&
									!(
										k.is_unformatted ||
										k.is_content_unformatted
						...
						(C.prototype._handle_inside_tag = function (
							_,
							p,
							k,
							H,
								...
								k.is_unformatted
									...
									: k.tag_start_char === "{" &&
										...
										: (p.type === c.ATTRIBUTE
											...
											(v =
												v ||
												_.previous_token_wrapped()),
											(k.has_wrapped_attrs = v)),
								b
							);
						}),
						(C.prototype._handle_text = function (_, p, k) {
							var H = { text: p.text, type: "TK_CONTENT" };
							return (
								k.custom_beautifier_name
									? this._print_custom_beatifier_text(_, p, k)
									: k.is_unformatted ||
											k.is_content_unformatted
										? _.add_raw_token(p)
										: (_.traverse_whitespace(p),
						...
						(C.prototype._print_custom_beatifier_text = function (
							_,
							p,
							k,
						) {
...
` +
						...
						(C.prototype._handle_tag_open = function (
							_,
							p,
							k,
							H,
							...
							var b = this._get_tag_open_token(p);
							if (
								((k.is_unformatted ||
									k.is_content_unformatted) &&
								!k.is_empty_element &&
								...
								!b.is_start_tag
									...
									: (_.traverse_whitespace(p),
										this._set_tag_position(_, p, b, k, H),
										b.is_inline_element ||
											_.set_wrap_point(),
										_.print_token(p)),
								b.is_start_tag &&
							...
							return (
								(this._is_wrap_attributes_force_aligned ||
									...
									this
										._is_wrap_attributes_preserve_aligned) &&
									(b.alignment_size = p.text.length + 1),
								!b.tag_complete &&
									!b.is_unformatted &&
									(_.alignment_size = b.alignment_size),
								b
							);
						});
					var R = function (_, p) {
					...
					(C.prototype._get_tag_open_token = function (_) {
						var p = new R(this._tag_stack.get_parser_token(), _);
						return (
							(p.alignment_size =
								this._options.wrap_attributes_indent_size),
							(p.is_end_tag =
								p.is_end_tag ||
								A(p.tag_check, this._options.void_elements)),
							(p.is_empty_element =
								p.tag_complete ||
								(p.is_start_tag && p.is_end_tag)),
							(p.is_unformatted =
								!p.tag_complete &&
								A(p.tag_check, this._options.unformatted)),
						...
						(C.prototype._set_tag_position = function (
							_,
							p,
							k,
							H,
									...
									(k.is_end_tag
										...
										: (this._do_optional_end_element(k) &&
											...
											(k.tag_name === "script" ||
												...
												(k.custom_beautifier_name = g(
													k.tag_check,
													p,
												)))),
								A(k.tag_check, this._options.extra_liners) &&
									(_.print_newline(!1),
									_._output.just_added_blankline() ||
										_.print_newline(!0)),
								k.is_empty_element)
							) {
								if (
									...
									this._tag_stack.indent_to_tag([
										...
										(k.indent_content = !0);
									var b = _.current_line_has_match(/{{#if/);
									b || _.print_newline(!1);
								}
								(k.tag_name === "!--" &&
									v.type === c.TAG_CLOSE &&
...
`) === -1) ||
									(k.is_inline_element ||
										k.is_unformatted ||
										_.print_newline(!1),
									this._calcluate_parent_multiline(_, k));
							} else if (k.is_end_tag) {
								var E = !1;
								(E =
									k.start_tag_token &&
									k.start_tag_token.multiline_content),
									(E =
										E ||
										(!k.is_inline_element &&
											!(
						...
						(C.prototype._calcluate_parent_multiline = function (
							_,
							p,
						) {
							p.parent &&
								_._output.just_added_newline() &&
								!(
					...
					(C.prototype._do_optional_end_element = function (_) {
						var p = null;
						if (
							!(
								_.is_empty_element ||
							...
							if (_.tag_name === "body")
								...
								_.parent.tag_name === "p" &&
								N.indexOf(_.tag_name) !== -1
							) {
								var k = _.parent.parent;
								(!k || M.indexOf(k.tag_name) === -1) &&
									(p = p || this._tag_stack.try_pop("p"));
							} else
								_.tag_name === "rp" || _.tag_name === "rt"
									? ((p =
											p ||
							...
							return (
								(_.parent = this._tag_stack.get_parser_token()),
								p
							);
						}
					}),
						(r.exports.Beautifier = C);
				},
				function (r, s, a) {
					var u = a(6).Options;
					function o(l) {
				...
				function (r, s, a) {
					var u = a(9).Tokenizer,
						...
						f = new l(/<\!--/, /-->/),
						w = function (g, A) {
							u.call(this, g, A), (this._current_tag_name = "");
							var x = new c(this._input).read_options(
									this._options,
								),
								T = new d(this._input);
							if (
								...
								var C = this._input.get_literal_regexp(
									this._options.unformatted_content_delimiter,
								);
								this.__patterns.unformatted_content_delimiter =
									T.matching(C).until_after(C);
							}
						};
					(w.prototype = new u()),
						...
						(w.prototype._is_closing = function (g, A) {
							return (
								(g.type === m.TAG_CLOSE &&
									A &&
									(((g.text === ">" || g.text === "/>") &&
						...
						(w.prototype._get_next_token = function (g, A) {
							var x = null;
							this._readWhitespace();
							var T = this._input.peek();
							return T === null
								? this._create_token(m.EOF, "")
								: ((x = x || this._read_open_handlebars(T, A)),
									(x = x || this._read_attribute(T, g, A)),
									(x = x || this._read_close(T, A)),
									(x = x || this._read_control_flows(T, A)),
									(x = x || this._read_raw_content(T, g, A)),
									(x = x || this._read_content_word(T, A)),
									(x = x || this._read_comment_or_cdata(T)),
									(x = x || this._read_processing(T)),
									(x = x || this._read_open(T, A)),
									(x =
										x ||
										this._create_token(
											m.UNKNOWN,
						...
						(w.prototype._read_comment_or_cdata = function (g) {
							...
							if (g === "<") {
								...
								C === "!" &&
									...
									x &&
										((A = this._create_token(m.COMMENT, x)),
										(A.directives = T));
							}
							return A;
						}),
						...
						(w.prototype._read_open = function (g, A) {
							var x = null,
								T = null;
							return (
								(!A || A.type === m.CONTROL_FLOW_OPEN) &&
									g === "<" &&
									((x = this._input.next()),
									this._input.peek() === "/" &&
										(x += this._input.next()),
						...
						(w.prototype._read_open_handlebars = function (g, A) {
							var x = null,
								T = null;
							return (
								(!A || A.type === m.CONTROL_FLOW_OPEN) &&
						...
						(w.prototype._read_control_flows = function (g, A) {
							var x = "",
								T = null;
							if (
						...
						(w.prototype._read_close = function (g, A) {
							var x = null,
								T = null;
							return (
								A &&
						...
						(w.prototype._read_attribute = function (g, A, x) {
							var T = null,
								C = "";
							if (x && x.text[0] === "<")
								if (g === "=")
									...
									g === '"'
										...
										(T = this._create_token(m.VALUE, R));
								} else
									(C = this.__patterns.attribute.read()),
										C &&
											(A.type === m.EQUALS
												? (T = this._create_token(
														m.VALUE,
						...
						(w.prototype._read_raw_content = function (g, A, x) {
							var T = "";
							if (x && x.text[0] === "{")
								...
								var C = A.opened.text.substr(1).toLowerCase();
								if (C === "script" || C === "style") {
									...
									this._is_content_unformatted(C) &&
										(T = this._input.readUntil(
											new RegExp(
												"</" + C + "[\\n\\r\\t ]*?>",
												"ig",
						...
						(w.prototype._read_content_word = function (g, A) {
							var x = "";
							if (
								(this._options.unformatted_content_delimiter &&
									g ===
	...
	function Wu(e, t, n) {
		...
		if (t) {
			let l = e.offsetAt(t.start),
				c = l;
			for (; c > 0 && pa(i, c - 1); ) c--;
			c === 0 || fa(i, c - 1) ? (l = c) : c < l && (l = c + 1);
			let d = e.offsetAt(t.end),
				m = d;
			for (; m < i.length && pa(i, m); ) m++;
			(m === i.length || fa(i, m)) && (d = m),
		...
		const u = {
			...
			unformatted: ii(n, "unformatted", void 0),
			content_unformatted: ii(n, "contentUnformatted", void 0),
			...
			extra_liners: ii(n, "extraLiners", void 0),
			wrap_attributes: pe(n, "wrapAttributes", "auto"),
			wrap_attributes_indent_size: pe(
				n,
...
`,
			...
			templating: Pu(n, "all"),
			unformatted_content_delimiter: pe(
				n,
		...
		let o = Uu(Fu(i), u);
		if (s > 0) {
			const l = n.insertSpaces ? ua(" ", a * s) : ua("	", s);
			(o = o
				.split(`
`)
				.join(
...
`.indexOf(e.charAt(t)) !== -1
	...
	(() => {
					...
					var u = {
						...
						relative: function (o, l) {
							if (
								...
								s(l),
								o === l ||
									(o = u.resolve(o)) === (l = u.resolve(l)))
							)
								return "";
							for (
								var c = 1;
								c < o.length && o.charCodeAt(c) === 47;
								++c
							);
							for (
							...
							for (
								...
								if (x === g) {
									if (w > g) {
										if (l.charCodeAt(f + x) === 47)
											return l.slice(f + x + 1);
		...
		(() => {
			...
			class m {
				static isUri(b) {
					return (
						b instanceof m ||
						(!!b &&
							typeof b.authority == "string" &&
							typeof b.fragment == "string" &&
							typeof b.path == "string" &&
							typeof b.query == "string" &&
							typeof b.scheme == "string" &&
							typeof b.fsPath == "string" &&
							typeof b.with == "function" &&
				...
				query;
				fragment;
				constructor(b, E, y, S, D, I = !1) {
					typeof b == "object"
						? ((this.scheme = b.scheme || l),
							(this.authority = b.authority || l),
							(this.path = b.path || l),
							(this.query = b.query || l),
							(this.fragment = b.fragment || l))
				...
				with(b) {
					...
					return (
						...
						y === void 0
							? (y = this.authority)
							: y === null && (y = l),
						S === void 0 ? (S = this.path) : S === null && (S = l),
						D === void 0 ? (D = this.query) : D === null && (D = l),
						I === void 0
							? (I = this.fragment)
							: I === null && (I = l),
						E === this.scheme &&
				...
				static file(b) {
					...
					if (
						...
						const y = b.indexOf(c, 2);
						y === -1
							? ((E = b.substring(2)), (b = c))
							: ((E = b.substring(2, y)),
								(b = b.substring(y) || c));
					}
					return new w("file", E, b, l, l);
				}
				static from(b) {
					const E = new w(
						b.scheme,
				...
				static revive(b) {
					if (b) {
						if (b instanceof m) return b;
						{
							const E = new w(b);
							return (
								(E._formatted = b.external),
								(E._fsPath = b._sep === f ? b.fsPath : null),
								E
							);
						}
					}
			...
			class w extends m {
				...
				get fsPath() {
					return (
						this._fsPath || (this._fsPath = T(this)), this._fsPath
					);
				}
				toString(b = !1) {
					return b
				...
				toJSON() {
					...
					return (
						this._fsPath &&
							((b.fsPath = this._fsPath), (b._sep = f)),
						this._formatted && (b.external = this._formatted),
						this.path && (b.path = this.path),
						this.scheme && (b.scheme = this.scheme),
						this.authority && (b.authority = this.authority),
						this.query && (b.query = this.query),
						this.fragment && (b.fragment = this.fragment),
						b
					);
				}
			}
			...
			function A(v, b, E) {
				...
				for (let D = 0; D < v.length; D++) {
					...
					if (
						...
						S !== -1 &&
							((y += encodeURIComponent(v.substring(S, D))),
							(S = -1)),
							y !== void 0 && (y += v.charAt(D));
					else {
						y === void 0 && (y = v.substr(0, D));
						const P = g[I];
						P !== void 0
							? (S !== -1 &&
				...
				return (
					S !== -1 && (y += encodeURIComponent(v.substring(S))),
					y !== void 0 ? y : v
				);
			}
			function x(v) {
				...
				for (let E = 0; E < v.length; E++) {
					const y = v.charCodeAt(E);
					y === 35 || y === 63
						? (b === void 0 && (b = v.substr(0, E)), (b += g[y]))
						: b !== void 0 && (b += v[E]);
				}
				return b !== void 0 ? b : v;
			}
			...
			function C(v, b) {
				...
				if (
					...
					let W = D.indexOf("@");
					if (W !== -1) {
						const G = D.substr(0, W);
						(D = D.substr(W + 1)),
							(W = G.lastIndexOf(":")),
							W === -1
								? (y += E(G, !1, !1))
								: ((y += E(G.substr(0, W), !1, !1)),
									(y += ":"),
									(y += E(G.substr(W + 1), !1, !0))),
							(y += "@");
					}
					(D = D.toLowerCase()),
						(W = D.lastIndexOf(":")),
			...
			function R(v) {
				try {
					...
					return v.length > 3 ? v.substr(0, 3) + R(v.substr(3)) : v;
				}
			}
			const N = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
			function M(v) {
				return v.match(N) ? v.replace(N, (b) => R(b)) : v;
			}
			var _ = n(470);
			const p = _.posix || _,
				k = "/";
			var H;
			(function (v) {
				(v.joinPath = function (b, ...E) {
					return b.with({ path: p.join(b.path, ...E) });
				}),
					(v.resolvePath = function (b, ...E) {
						let y = b.path,
							S = !1;
						y[0] !== k && ((y = k + y), (S = !0));
						let D = p.resolve(y, ...E);
					...
					(v.dirname = function (b) {
						if (b.path.length === 0 || b.path === k) return b;
						let E = p.dirname(b.path);
						return (
							E.length === 1 &&
								E.charCodeAt(0) === 46 &&
								(E = ""),
					...
					(v.basename = function (b) {
						return p.basename(b.path);
					}),
					(v.extname = function (b) {
						return p.extname(b.path);
					});
			})(H || (H = {}));
		})(),
			(ga = i);
	})();
	var { URI: qu, Utils: pc } = ga;
	function ri(e) {
		const t = e[0],
			n = e[e.length - 1];
		return (
					...
					case z.AttributeValue:
						if (a && s && this.dataManager.isPathAttribute(a, s)) {
							...
							u &&
								typeof o > "u" &&
								((o = ri(c)),
								o && t && (o = t.resolveReference(o, e.uri))),
								(u = !1),
								(s = void 0);
						} else if (s === "id") {
							const c = ri(i.getTokenText());
	...
	function Ju(e, t, n) {
		...
		if (!r.tag) return [];
		const s = [],
			a = wa(z.StartTag, e, r.start),
			u =
				typeof r.endTagStart == "number" &&
				wa(z.EndTag, e, r.endTagStart);
		return (
			((a && _a(a, t)) || (u && _a(u, t))) &&
				(a && s.push({ kind: Xt.Read, range: a }),
				u && s.push({ kind: Xt.Read, range: u })),
			s
		);
	}
	function ba(e, t) {
	...
	function _a(e, t) {
		return ba(e.start, t) && ba(t, e.end);
	}
	function wa(e, t, n) {
	...
	function Qu(e, t) {
		...
		return n;
		function r(s, a) {
			const u = Jn.create(s.name, s.kind, s.range, e.uri, a?.name);
			if (
				(u.containerName ?? (u.containerName = ""),
				n.push(u),
				s.children)
			)
	...
	function ya(e, t, n) {
		const i = Yu(t),
			...
			s = Qn.create(i, void 0, Xn.Field, r, r);
		n.push(s),
			t.children.forEach((a) => {
				s.children ?? (s.children = []), ya(e, a, s.children);
			});
	}
	function Yu(e) {
		let t = e.tag;
	...
	var tc = class {
		...
		nc = class {
			...
			getSelectionRange(e, t, n) {
				...
				return s || (s = Qt.create(j.create(e, e))), s;
			}
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
		...
		rc = class {
			...
			setDataProviders(e, t) {
				(this.dataProviders = []),
					e && this.dataProviders.push(new ca("html5", ic)),
			...
			isVoidElement(e, t) {
				return (
					!!e &&
					du(t, e.toLowerCase(), (n, i) => n.localeCompare(i)) >= 0
				);
			}
			getVoidElements(e) {
	...
	function oc(e = ac) {
		...
		return {
			...
			findOnTypeRenameRanges: xa,
			findLinkedEditingRanges: xa,
		};
	}
	function lc(e, t) {
		return new ca(e, t);
...
//# sourceMappingURL=html.worker-M7DPnkSk.js.map
