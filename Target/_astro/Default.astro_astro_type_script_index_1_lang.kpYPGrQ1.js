(async ()=>{
    ...
    (function() {
        ...
        async function load(esModule, options) {
            ...
            const baseUrl = new URL(`${fileUriFromPath(configuration.appRoot, {
            ...
            try {
                const result = await import(new URL(`${esModule}.js`, baseUrl).href).then(async (m)=>{
                    await m.__tla;
                    return m;
                });
        ...
        function registerDeveloperKeybindings(disallowReloadKeybinding) {
            ...
            const extractKey = __name(function(e) {
                return [
                    e.ctrlKey ? "ctrl-" : "",
                    e.metaKey ? "meta-" : "",
                    e.altKey ? "alt-" : "",
            ...
            let listener = __name(function(e) {
