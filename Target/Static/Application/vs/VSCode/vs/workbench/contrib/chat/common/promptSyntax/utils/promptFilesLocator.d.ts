...
export declare class PromptFilesLocator {
    ...
    findFilesInRoots(roots: URI[], folder: string | undefined, paths: IWorkspaceInstructionFile[], token: CancellationToken, result?: IResolvedAgentFile[]): Promise<IResolvedAgentFile[]>;
