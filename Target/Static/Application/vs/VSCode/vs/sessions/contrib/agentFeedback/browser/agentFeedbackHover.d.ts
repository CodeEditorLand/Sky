...
export declare class AgentFeedbackHover extends Disposable {
    ...
    constructor(_element: HTMLElement, _attachment: IAgentFeedbackVariableEntry, _canDelete: boolean, _hoverService: IHoverService, _instantiationService: IInstantiationService, _agentFeedbackService: IAgentFeedbackService, _languageService: ILanguageService);
