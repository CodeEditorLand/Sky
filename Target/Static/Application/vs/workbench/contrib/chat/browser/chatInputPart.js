...
import { ChatRequestVariableSet, isPromptFileVariableEntry, isElementVariableEntry, isImageVariableEntry, isNotebookOutputVariableEntry, isPasteVariableEntry, isSCMHistoryItemVariableEntry, isPromptTextVariableEntry } from "../common/chatVariableEntries.js";
...
let ChatInputPart = class ChatInputPart2 extends Disposable {
  ...
  get currentMode() {
    return this._currentMode.kind === ChatMode.Agent && !this.agentService.hasToolsAgent ? ChatMode.Edit : this._currentMode.kind;
  }
  get currentMode2() {
    ...
    this.inputActionsToolbar = this._register(this.instantiationService.createInstance(MenuWorkbenchToolBar, toolbarsContainer, MenuId.ChatInput, {
      ...
      actionViewItemProvider: /* @__PURE__ */ __name((action, options2) => {
        if (action.id === ChatOpenModelPickerActionId && action instanceof MenuItemAction) {
          ...
          const delegate = {
            getMode: /* @__PURE__ */ __name(() => this.currentMode2, "getMode"),
