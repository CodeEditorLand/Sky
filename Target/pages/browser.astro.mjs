...
import { $ as $$Browser$1 } from '../chunks/Browser_DUwBaTzG.mjs';
...
const $$Browser = createComponent(($$result, $$props, $$slots) => {
  ...
  }), "data-settings")}><meta id="vscode-workbench-auth-session"${addAttribute(JSON.stringify({}), "data-settings")}>`, "default": ($$result2) => renderTemplate`            ${Bundle ? renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate` ${renderScript($$result3, "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/Land/Element/Sky/Source/pages/Browser.astro?astro&type=script&index=0&lang.ts")} ${renderComponent($$result3, "BrowserWorkbench", $$Browser$1, {})} ` })}` : renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate(_b || (_b = __template([' <script type="module"', ' defer><\/script> <script type="module"', '><\/script> <script type="module"', " defer><\/script> ", " "])), addAttribute(Bust("/Worker/CSS/Load.js"), "src"), addAttribute(Bust("/Worker/Policy.js"), "src"), addAttribute(Bust("/Worker/Register.js"), "src"), renderComponent($$result3, "BrowserWorkbench", $$Browser$1, {})) })}`}` })}`;
}, "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/Land/Element/Sky/Source/pages/Browser.astro", void 0);

const $$file = "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/Land/Element/Sky/Source/pages/Browser.astro";
const $$url = "/Browser";
