...
` +
	...
	(function (e) {
			...
			return (b, C = null, A) => {
				...
				return (
					(T = w(
						(B) => {
							if (!k)
								return T ? T.dispose() : (k = !0), b.call(C, B);
						},
						null,
						A,
					)),
		...
		e.once = n;
		function r(w, b, C) {
			return c((A, k = null, T) => w((B) => A.call(k, b(B)), null, T), C);
		}
		e.map = r;
		function s(w, b, C) {
			return c(
		...
		function i(w, b, C) {
			return c(
				(A, k = null, T) => w((B) => b(B) && A.call(k, B), null, T),
				C,
			);
		}
		e.filter = i;
		...
		function l(...w) {
			return (b, C = null, A) => {
				const k = ss(...w.map((T) => T((B) => b.call(C, B))));
				return f(k, A);
			};
		}
		e.any = l;
		...
		function h(w, b, C = 100, A = !1, k = !1, T, B) {
			let X,
				Y,
				He,
				gt = 0,
			...
			return (b, C, A) => {
				...
				const B = {
					...
					endUpdate() {
						k--,
							k === 0 &&
								(w.reportChanges(), T && ((T = !1), b.call(C)));
					},
				...
				return (
					A instanceof ye ? A.add(X) : Array.isArray(A) && A.push(X),
					X
				);
			};
		}
...
`),
	...
	class se {
		...
		fire(t) {
			...
			if (
				...
				if (this._listeners instanceof vt)
					this._deliver(this._listeners, t);
				else {
					const o = this._deliveryQueue;
					o.enqueue(this, t, this._listeners.length),
						this._deliverQueue(o);
				}
	...
	typeof Le.vscode < "u" && typeof Le.vscode.process < "u"
		? (Q = Le.vscode.process)
		: typeof process < "u" &&
			typeof ((Lt = process == null ? void 0 : process.versions) ===
				null || Lt === void 0
				? void 0
				: Lt.node) == "string" &&
			(Q = process);
	const ps =
		typeof ((Nt = Q?.versions) === null || Nt === void 0
			? void 0
			: Nt.electron) == "string" && Q?.type === "renderer";
	if (typeof Q == "object") {
		(St = Q.platform === "win32"),
	...
	function zs(e, t, n) {
		return new ge(new ln(e), new ln(t)).ComputeDiff(n).changes;
	}
	class Fe {
		static Assert(t, n) {
	...
	class ge {
		constructor(t, n, r = null) {
			...
			const [s, i, o] = ge._getElements(t),
				[l, u, c] = ge._getElements(n);
		...
		ComputeDiffRecursive(t, n, r, s, i) {
			...
			const o = [0],
				l = [0],
				u = this.ComputeRecursionPoint(t, n, r, s, o, l, i),
				c = o[0],
				f = l[0];
			if (u !== null) return u;
			if (!i[0]) {
		...
		WALKTRACE(t, n, r, s, i, o, l, u, c, f, h, d, m, g, x, v, L, S) {
			let _ = null,
				N = null,
				p = new un(),
				R = n,
	...
	if (typeof Et < "u" && typeof Et.process < "u") {
		...
		typeof process < "u"
			? (De = {
					...
					cwd() {
						return cn.VSCODE_CWD || process.cwd();
					},
				})
			: (De = {
					get platform() {
	...
	function Ys(e, t) {
		if (e === null || typeof e != "object") throw new hn(t, "Object", e);
	}
	function $(e, t) {
		if (typeof e != "string") throw new hn(t, "string", e);
	}
	const xe = Os === "win32";
	function P(e) {
		return e === j || e === K;
	...
	const Z = {
			...
			relative(e, t) {
				...
				return (
					...
					m.length > 0
						? `${m}${r.slice(l, u)}`
						: (r.charCodeAt(l) === K && ++l, r.slice(l, u))
				);
			},
			toNamespacedPath(e) {
	...
	class Te extends Se {
		...
		toString(t = !1) {
			return t
				? Ft(this, !0)
				: (this._formatted || (this._formatted = Ft(this, !1)),
					this._formatted);
		}
		toJSON() {
			const t = { $mid: 1 };
			return (
				this._fsPath && ((t.fsPath = this._fsPath), (t._sep = dn)),
	...
	function ai(e) {
		...
		for (let n = 0; n < e.length; n++) {
			const r = e.charCodeAt(n);
			r === 35 || r === 63
				? (t === void 0 && (t = e.substr(0, n)), (t += mn[r]))
				: t !== void 0 && (t += e[n]);
		}
		return t !== void 0 ? t : e;
	}
	...
	function Ft(e, t) {
		const n = t ? ai : gn;
		let r = "",
			{ scheme: s, authority: i, path: o, query: l, fragment: u } = e;
		if (
			(s && ((r += s), (r += ":")),
			(i || s === "file") && ((r += ae), (r += ae)),
			i)
	...
	function bn(e) {
		try {
			...
			return e.length > 3 ? e.substr(0, 3) + bn(e.substr(3)) : e;
		}
	}
	const _n = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
	function it(e) {
		return e.match(_n) ? e.replace(_n, (t) => bn(t)) : e;
	}
	class J {
		constructor(t, n) {
	...
	class F {
		...
		static intersectRanges(t, n) {
			...
			return (
				...
				r > i || (r === i && s > o) ? null : new F(r, s, i, o)
			);
		}
		equalsRange(t) {
	...
	const Ln = new is();
	Ln.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
	function Pt(e, t, n, r, s) {
		if (((t = wn(t)), s || (s = Ke.first(Ln)), n.length > s.maxLen)) {
			let c = e - s.maxLen / 2;
			return (
				c < 0 ? (c = 0) : (r += c),
			...
			for (let i = 1, o = t.getLineCount(); i <= o; i++) {
				...
				for (; c < u; ) {
					...
					if (d === 13) {
						...
						_ === 1 &&
							(s.push(lt._createLink(r, l, i, f, c)), (L = !0));
					} else if (d === 12) {
						let _;
				...
				d === 13 && s.push(lt._createLink(r, l, i, f, u));
			}
			return s;
		}
	}
	...
	class Vt {
		...
		valueSetsReplace(t, n, r) {
			let s = null;
			for (let i = 0, o = t.length; s === null && i < o; i++)
	...
	(function () {
		const e = "",
			...
			r = [];
		for (const s of t) {
			const [i, o, l, u, c, f, h, d, m] = s;
			if (
				(r[o] || ((r[o] = !0), (Ai[l] = o), (Ri[l.toLowerCase()] = o)),
				!n[u])
			) {
				if (((n[u] = !0), !c))
					throw new Error(
	...
	(function (e) {
		...
		function i(l) {
			return Bt.strToKeyCode(l) || qt.strToKeyCode(l);
		}
	...
	class $i {
		static computeUnicodeHighlights(t, n, r) {
			...
			l === "allNonBasicAscii"
				? (u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
				: (u = new RegExp(`${Oi(Array.from(l))}`, "g"));
			...
			e: for (let v = s, L = i; v <= L; v++) {
				...
				do
					if (((d = c.next(S)), d)) {
						...
						const E = o.shouldHighlightNonBasicASCII(
							R,
							y ? y.word : null,
						);
						if (E !== 0) {
...
` ||
	...
	class ce {
		...
		subtractFrom(t) {
			...
			for (let o = n; o < r; o++) {
				...
				l.startLineNumber > i && s.push(new D(i, l.startLineNumber)),
	...
	class oe {
		static inverse(t, n, r) {
			...
			const l = new oe(new D(i, n + 1), new D(o, r + 1));
		...
		static clip(t, n, r) {
			...
			for (const i of t) {
				...
				o && !o.isEmpty && l && !l.isEmpty && s.push(new oe(o, l));
			}
			return s;
		}
		constructor(t, n) {
	...
	let Dr = class {
		...
		createCharSequence(t, n, r) {
			...
			for (let u = n; u <= r; u++) {
				...
				for (let d = f; d < h; d++)
					(s[l] = c.charCodeAt(d - 1)),
						(i[l] = u + 1),
						(o[l] = d),
						l++;
				!t &&
					u < r &&
					((s[l] = 10), (i[l] = u + 1), (o[l] = c.length + 1), l++);
			}
			return new Yi(s, i, o);
		}
	};
	...
	class Ki {
		constructor(t, n, r) {
			(this.shouldComputeCharChanges = r.shouldComputeCharChanges),
				...
				(this.original = new Dr(t)),
				(this.modified = new Dr(n)),
				(this.continueLineDiff = Tr(r.maxComputationTime)),
				(this.continueCharDiff = Tr(
		...
		_pushTrimWhitespaceCharChange(t, n, r, s, i, o, l) {
			if (this._mergeTrimWhitespaceCharChange(t, n, r, s, i, o, l))
				return;
			let u;
			this.shouldComputeCharChanges &&
				(u = [new Be(n, r, n, s, i, o, i, l)]),
				t.push(new Xe(n, n, i, i, u));
		}
		_mergeTrimWhitespaceCharChange(t, n, r, s, i, o, l) {
			const u = t.length;
			if (u === 0) return !1;
			const c = t[u - 1];
			return c.originalEndLineNumber === 0 ||
				...
				: c.originalEndLineNumber === n && c.modifiedEndLineNumber === i
					? (this.shouldComputeCharChanges &&
							c.charChanges &&
							c.charChanges.push(new Be(n, r, n, s, i, o, i, l)),
						!0)
...
`);
		...
		computeSimilarity(t) {
			...
			for (let o = 0; o < i; o++)
				s += Math.abs(
					((n = this.histogram[o]) !== null && n !== void 0 ? n : 0) -
						((r = t.histogram[o]) !== null && r !== void 0 ? r : 0),
				);
		...
		compute(t, n, r = Qe.instance, s) {
			...
			for (let g = 0; g < t.length; g++)
				for (let x = 0; x < n.length; x++) {
					...
					if (_ === S) {
						const N = g > 0 && x > 0 ? l.get(g - 1, x - 1) : 0;
						l.set(g, x, N + 1), o.set(g, x, 3);
					} else
						_ === v
							? (l.set(g, x, 0), o.set(g, x, 1))
							: _ === L && (l.set(g, x, 0), o.set(g, x, 2));
					i.set(g, x, _);
				}
			const u = [];
			let c = t.length,
	...
	class Vr {
		compute(t, n, r = Qe.instance) {
			...
			u.set(0, o(0, 0));
			const c = new ra();
			c.set(0, u.get(0) === 0 ? null : new Ir(null, 0, 0, u.get(0)));
			let f = 0;
			e: for (;;) {
				if ((l++, !r.isValid())) return fe.trivialTimedOut(s, i);
				const x = -Math.min(l, i.length + (l % 2)),
					v = Math.min(l, s.length + (l % 2));
				for (f = x; f <= v; f += 2) {
					...
					if (
						(c.set(f, p !== _ ? new Ir(R, _, N, p - _) : R),
			...
			for (;;) {
				...
				if (
					((x !== m || v !== g) &&
						d.push(new z(new V(x, m), new V(v, g))),
					!h)
				)
					break;
	...
	class mt {
		...
		getBoundaryScore(t) {
			const n = qr(t > 0 ? this.elements[t - 1] : -1),
				r = qr(t < this.elements.length ? this.elements[t] : -1);
			if (n === 7 && r === 8) return 0;
			if (n === 8) return 150;
			let s = 0;
			return (
	...
	function ia(e, t, n, r, s, i) {
		let { moves: o, excludedChanges: l } = oa(e, t, n, i);
		if (!i.isValid()) return [];
...
`).length >= 15 && aa(h, (m) => m.length >= 2) >= 2
	...
	function la(e, t, n, r, s, i) {
		...
		const u = [];
		e.sort(at((d) => d.modified.startLineNumber, ot));
		for (const d of e) {
			let m = [];
			for (
		...
		u.sort(fi(at((d) => d.modifiedLineRange.length, ot)));
		const c = new ce(),
			f = new ce();
		for (const d of u) {
			const m =
			...
			for (const L of v.ranges) {
				...
				const S = L,
					_ = L.delta(-m);
				o.push(new oe(_, S)), c.addRange(S), f.addRange(_);
			}
		}
		o.sort(at((d) => d.original.startLineNumber, ot));
		const h = new je(e);
	...
	function Ur(e, t, n) {
		...
		const s = new Vr().compute(
			new mt([e], new V(0, 1), !1),
			new mt([t], new V(0, 1), !1),
			n,
		);
		let i = 0;
		const o = z.invert(s.diffs, e.length);
		for (const f of o)
	...
	function ua(e) {
		...
		e.sort(at((n) => n.original.startLineNumber, ot));
		const t = [e[0]];
	...
	function Hr(e, t, n) {
		let r = n;
		return (r = Wr(e, t, r)), (r = Wr(e, t, r)), (r = ha(e, t, r)), r;
	}
	function Wr(e, t, n) {
	...
	function zr(e, t, n, r, s) {
		...
		for (
			...
			e.seq2Range.endExclusive + l < s.endExclusive &&
			n.isStronglyEqual(
				e.seq2Range.start + l,
	...
	function da(e, t, n) {
		...
		function o(u, c) {
			...
			g + x < ((d.seq1Range.length + d.seq2Range.length) * 2) / 3 &&
				s.push(d),
		...
		do {
			...
			for (let u = 1; u < r.length; u++) {
				let h = function (m, g) {
					...
					return (
						Math.pow(
							Math.pow(w(S * 40 + _), 1.5) +
								Math.pow(w(N * 40 + p), 1.5),
							1.5,
						) +
							Math.pow(
								Math.pow(w(R * 40 + y), 1.5) +
									Math.pow(w(E * 40 + q), 1.5),
								1.5,
							) >
						(G ** 1.5) ** 1.5 * 1.3
					);
		...
		return (
			ci(r, (l, u, c) => {
				...
				const x = z.fromOffsetPairs(
						l ? l.getEndExclusives() : ne.zero,
						c ? c.getStarts() : ne.max,
					),
					v = f.intersect(x);
				o.length > 0 &&
				v.getStarts().equals(o[o.length - 1].getEndExclusives())
					? (o[o.length - 1] = o[o.length - 1].join(v))
					: o.push(v);
			}),
			o
		);
	...
	class $r {
		...
		getBoundaryScore(t) {
			const n = t === 0 ? 0 : Or(this.lines[t - 1]),
				r = t === this.lines.length ? 0 : Or(this.lines[t]);
			return 1e3 - (n + r);
		}
		getText(t) {
...
`);
	...
	class _a {
		...
		computeDiff(t, n, r) {
			...
			function l(p) {
				let R = o.get(p);
				return R === void 0 && ((R = o.size), o.set(p, R)), R;
			}
			const u = t.map((p) => l(p.trim())),
				c = n.map((p) => l(p.trim())),
				f = new $r(u, t),
				h = new $r(c, n),
				d =
			...
			for (const p of m) {
				...
				v(R),
					(L = p.seq1Range.endExclusive),
					(S = p.seq2Range.endExclusive);
		...
		computeMoves(t, n, r, s, i, o, l) {
			return ia(t, n, r, s, i, o).map((f) => {
				const h = this.refineDiff(
					...
					d = Gr(h.mappings, n, r, !0);
				return new Gi(f, d);
			});
		}
		refineDiff(t, n, r, s, i) {
			const o = new mt(t, r.seq1Range, i),
				l = new mt(n, r.seq2Range, i),
				u =
					o.length + l.length < 500
						? this.dynamicProgrammingDiffing.compute(o, l, s)
						: this.myersDiffingAlgorithm.compute(o, l, s);
			let c = u.diffs;
			return (
				(c = Hr(o, l, c)),
				(c = da(o, l, c)),
				...
				(c = ba(o, l, c)),
				{
					mappings: c.map(
						(h) =>
							new ve(
								o.translateRange(h.seq1Range),
								l.translateRange(h.seq2Range),
							),
					),
	...
	const jr = { getLegacy: () => new Ji(), getDefault: () => new _a() };
	function we(e, t) {
	...
	function Jr(e, t, n) {
		...
		const s = t[0].values(),
			i = Xr(s),
			o = new I(new re(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
		return { range: e, color: Jt(o.rgba.r, o.rgba.g, o.rgba.b, o.rgba.a) };
	}
	function Ye(e, t) {
	...
	function Aa(e, t, n) {
		...
		if (r) {
			...
			if (o.endColumn > o.startColumn) {
				const l = { range: o, ...Zr(r[1]), shouldBeInComments: !0 };
	...
	class Ra extends gi {
		...
		getWordAtPosition(t, n) {
			const r = Pt(t.column, wn(n), this._lines[t.lineNumber - 1], 0);
			return r
	...
	class Ce {
		...
		async computeDiff(t, n, r, s) {
			const i = this._getModel(t),
				o = this._getModel(n);
			return !i || !o ? null : Ce.computeDiff(i, o, r, s);
		}
		static computeDiff(t, n, r, s) {
			const i = s === "advanced" ? jr.getDefault() : jr.getLegacy(),
				o = t.getLinesContent(),
				l = n.getLinesContent(),
				u = i.computeDiff(o, l, r),
		...
		async computeMoreMinimalEdits(t, n, r) {
			...
			for (let u = 1; u < n.length; u++)
				F.getEndPosition(n[l].range).equals(
					F.getStartPosition(n[u].range),
				)
					? ((n[l].range = F.fromPositions(
							F.getStartPosition(n[l].range),
			...
			for (let { range: u, text: c, eol: f } of n) {
				if ((typeof f == "number" && (o = f), F.isEmpty(u) && !c))
					continue;
			...
			e: for (const u of t) {
				...
				if (c) {
					for (const f of c.words(o))
						if (
							!(f === n || !isNaN(Number(f))) &&
							(l.add(f), l.size > Ce._suggestionsLimit)
						)
							break e;
				}
			}
		...
		loadForeignModule(t, n, r) {
			const o = {
				host: gs(r, (l, u) => this._host.fhr(l, u)),
...
//# sourceMappingURL=editor.worker-MnaSPjGA.js.map
