...
` +
	...
	function ka(e) {
		return e instanceof Aa
			? !0
			: e instanceof Error && e.name === en && e.message === en;
	}
	...
	let Q = class si {
		constructor(t) {
			(this.element = t),
				(this.next = si.Undefined),
				(this.prev = si.Undefined);
		}
	};
	...
	(function (e) {
			...
			return (b, E = null, y) => {
				...
				return (
					(N = v(
						(I) => {
							if (!L)
								return N ? N.dispose() : (L = !0), b.call(E, I);
						},
						null,
						y,
					)),
		...
		e.once = n;
		function i(v, b, E) {
			return l((y, L = null, N) => v((I) => y.call(L, b(I)), null, N), E);
		}
		e.map = i;
		function r(v, b, E) {
			return l(
		...
		function s(v, b, E) {
			return l(
				(y, L = null, N) => v((I) => b(I) && y.call(L, I), null, N),
				E,
			);
		}
		e.filter = s;
		...
		function u(...v) {
			return (b, E = null, y) => {
				const L = La(...v.map((N) => N((I) => b.call(E, I))));
				return c(L, y);
			};
		}
		e.any = u;
		...
		function l(v, b) {
			...
			const y = {
				...
				L = new _e(y);
			return b?.add(L), L.event;
		}
		function c(v, b) {
			return b instanceof Array ? b.push(v) : b && b.add(v), v;
		}
		function d(v, b, E = 100, y = !1, L = !1, N, I) {
			let P,
				U,
				W,
				G = 0,
		...
		class T {
			...
			reduce(b, E) {
				let y = E;
				return this.steps.push((L) => ((y = b(y, L)), y)), this;
			}
			latch(b = (E, y) => E === y) {
				let E = !0,
					y;
		...
		function A(v, b, E = (y) => y) {
			const y = (...P) => I.fire(E(...P)),
				L = () => v.on(b, y),
				N = () => v.removeListener(b, y),
				I = new _e({
		...
		function M(v, b, E = (y) => y) {
			const y = (...P) => I.fire(E(...P)),
				L = () => v.addEventListener(b, y),
				N = () => v.removeEventListener(b, y),
				I = new _e({
					onWillAddFirstListener: L,
					onDidRemoveLastListener: N,
				});
			...
			return (b, E, y) => {
				...
				const I = {
					...
					endUpdate() {
						L--,
							L === 0 &&
								(v.reportChanges(), N && ((N = !1), b.call(E)));
					},
	...
	class nn {
		static create() {
			var t;
			const n = new Error();
			return new nn((t = n.stack) !== null && t !== void 0 ? t : "");
		}
		constructor(t) {
			this.value = t;
		}
...
`),
	...
	class _e {
		...
		fire(t) {
			...
			if (
				...
				if (this._listeners instanceof rn)
	...
	typeof Oe.vscode < "u" && typeof Oe.vscode.process < "u"
		...
		: typeof process < "u" &&
			typeof ((an = process == null ? void 0 : process.versions) ===
				null || an === void 0
				? void 0
				: an.node) == "string" &&
			(ae = process);
	const qa =
		typeof ((on = ae?.versions) === null || on === void 0
			? void 0
			: on.electron) == "string" && ae?.type === "renderer";
	if (typeof ae == "object") {
		(ln = ae.platform === "win32"),
			(un = ae.platform === "darwin"),
			(cn = ae.platform === "linux"),
			cn && ae.env.SNAP && ae.env.SNAP_REVISION,
		...
		typeof navigator == "object" && !qa
			? ((we = navigator.userAgent),
				(ln = we.indexOf("Windows") >= 0),
				(un = we.indexOf("Macintosh") >= 0),
				(we.indexOf("Macintosh") >= 0 ||
					we.indexOf("iPad") >= 0 ||
					we.indexOf("iPhone") >= 0) &&
					navigator.maxTouchPoints &&
					navigator.maxTouchPoints > 0,
				(cn = we.indexOf("Linux") >= 0),
				we?.indexOf("Mobi") >= 0,
				X(
					{
	...
	(Ze = Ve),
		(Ve.ambiguousCharacterData = new ci(() =>
			JSON.parse(
	...
	class lo {
		...
		_handleRequestMessage(t) {
			...
			this._handler.handleMessage(t.method, t.args).then(
				(r) => {
					this._send(new di(this._workerId, n, r, void 0));
				},
				(r) => {
					r.detail instanceof Error && (r.detail = oi(r.detail)),
						this._send(new di(this._workerId, n, void 0, oi(r)));
				},
			);
		}
		...
		initialize(t, n, i, r) {
			...
			return this._requestHandlerFactory
				? ((this._requestHandler = this._requestHandlerFactory(u)),
					Promise.resolve(sn(this._requestHandler)))
				: (n &&
	...
	function ho(e, t) {
		t = pi(149417, t);
		for (let n = 0, i = e.length; n < i; n++) t = pi(e.charCodeAt(n), t);
		return t;
	}
	class gi {
		constructor(t) {
	...
	function mo(e, t, n) {
		return new ze(new gi(e), new gi(t)).ComputeDiff(n).changes;
	}
	class Ke {
		static Assert(t, n) {
			...
			for (let p = 1; p <= w / 2 + 1; p++) {
				...
				for (let b = m; b <= f; b += 2) {
					...
					for (; o > t && l > i && this.ElementsAreEqual(o, l); )
						o--, l--;
					if (((x[b] = o), _ && Math.abs(b - T) <= p && o <= S[b]))
						return (
							(s[0] = o),
							(a[0] = l),
							E >= S[b] && p <= 1448
	...
	if (typeof mn < "u" && typeof mn.process < "u") {
		...
		typeof process < "u"
			? (tt = {
					...
					cwd() {
						return _i.VSCODE_CWD || process.cwd();
					},
				})
			: (tt = {
					get platform() {
	...
	function yo(e, t) {
		if (e === null || typeof e != "object") throw new wi(t, "Object", e);
	}
	function K(e, t) {
		if (typeof e != "string") throw new wi(t, "string", e);
	}
	const We = po === "win32";
	function q(e) {
		return e === re || e === ue;
	...
	let pn = class Kt {
		...
		static joinPath(t, ...n) {
			...
			return (
				dt && t.scheme === "file"
					? (i = Kt.file(oe.join(gn(t, !0), ...n)).path)
					: (i = ce.join(t.path, ...n)),
				t.with({ path: i })
			);
		}
	...
	class nt extends pn {
		...
		toString(t = !1) {
			return t
				? bn(this, !0)
				: (this._formatted || (this._formatted = bn(this, !1)),
					this._formatted);
		}
		toJSON() {
			const t = { $mid: 1 };
			return (
				this._fsPath && ((t.fsPath = this._fsPath), (t._sep = yi)),
	...
	function Ro(e) {
		...
		for (let n = 0; n < e.length; n++) {
			const i = e.charCodeAt(n);
			i === 35 || i === 63
				? (t === void 0 && (t = e.substr(0, n)), (t += xi[i]))
				: t !== void 0 && (t += e[n]);
		}
		return t !== void 0 ? t : e;
	}
	...
	function ki(e) {
		try {
			...
			return e.length > 3 ? e.substr(0, 3) + ki(e.substr(3)) : e;
		}
	}
	const Ai = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
	function Nt(e) {
		return e.match(Ai) ? e.replace(Ai, (t) => ki(t)) : e;
	}
	let Le = class $e {
			constructor(t, n) {
	...
	const Ri = new Ca();
	Ri.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
	function _n(e, t, n, i, r) {
		if (((t = Ei(t)), r || (r = St.first(Ri)), n.length > r.maxLen)) {
			let l = e - r.maxLen / 2;
			return (
				l < 0 ? (l = 0) : (i += l),
	...
	class wn {
		constructor(t) {
			...
			(this._defaultValue = n),
				(this._asciiMap = wn._createAsciiMap(n)),
				(this._map = new Map());
		}
			...
			for (let s = 1, a = t.getLineCount(); s <= a; s++) {
				...
				for (; l < o; ) {
					...
					if (m === 13) {
						...
						A === 1 &&
							(r.push(zt._createLink(i, u, s, c, l)), (x = !0));
					} else if (m === 12) {
						let A;
				...
				m === 13 && r.push(zt._createLink(i, u, s, c, o));
			}
			return r;
		}
	}
	...
	yn.INSTANCE = new yn();
	const Mi = Object.freeze(function (e, t) {
	...
	(function (e) {
		function t(n) {
			return n === e.None || n === e.Cancelled || n instanceof Ut
				? !0
				: !n || typeof n != "object"
					? !1
	...
	class Xo {
		...
		cancel() {
			this._token
				? this._token instanceof Ut && this._token.cancel()
		...
		dispose(t = !1) {
			...
			t && this.cancel(),
				(n = this._parentListener) === null ||
					...
					n.dispose(),
				this._token
					? this._token instanceof Ut && this._token.dispose()
					: (this._token = Ht.None);
		}
	}
	class xn {
	...
	(function (e) {
		function t(u) {
			return Wt.keyCodeToStr(u);
		}
		e.toString = t;
		function n(u) {
			return Wt.strToKeyCode(u);
		}
		e.fromString = n;
		function i(u) {
			return Tn.keyCodeToStr(u);
		}
		...
		function s(u) {
			return Tn.strToKeyCode(u) || kn.strToKeyCode(u);
		}
	...
	(function (e) {
		(e[(e.acceptSuggestionOnCommitCharacter = 0)] =
			...
			(e[(e.colorDecoratorsActivatedOn = 148)] =
...
` ||
	...
	function En(e, t, n = 0, i = e.length) {
		let r = n,
			s = i;
		for (; r < s; ) {
			const a = Math.floor((r + s) / 2);
		...
		static createFromDiffResult(t, n, i, r, s, a, u) {
			...
			if (
				...
				if (f.getElements().length > 0 && w.getElements().length > 0) {
					let g = Br(f, w, s, !0).changes;
					u && (g = xl(g)), (m = []);
					for (let S = 0, x = g.length; S < x; S++)
						m.push(st.createFromDiffChange(g[S], f, w));
				}
			}
	...
	class Tl {
		constructor(t, n, i) {
			(this.shouldComputeCharChanges = i.shouldComputeCharChanges),
				...
				(this.original = new qr(t)),
				(this.modified = new qr(n)),
				(this.continueLineDiff = Or(i.maxComputationTime)),
				(this.continueCharDiff = Or(
...
`);
	...
	class Al {
		compute(t, n, i = _t.instance, r) {
			...
			const s = new Nn(t.length, n.length),
				a = new Nn(t.length, n.length),
				u = new Nn(t.length, n.length);
	...
	class Vr {
		compute(t, n, i = _t.instance) {
			...
			o.set(0, a(0, 0));
			const l = new Ll();
			l.set(0, o.get(0) === 0 ? null : new jr(null, 0, 0, o.get(0)));
			let c = 0;
			e: for (;;) {
				...
				for (c = g; c <= S; c += 2) {
					...
					if (
						(l.set(c, R !== A ? new jr(D, A, M, R - A) : D),
			...
			for (;;) {
				...
				if (
					((g !== f || S !== w) &&
						m.push(new Z(new V(g, f), new V(S, w))),
					!d)
				)
					break;
	...
	class Bt {
		...
		getBoundaryScore(t) {
			const n = $r(t > 0 ? this.elements[t - 1] : -1),
				i = $r(t < this.elements.length ? this.elements[t] : -1);
			if (n === 7 && i === 8) return 0;
			if (n === 8) return 150;
			let r = 0;
			return (
		...
		findWordContaining(t) {
			if (t < 0 || t >= this.elements.length || !In(this.elements[t]))
				return;
			let n = t;
			for (; n > 0 && In(this.elements[n - 1]); ) n--;
			let i = t;
			for (; i < this.elements.length && In(this.elements[i]); ) i++;
			return new V(n, i);
		}
		countLinesIn(t) {
			return (
...
`).length >= 15 && Rl(d, (f) => f.length >= 2) >= 2
	...
	function Nl(e, t, n, i, r, s) {
		...
		const o = [];
		e.sort(Dt((m) => m.modified.startLineNumber, It));
		for (const m of e) {
			let f = [];
			for (
		...
		o.sort(Ho(Dt((m) => m.modifiedLineRange.length, It)));
		const l = new Ce(),
			c = new Ce();
		for (const m of o) {
			const f =
		...
		a.sort(Dt((m) => m.original.startLineNumber, It));
		const d = new gt(e);
		for (let m = 0; m < a.length; m++) {
			...
			for (M = 0; M < S; M++) {
				const D = f.original.startLineNumber - M - 1,
					_ = f.modified.startLineNumber - M - 1;
				if (
					D > i.length ||
					_ > r.length ||
					l.contains(_) ||
			...
			for (R = 0; R < A; R++) {
				const D = f.original.endLineNumberExclusive + R,
					_ = f.modified.endLineNumberExclusive + R;
				if (
					D > i.length ||
					_ > r.length ||
					l.contains(_) ||
	...
	function Xr(e, t, n) {
		...
		const r = new Vr().compute(
			new Bt([e], new V(0, 1), !1),
			new Bt([t], new V(0, 1), !1),
			n,
		);
		let s = 0;
		...
		function u(c) {
			let d = 0;
			for (let m = 0; m < e.length; m++) Dn(c.charCodeAt(m)) || d++;
			return d;
		}
	...
	function Dl(e) {
		...
		e.sort(Dt((n) => n.original.startLineNumber, It));
		const t = [e[0]];
	...
	function Jr(e, t, n) {
		let i = n;
		return (i = Qr(e, t, i)), (i = Qr(e, t, i)), (i = zl(e, t, i)), i;
	}
	function Qr(e, t, n) {
		...
		do {
			...
			for (let o = 1; o < i.length; o++) {
				let d = function (f, w) {
					...
					return (
						Math.pow(
							Math.pow(v(T * 40 + A), 1.5) +
								Math.pow(v(M * 40 + R), 1.5),
							1.5,
						) +
							Math.pow(
								Math.pow(v(D * 40 + _), 1.5) +
		...
		return (
			Io(i, (u, o, l) => {
				...
				const g = Z.fromOffsetPairs(
					...
					S = c.intersect(g);
				a.length > 0 &&
				S.getStarts().equals(a[a.length - 1].getEndExclusives())
	...
	class Zr {
		...
		getBoundaryScore(t) {
			const n = t === 0 ? 0 : Kr(this.lines[t - 1]),
				i = t === this.lines.length ? 0 : Kr(this.lines[t]);
			return 1e3 - (n + i);
		}
		getText(t) {
...
`);
	...
	class Bl {
		constructor() {
			(this.dynamicProgrammingDiffing = new Al()),
				(this.myersDiffingAlgorithm = new Vr());
		}
		computeDiff(t, n, i) {
			...
			let x = 0,
				T = 0;
			for (const R of f) {
				Ft(() => R.seq1Range.start - x === R.seq2Range.start - T);
				const D = R.seq1Range.start - x;
				S(D),
					(x = R.seq1Range.endExclusive),
					(T = R.seq2Range.endExclusive);
				const _ = this.refineDiff(t, n, R, r, s);
				_.hitTimeout && (w = !0);
					...
					for (const _ of A) {
						...
						for (const p of _.innerChanges)
							if (
								...
								return !1;
						if (!D(_.modified, n) || !D(_.original, t)) return !1;
					}
					return !0;
				}),
				new Pt(A, M, w)
		...
		computeMoves(t, n, i, r, s, a, u) {
			return El(t, n, i, r, s, a).map((c) => {
				const d = this.refineDiff(
					...
					m = es(d.mappings, n, i, !0);
				return new gl(c, m);
			});
		}
		refineDiff(t, n, i, r, s) {
			const a = new Bt(t, i.seq1Range, s),
				u = new Bt(n, i.seq2Range, s),
				o =
	...
	const ts = { getLegacy: () => new vl(), getDefault: () => new Bl() };
	function Be(e, t) {
	...
	function is(e, t, n) {
		...
		const r = t[0].values(),
			s = ns(r);
		return { range: e, color: zn(s[0], s[1], s[2], n ? s[3] : 1) };
	}
	function rs(e, t, n) {
		if (!e || t.length !== 1) return;
		const r = t[0].values(),
		...
		return { range: e, color: zn(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a) };
	}
	function vt(e, t) {
	...
	function Ql(e, t, n) {
		...
		if (i) {
			...
			if (a.endColumn > a.startColumn) {
				const u = { range: a, ...as(i[1]), shouldBeInComments: !0 };
	...
	class Yl extends Fo {
		...
		getWordAtPosition(t, n) {
			const i = _n(t.column, Ei(n), this._lines[t.lineNumber - 1], 0);
			return i
	...
	class je {
		...
		static computeDiff(t, n, i, r) {
			const s = r === "advanced" ? ts.getDefault() : ts.getLegacy(),
				a = t.getLinesContent(),
				u = n.getLinesContent(),
		...
		async navigateValueSet(t, n, i, r, s) {
			...
			return yn.INSTANCE.navigateValueSet(n, o, l, c, i);
		}
		loadForeignModule(t, n, i) {
			...
			return this._foreignModuleFactory
				? ((this._foreignModule = this._foreignModuleFactory(a, n)),
					Promise.resolve(sn(this._foreignModule)))
	...
	(function (e) {
		function t(i, r) {
			return (
				i === Number.MAX_VALUE && (i = qt.MAX_VALUE),
				r === Number.MAX_VALUE && (r = qt.MAX_VALUE),
				{ line: i, character: r }
			);
		}
		e.create = t;
	...
	(function (e) {
		...
		function n(i) {
			let r = i;
			return C.objectLiteral(r) && ie.is(r.start) && ie.is(r.end);
		}
		e.is = n;
	})(j || (j = {}));
	var Ot;
	...
	(function (e) {
		...
		function n(i) {
			const r = i;
			return C.objectLiteral(r) && j.is(r.range) && Wn.is(r.color);
		}
		e.is = n;
	})(hs || (hs = {}));
	var ds;
	(function (e) {
		...
		function n(i) {
			...
			return (
				C.objectLiteral(r) &&
				C.string(r.label) &&
				(C.undefined(r.textEdit) || se.is(r)) &&
				(C.undefined(r.additionalTextEdits) ||
					C.typedArray(r.additionalTextEdits, se.is))
			);
		}
		e.is = n;
	})(ds || (ds = {}));
	...
	(function (e) {
		function t(i, r, s, a, u, o) {
			...
			return (
				C.defined(s) && (l.startCharacter = s),
				C.defined(a) && (l.endCharacter = a),
				C.defined(u) && (l.kind = u),
				C.defined(o) && (l.collapsedText = o),
				l
			);
		}
		e.create = t;
	...
	(function (e) {
		...
		function n(i) {
			let r = i;
			return C.defined(r) && Ot.is(r.location) && C.string(r.message);
		}
		e.is = n;
	})(Fn || (Fn = {}));
	var fs;
	...
	(function (e) {
		function t(i, r, s, a, u, o) {
			...
			return (
				C.defined(s) && (l.severity = s),
				C.defined(a) && (l.code = a),
				C.defined(u) && (l.source = u),
				C.defined(o) && (l.relatedInformation = o),
				l
			);
		}
		e.create = t;
		function n(i) {
			...
			return (
				...
				(C.undefined(s.relatedInformation) ||
					C.typedArray(s.relatedInformation, Fn.is))
			);
		}
		e.is = n;
	})(jt || (jt = {}));
	...
	(function (e) {
		function t(i, r, ...s) {
			...
			return C.defined(s) && s.length > 0 && (a.arguments = s), a;
		}
		e.create = t;
		function n(i) {
			let r = i;
	...
	(function (e) {
		...
		function r(s) {
			const a = s;
			return C.objectLiteral(a) && C.string(a.newText) && j.is(a.range);
		}
		e.is = r;
	})(se || (se = {}));
	var Pn;
	...
	(function (e) {
		...
		function r(s) {
			const a = s;
			return se.is(a) && (Pn.is(a.annotationId) || ut.is(a.annotationId));
		}
		e.is = r;
	})(bs || (bs = {}));
	var Bn;
	(function (e) {
		...
		function n(i) {
			let r = i;
			return (
				C.defined(r) && Gn.is(r.textDocument) && Array.isArray(r.edits)
			);
		}
		e.is = n;
	})(Bn || (Bn = {}));
	...
	(function (e) {
		function t(n) {
			const i = n;
			return C.objectLiteral(n) && Ne.is(i.kind) && C.string(i.value);
		}
		e.is = t;
	})(yt || (yt = {}));
	var he;
	...
	(function (e) {
		...
		function n(i) {
			const r = i;
			return (
				r && C.string(r.newText) && j.is(r.insert) && j.is(r.replace)
			);
		}
		e.is = n;
	})(xs || (xs = {}));
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				C.defined(r) &&
				C.typedArray(r.diagnostics, jt.is) &&
				(r.only === void 0 || C.typedArray(r.only, C.string)) &&
				(r.triggerKind === void 0 ||
					r.triggerKind === Xt.Invoked ||
					r.triggerKind === Xt.Automatic)
			);
		}
		e.is = n;
	})(Is || (Is = {}));
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				C.defined(r) &&
				j.is(r.range) &&
				(C.undefined(r.command) || lt.is(r.command))
			);
		}
		e.is = n;
	})(Hs || (Hs = {}));
	...
	(function (e) {
		...
		function n(i) {
			const r = i;
			return r != null && j.is(r.range) && C.string(r.text);
		}
		e.is = n;
	})(qs || (qs = {}));
	var Os;
	...
	(function (e) {
		...
		function n(i) {
			const r = i;
			return C.defined(r) && j.is(i.stoppedLocation);
		}
		e.is = n;
	})(js || (js = {}));
	var Qn;
		...
		function n(i) {
			...
			return (
				...
				(r.tooltip === void 0 ||
					C.string(r.tooltip) ||
					yt.is(r.tooltip)) &&
				(r.location === void 0 || Ot.is(r.location)) &&
				(r.command === void 0 || lt.is(r.command))
			);
		}
		e.is = n;
	...
	(function (e) {
		...
		function n(i) {
			...
			return (
				(C.objectLiteral(r) &&
					ie.is(r.position) &&
					(C.string(r.label) || C.typedArray(r.label, Yn.is)) &&
					(r.kind === void 0 || Qn.is(r.kind)) &&
					r.textEdits === void 0) ||
				(C.typedArray(r.textEdits, se.is) &&
					(r.tooltip === void 0 ||
						C.string(r.tooltip) ||
						yt.is(r.tooltip)) &&
	...
	(function (e) {
		function t(n) {
			const i = n;
			return C.objectLiteral(i) && Un.is(i.uri) && C.string(i.name);
		}
		e.is = t;
	})(Ks || (Ks = {}));
	var ea;
	(function (e) {
		...
		function n(s) {
			...
			return !!(
				C.defined(a) &&
				C.string(a.uri) &&
				(C.undefined(a.languageId) || C.string(a.languageId)) &&
				C.uinteger(a.lineCount) &&
				C.func(a.getText) &&
				C.func(a.positionAt) &&
				C.func(a.offsetAt)
			);
...
` &&
	...
	var ta = class ai {
			...
			getLineOffsets() {
				return (
					this._lineOffsets === void 0 &&
						(this._lineOffsets = na(this._content, !0)),
					this._lineOffsets
				);
			}
			positionAt(t) {
	...
	(function (e) {
		function t(r, s, a, u) {
			return new ta(r, s, a, u);
		}
		e.create = t;
		function n(r, s, a) {
			if (r instanceof ta) return r.update(s, a), r;
			throw new Error(
		...
		function x() {
			...
			switch (s) {
				...
				case B.WithinContent:
					if (r.advanceIfChar(Qt)) {
						if (!r.eos() && r.peekChar() === sa) {
							if (r.advanceIfChars([sa, ct, ct]))
								return (
									(s = B.WithinComment),
						...
						return r.advanceIfChar(ti)
							? ((s = B.AfterOpeningEndTag), g(T, z.EndTagOpen))
							: ((s = B.AfterOpeningStartTag),
								g(T, z.StartTagOpen));
					}
					return r.advanceUntilChar(Qt), g(T, z.Content);
	...
	var oa = class {
			...
			findNodeBefore(e) {
				const t = aa(this.children, (n) => e <= n.start) - 1;
				if (t >= 0) {
	...
	var Eu = class {
		...
		_doComplete(e, t, n, i) {
			...
			function g(y, L = c) {
				return (
					y > c && (y = c),
					{ start: e.positionAt(y), end: e.positionAt(L) }
				);
			}
			function S(y, L) {
				const N = g(y, L);
			...
			function x(y) {
				let L = y;
				for (; L > 0; ) {
					const N = l.charAt(L - 1);
					if (
						`
\r`.indexOf(N) >= 0
					)
						return l.substring(L, y);
					if (!Zt(N)) return null;
					L--;
				}
			...
			function T(y, L, N = c) {
				const I = g(y, N),
					P = ca(l, N, B.WithinEndTag, z.EndTagClose) ? "" : ">";
				let U = d;
				for (L && (U = U.parent); U; ) {
					const W = U.tag;
					if (
			...
			const A = (y, L) => {
				...
				if (!this.dataManager.isVoidElement(L, u)) {
					const N = e.positionAt(y);
					r.items.push({
						label: "</" + L + ">",
						kind: he.Property,
						filterText: "</" + L + ">",
						textEdit: se.insert(N, "$0</" + L + ">"),
			...
			function M(y, L) {
				return S(y, L), T(y, !0, L), r;
			}
			function R() {
				const y = Object.create(null);
				return (
					d.attributeNames.forEach((L) => {
						y[L] = !0;
					}),
					y
				);
			...
			function D(y, L = c) {
				let N = c;
				for (; N < L && l[N] !== "<"; ) N++;
				const I = l.substring(y, L),
					P = g(y, N);
				let U = "";
				if (!ca(l, L, B.AfterAttributeName, z.DelimiterAssign)) {
			...
			function p(y, L = c) {
				...
				if (c > y && c <= L && Ru(l[y])) {
					...
					(N = g(G, $)),
						...
						(I = !1);
				} else (N = g(y, L)), (P = l.substring(y, c)), (I = !0);
				if (s.length > 0) {
			...
			function v() {
				...
				for (; y >= 0 && Tt(l, y); ) y--, L--;
				if (y >= 0 && l[y] === "&") {
					const N = j.create(ie.create(t.line, L - 1), t);
					for (const I in xt)
						if (fu(I, ";")) {
							const P = "&" + I;
							r.items.push({
				...
				switch (E) {
					...
					case z.EndTag:
						if (c <= m.getTokenEnd()) {
							...
							for (; y >= 0; ) {
								const L = l.charAt(y);
								if (L === "/") return T(y, !1, m.getTokenEnd());
								if (!Zt(L)) break;
								y--;
							}
						}
		...
		doesSupportMarkdown() {
			if (!Yt(this.supportsMarkdown)) {
				if (!Yt(this.lsOptions.clientCapabilities))
...
` &&
						...
						(T.prototype.foundNestedPseudoClass = function () {
							for (
								var A = 0, M = 1, R = this._input.peek(M);
								R;
							) {
								if (R === "{") return !0;
								if (R === "(") A += 1;
...
` &&
							...
							var ri = this._output.get_code(M);
							return ri;
						}),
...
`,
						...
						for (var y = null, L = E.next(); L.type !== c.EOF; )
							L.type === c.TAG_OPEN || L.type === c.COMMENT
								? ((y = this._handle_tag_open(b, L, v, H, E)),
									(v = y))
								: L.type === c.ATTRIBUTE ||
										L.type === c.EQUALS ||
										L.type === c.VALUE ||
										(L.type === c.TEXT && !v.tag_complete)
									? (y = this._handle_inside_tag(b, L, v, H))
									: L.type === c.TAG_CLOSE
										? (y = this._handle_tag_close(b, L, v))
										: L.type === c.TEXT
											? (y = this._handle_text(b, L, v))
											: L.type === c.CONTROL_FLOW_OPEN
												? (y =
								...
								(H = y),
								(L = E.next());
						var N = b._output.get_code(p);
						return N;
					}),
						(A.prototype._handle_control_flow_open = function (
							_,
							p,
						) {
						...
						(A.prototype._handle_control_flow_close = function (
							_,
							p,
						) {
							var k = { text: p.text, type: p.type };
						...
						(A.prototype._handle_tag_close = function (_, p, k) {
						...
						(A.prototype._handle_inside_tag = function (
							_,
							p,
							k,
							H,
						...
						(A.prototype._handle_text = function (_, p, k) {
						...
						(A.prototype._print_custom_beatifier_text = function (
							_,
							p,
							k,
						) {
...
` +
						...
						(A.prototype._handle_tag_open = function (
							_,
							p,
							k,
							H,
					...
					(A.prototype._get_tag_open_token = function (_) {
						var p = new M(this._tag_stack.get_parser_token(), _);
						return (
							(p.alignment_size =
								this._options.wrap_attributes_indent_size),
							(p.is_end_tag =
								p.is_end_tag ||
								S(p.tag_check, this._options.void_elements)),
							(p.is_empty_element =
								p.tag_complete ||
								(p.is_start_tag && p.is_end_tag)),
							(p.is_unformatted =
								!p.tag_complete &&
								S(p.tag_check, this._options.unformatted)),
						...
						(A.prototype._set_tag_position = function (
							_,
							p,
							k,
							H,
...
`) === -1) ||
						...
						(A.prototype._calcluate_parent_multiline = function (
							_,
							p,
						) {
							p.parent &&
					...
					(A.prototype._do_optional_end_element = function (_) {
						var p = null;
						if (
							!(
								_.is_empty_element ||
						...
						(w.prototype._read_comment_or_cdata = function (g) {
							...
							if (g === "<") {
								...
								A === "!" &&
									...
									x &&
										((S = this._create_token(m.COMMENT, x)),
										(S.directives = T));
							}
							return S;
						}),
	...
	function Wu(e, t, n) {
		...
		if (t) {
			let l = e.offsetAt(t.start),
				c = l;
			for (; c > 0 && fa(i, c - 1); ) c--;
			c === 0 || ma(i, c - 1) ? (l = c) : c < l && (l = c + 1);
			let d = e.offsetAt(t.end),
				m = d;
			for (; m < i.length && fa(i, m); ) m++;
			(m === i.length || ma(i, m)) && (d = m),
...
`,
		...
		let o = Uu(Fu(i), u);
		if (s > 0) {
			const l = n.insertSpaces ? la(" ", a * s) : la("	", s);
			(o = o
				.split(`
`)
				.join(
...
`.indexOf(e.charAt(t)) !== -1
	...
	(() => {
		...
		(() => {
				...
				with(b) {
					...
					return (
						...
						y === void 0
							? (y = this.authority)
							: y === null && (y = l),
						L === void 0 ? (L = this.path) : L === null && (L = l),
			...
			function S(v, b, E) {
				...
				for (let N = 0; N < v.length; N++) {
					...
					if (
						...
						L !== -1 &&
							((y += encodeURIComponent(v.substring(L, N))),
							(L = -1)),
				...
				return (
					L !== -1 && (y += encodeURIComponent(v.substring(L))),
					y !== void 0 ? y : v
				);
			}
			function x(v) {
			...
			function D(v) {
				return v.match(R) ? v.replace(R, (b) => M(b)) : v;
			}
			var _ = n(470);
			const p = _.posix || _,
				k = "/";
	...
	function Ju(e, t, n) {
		...
		if (!r.tag) return [];
		const s = [],
			a = _a(z.StartTag, e, r.start),
			u =
				typeof r.endTagStart == "number" &&
				_a(z.EndTag, e, r.endTagStart);
		return (
			((a && ba(a, t)) || (u && ba(u, t))) &&
				(a && s.push({ kind: $t.Read, range: a }),
				u && s.push({ kind: $t.Read, range: u })),
			s
		);
	}
	function ga(e, t) {
	...
	function Qu(e, t) {
		...
		return n;
		function r(s, a) {
			const u = Xn.create(s.name, s.kind, s.range, e.uri, a?.name);
			if (
	...
	function va(e, t, n) {
		const i = Yu(t),
			...
			s = Jn.create(i, void 0, $n.Field, r, r);
		n.push(s),
			t.children.forEach((a) => {
				s.children ?? (s.children = []), va(e, a, s.children);
			});
	}
	function Yu(e) {
		let t = e.tag;
	...
	var tc = class {
		...
		nc = class {
			...
			getSelectionRange(e, t, n) {
				...
				return s || (s = Jt.create(j.create(e, e))), s;
			}
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
		...
		rc = class {
			...
			setDataProviders(e, t) {
				(this.dataProviders = []),
					e && this.dataProviders.push(new ua("html5", ic)),
	...
	function oc(e = ac) {
		...
		return {
			...
			findOnTypeRenameRanges: ya,
			findLinkedEditingRanges: ya,
		};
	}
	function lc(e, t) {
		return new ua(e, t);
...
//# sourceMappingURL=html.worker-Bp7pNElH.js.map
