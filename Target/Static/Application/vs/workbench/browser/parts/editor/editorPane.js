...
class EditorPane extends Composite {
  ...
  static {
    this.EDITOR_MEMENTOS = /* @__PURE__ */ new Map();
  }
  get minimumWidth() {
  ...
  getEditorMemento(editorGroupService, configurationService, key, limit = 10) {
    ...
    if (!editorMemento) {
      editorMemento = this._register(new EditorMemento(this.getId(), key, this.getMemento(
        1,
        1
        /* StorageTarget.MACHINE */
      ), limit, editorGroupService, configurationService));
