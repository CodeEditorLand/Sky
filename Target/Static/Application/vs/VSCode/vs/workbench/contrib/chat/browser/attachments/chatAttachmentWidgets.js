...
let ImageAttachmentWidget = class ImageAttachmentWidget2 extends AbstractChatAttachmentWidget {
  ...
  constructor(resource, attachment, currentLanguageModel, options, container, contextResourceLabels, commandService, openerService, configurationService, hoverService, languageModelsService, instantiationService, labelService, chatEntitlementService) {
    ...
    const clickHandler = /* @__PURE__ */ __name(async () => {
      if (attachment.value instanceof Uint8Array && configurationService.getValue(ChatConfiguration.ImageCarouselEnabled)) {
...
function hookUpSymbolAttachmentDragAndContextMenu(accessor, widget, parentContextKeyService, attachment, contextMenuId) {
  ...
  const ensureContextKeyService = /* @__PURE__ */ __name(() => {
