 ...
 */
export declare function match(pattern: string | IRelativePattern, path: string, options?: IGlobOptions): boolean;
export declare function match(expression: IExpression, path: string, options?: IGlobOptions): boolean;
/**
 * Simplified glob matching. Supports a subset of glob patterns:
 * * `*` to match zero or more characters in a path segment
 * * `?` to match on one character in a path segment
