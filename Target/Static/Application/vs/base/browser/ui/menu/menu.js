...
.monaco-menu .action-item {
	cursor: default;
		...
		`;const i=c.scrollbarShadow;i&&(t+=`
			...
			`)}return t}export{R as $f9,A as $g9,ke as $h9,x as $i9,ie as $j9,_ as $k9,y as HorizontalDirection,M as VerticalDirection};
