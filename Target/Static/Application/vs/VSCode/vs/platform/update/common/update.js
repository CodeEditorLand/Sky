...
const State = {
  ...
  Idle: /* @__PURE__ */ __name((updateType, error, notAvailable) => ({ type: "idle", updateType, error, notAvailable }), "Idle"),
  CheckingForUpdates: /* @__PURE__ */ __name((explicit) => ({ type: "checking for updates", explicit }), "CheckingForUpdates"),
  AvailableForDownload: /* @__PURE__ */ __name((update, canInstall) => ({ type: "available for download", update, canInstall }), "AvailableForDownload"),
