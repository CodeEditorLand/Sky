      ...
      async run(accessor) {
        ...
        if (connectionInfo) {
          ...
          notificationService.notify({
            ...
            actions: {
              primary: [
                toAction({ id: "copyToClipboard", label: localize("action.copyToClipboard", "Copy Browser Link to Clipboard"), run: /* @__PURE__ */ __name(() => clipboardService.writeText(linkToOpen.toString(true)), "run") }),
                toAction({
                  id: "showExtension",
                  label: localize("action.showExtension", "Show Extension"),
                  run: /* @__PURE__ */ __name(() => {
