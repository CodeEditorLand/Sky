          ...
          try {
            ...
            if (!this._didReportIssue) {
              ...
              this.dialogService.prompt({
                ...
                buttons: [
                  { label: localize("reportIssue", "Report Issue"), run: /* @__PURE__ */ __name(() => this.openerService.open("https://github.com/microsoft/vscode/issues/new?template=bug_report.md"), "run") }
                ]
              });
            }
            throw e;
