...
class EditorEmptySelectionClipboard extends EditorBooleanOption {
  ...
  constructor() {
    super(38, "emptySelectionClipboard", true, { description: nls.localize("emptySelectionClipboard", "Controls whether copying without a selection copies the current line.") });
  }
  compute(env, options, value) {
...
class EditorLineHeight extends EditorFloatOption {
  ...
  constructor() {
    super(68, "lineHeight", EDITOR_FONT_DEFAULTS.lineHeight, (x) => EditorFloatOption.clamp(x, 0, 150), { markdownDescription: nls.localize("lineHeight", "Controls the line height. \n - Use 0 to automatically compute the line height from the font size.\n - Values between 0 and 8 will be used as a multiplier with the font size.\n - Values greater than or equal to 8 will be used as effective values.") });
  }
  compute(env, options, value) {
...
const EditorOptions = {
  ...
  ariaLabel: register(new EditorStringOption(4, "ariaLabel", nls.localize("editorViewAccessibleLabel", "Editor content"))),
  ...
  stickyTabStops: register(new EditorBooleanOption(121, "stickyTabStops", false, { description: nls.localize("stickyTabStops", "Emulate selection behavior of tab characters when using spaces for indentation. Selection will stick to tab stops.") })),
  codeLens: register(new EditorBooleanOption(17, "codeLens", true, { description: nls.localize("codeLens", "Controls whether the editor shows CodeLens.") })),
  codeLensFontFamily: register(new EditorStringOption(18, "codeLensFontFamily", "", { description: nls.localize("codeLensFontFamily", "Controls the font family for CodeLens.") })),
  ...
  colorDecorators: register(new EditorBooleanOption(20, "colorDecorators", true, { description: nls.localize("colorDecorators", "Controls whether the editor should render the inline color decorators and color picker.") })),
  ...
  columnSelection: register(new EditorBooleanOption(22, "columnSelection", false, { description: nls.localize("columnSelection", "Enable that the selection with the mouse and keys is doing column selection.") })),
  comments: register(new EditorComments()),
  contextmenu: register(new EditorBooleanOption(24, "contextmenu", true)),
  copyWithSyntaxHighlighting: register(new EditorBooleanOption(25, "copyWithSyntaxHighlighting", true, { description: nls.localize("copyWithSyntaxHighlighting", "Controls whether syntax highlighting should be copied into the clipboard.") })),
  cursorBlinking: register(new EditorEnumOption(26, "cursorBlinking", 1, "blink", ["blink", "smooth", "phase", "expand", "solid"], cursorBlinkingStyleFromString, { description: nls.localize("cursorBlinking", "Control the cursor animation style.") })),
  ...
  cursorStyle: register(new EditorEnumOption(28, "cursorStyle", TextEditorCursorStyle.Line, "line", ["line", "block", "underline", "line-thin", "block-outline", "underline-thin"], cursorStyleFromString, { description: nls.localize("cursorStyle", "Controls the cursor style in insert input mode.") })),
  overtypeCursorStyle: register(new EditorEnumOption(84, "overtypeCursorStyle", TextEditorCursorStyle.Block, "block", ["line", "block", "underline", "line-thin", "block-outline", "underline-thin"], cursorStyleFromString, { description: nls.localize("overtypeCursorStyle", "Controls the cursor style in overtype input mode.") })),
  cursorSurroundingLines: register(new EditorIntOption(29, "cursorSurroundingLines", 0, 0, 1073741824, { description: nls.localize("cursorSurroundingLines", "Controls the minimal number of visible leading lines (minimum 0) and trailing lines (minimum 1) surrounding the cursor. Known as 'scrollOff' or 'scrollOffset' in some other editors.") })),
  ...
  cursorWidth: register(new EditorIntOption(31, "cursorWidth", 0, 0, 1073741824, { markdownDescription: nls.localize("cursorWidth", "Controls the width of the cursor when `#editor.cursorStyle#` is set to `line`.") })),
  ...
  dragAndDrop: register(new EditorBooleanOption(35, "dragAndDrop", true, { description: nls.localize("dragAndDrop", "Controls whether the editor should allow moving selections via drag and drop.") })),
  emptySelectionClipboard: register(new EditorEmptySelectionClipboard()),
  dropIntoEditor: register(new EditorDropIntoEditor()),
  experimentalEditContextEnabled: register(new EditorBooleanOption(37, "experimentalEditContextEnabled", product.quality !== "stable", {
  ...
  fastScrollSensitivity: register(new EditorFloatOption(42, "fastScrollSensitivity", 5, (x) => x <= 0 ? 5 : x, { markdownDescription: nls.localize("fastScrollSensitivity", "Scrolling speed multiplier when pressing `Alt`.") })),
  find: register(new EditorFind()),
  fixedOverflowWidgets: register(new EditorBooleanOption(44, "fixedOverflowWidgets", false)),
  folding: register(new EditorBooleanOption(45, "folding", true, { description: nls.localize("folding", "Controls whether the editor has code folding enabled.") })),
  ...
  foldingHighlight: register(new EditorBooleanOption(47, "foldingHighlight", true, { description: nls.localize("foldingHighlight", "Controls whether the editor should highlight folded ranges.") })),
  foldingImportsByDefault: register(new EditorBooleanOption(48, "foldingImportsByDefault", false, { description: nls.localize("foldingImportsByDefault", "Controls whether the editor automatically collapses import ranges.") })),
  ...
  unfoldOnClickAfterEndOfLine: register(new EditorBooleanOption(50, "unfoldOnClickAfterEndOfLine", false, { description: nls.localize("unfoldOnClickAfterEndOfLine", "Controls whether clicking on the empty content after a folded line will unfold the line.") })),
  fontFamily: register(new EditorStringOption(51, "fontFamily", EDITOR_FONT_DEFAULTS.fontFamily, { description: nls.localize("fontFamily", "Controls the font family.") })),
  fontInfo: register(new EditorFontInfo()),
  fontLigatures2: register(new EditorFontLigatures()),
  fontSize: register(new EditorFontSize()),
  fontWeight: register(new EditorFontWeight()),
  fontVariations: register(new EditorFontVariations()),
  formatOnPaste: register(new EditorBooleanOption(57, "formatOnPaste", false, { description: nls.localize("formatOnPaste", "Controls whether the editor should automatically format the pasted content. A formatter must be available and the formatter should be able to format a range in a document.") })),
  formatOnType: register(new EditorBooleanOption(58, "formatOnType", false, { description: nls.localize("formatOnType", "Controls whether the editor should automatically format the line after typing.") })),
  glyphMargin: register(new EditorBooleanOption(59, "glyphMargin", true, { description: nls.localize("glyphMargin", "Controls whether the editor should render the vertical glyph margin. Glyph margin is mostly used for debugging.") })),
  gotoLocation: register(new EditorGoToLocation()),
  hideCursorInOverviewRuler: register(new EditorBooleanOption(61, "hideCursorInOverviewRuler", false, { description: nls.localize("hideCursorInOverviewRuler", "Controls whether the cursor should be hidden in the overview ruler.") })),
  hover: register(new EditorHover()),
  inDiffEditor: register(new EditorBooleanOption(63, "inDiffEditor", false)),
  letterSpacing: register(new EditorFloatOption(65, "letterSpacing", EDITOR_FONT_DEFAULTS.letterSpacing, (x) => EditorFloatOption.clamp(x, -5, 20), { description: nls.localize("letterSpacing", "Controls the letter spacing in pixels.") })),
  lightbulb: register(new EditorLightbulb()),
  lineDecorationsWidth: register(new EditorLineDecorationsWidth()),
  lineHeight: register(new EditorLineHeight()),
  lineNumbers: register(new EditorRenderLineNumbersOption()),
  lineNumbersMinChars: register(new EditorIntOption(70, "lineNumbersMinChars", 5, 1, 300)),
  linkedEditing: register(new EditorBooleanOption(71, "linkedEditing", false, { description: nls.localize("linkedEditing", "Controls whether the editor has linked editing enabled. Depending on the language, related symbols such as HTML tags, are updated while editing.") })),
  links: register(new EditorBooleanOption(72, "links", true, { description: nls.localize("links", "Controls whether the editor should detect links and make them clickable.") })),
  matchBrackets: register(new EditorStringEnumOption(73, "matchBrackets", "always", ["always", "near", "never"], { description: nls.localize("matchBrackets", "Highlight matching brackets.") })),
  minimap: register(new EditorMinimap()),
  mouseStyle: register(new EditorStringEnumOption(75, "mouseStyle", "text", ["text", "default", "copy"])),
  mouseWheelScrollSensitivity: register(new EditorFloatOption(76, "mouseWheelScrollSensitivity", 1, (x) => x === 0 ? 1 : x, { markdownDescription: nls.localize("mouseWheelScrollSensitivity", "A multiplier to be used on the `deltaX` and `deltaY` of mouse wheel scroll events.") })),
  ...
  multiCursorMergeOverlapping: register(new EditorBooleanOption(78, "multiCursorMergeOverlapping", true, { description: nls.localize("multiCursorMergeOverlapping", "Merge multiple cursors when they are overlapping.") })),
  ...
  overtypeOnPaste: register(new EditorBooleanOption(85, "overtypeOnPaste", true, { description: nls.localize("overtypeOnPaste", "Controls whether pasting should overtype.") })),
  overviewRulerBorder: register(new EditorBooleanOption(86, "overviewRulerBorder", true, { description: nls.localize("overviewRulerBorder", "Controls whether a border should be drawn around the overview ruler.") })),
  ...
  definitionLinkOpensInPeek: register(new EditorBooleanOption(93, "definitionLinkOpensInPeek", false, { description: nls.localize("definitionLinkOpensInPeek", "Controls whether the Go to Definition mouse gesture always opens the peek widget.") })),
  quickSuggestions: register(new EditorQuickSuggestions()),
  quickSuggestionsDelay: register(new EditorIntOption(95, "quickSuggestionsDelay", 10, 0, 1073741824, { description: nls.localize("quickSuggestionsDelay", "Controls the delay in milliseconds after which quick suggestions will show up.") })),
  readOnly: register(new EditorBooleanOption(96, "readOnly", false)),
  readOnlyMessage: register(new ReadonlyMessage()),
  renameOnType: register(new EditorBooleanOption(98, "renameOnType", false, { description: nls.localize("renameOnType", "Controls whether the editor auto renames on type."), markdownDeprecationMessage: nls.localize("renameOnTypeDeprecate", "Deprecated, use `editor.linkedEditing` instead.") })),
  renderControlCharacters: register(new EditorBooleanOption(99, "renderControlCharacters", true, { description: nls.localize("renderControlCharacters", "Controls whether the editor should render control characters."), restricted: true })),
  renderFinalNewline: register(new EditorStringEnumOption(100, "renderFinalNewline", platform.isLinux ? "dimmed" : "on", ["off", "on", "dimmed"], { description: nls.localize("renderFinalNewline", "Render last line number when the file ends with a newline.") })),
  ...
  renderLineHighlightOnlyWhenFocus: register(new EditorBooleanOption(102, "renderLineHighlightOnlyWhenFocus", false, { description: nls.localize("renderLineHighlightOnlyWhenFocus", "Controls if the editor should render the current line highlight only when the editor is focused.") })),
  ...
  roundedSelection: register(new EditorBooleanOption(106, "roundedSelection", true, { description: nls.localize("roundedSelection", "Controls whether selections should have rounded corners.") })),
  rulers: register(new EditorRulers()),
  scrollbar: register(new EditorScrollbar()),
  scrollBeyondLastColumn: register(new EditorIntOption(109, "scrollBeyondLastColumn", 4, 0, 1073741824, { description: nls.localize("scrollBeyondLastColumn", "Controls the number of extra characters beyond which the editor will scroll horizontally.") })),
  scrollBeyondLastLine: register(new EditorBooleanOption(110, "scrollBeyondLastLine", true, { description: nls.localize("scrollBeyondLastLine", "Controls whether the editor will scroll beyond the last line.") })),
  ...
  selectionHighlight: register(new EditorBooleanOption(113, "selectionHighlight", true, { description: nls.localize("selectionHighlight", "Controls whether the editor should highlight matches similar to the selection.") })),
  ...
  showUnused: register(new EditorBooleanOption(116, "showUnused", true, { description: nls.localize("showUnused", "Controls fading out of unused code.") })),
  showDeprecated: register(new EditorBooleanOption(145, "showDeprecated", true, { description: nls.localize("showDeprecated", "Controls strikethrough deprecated variables.") })),
  ...
  smoothScrolling: register(new EditorBooleanOption(119, "smoothScrolling", false, { description: nls.localize("smoothScrolling", "Controls whether the editor will scroll using an animation.") })),
  ...
  inlineCompletionsAccessibilityVerbose: register(new EditorBooleanOption(155, "inlineCompletionsAccessibilityVerbose", false, { description: nls.localize("inlineCompletionsAccessibilityVerbose", "Controls whether the accessibility hint should be provided to screen reader users when an inline completion is shown.") })),
  suggestFontSize: register(new EditorIntOption(124, "suggestFontSize", 0, 0, 1e3, { markdownDescription: nls.localize("suggestFontSize", "Font size for the suggest widget. When set to {0}, the value of {1} is used.", "`0`", "`#editor.fontSize#`") })),
  suggestLineHeight: register(new EditorIntOption(125, "suggestLineHeight", 0, 0, 1e3, { markdownDescription: nls.localize("suggestLineHeight", "Line height for the suggest widget. When set to {0}, the value of {1} is used. The minimum value is 8.", "`0`", "`#editor.lineHeight#`") })),
  suggestOnTriggerCharacters: register(new EditorBooleanOption(126, "suggestOnTriggerCharacters", true, { description: nls.localize("suggestOnTriggerCharacters", "Controls whether suggestions should automatically show up when typing trigger characters.") })),
  ...
  useTabStops: register(new EditorBooleanOption(133, "useTabStops", true, { description: nls.localize("useTabStops", "Spaces and tabs are inserted and deleted in alignment with tab stops.") })),
  ...
  wordSeparators: register(new EditorStringOption(136, "wordSeparators", USUAL_WORD_SEPARATORS, { description: nls.localize("wordSeparators", "Characters that will be used as word separators when doing word related navigations or operations.") })),
  ...
  tabFocusMode: register(new EditorBooleanOption(150, "tabFocusMode", false, { markdownDescription: nls.localize("tabFocusMode", "Controls whether the editor receives tabs or defers them to the workbench for navigation.") })),
