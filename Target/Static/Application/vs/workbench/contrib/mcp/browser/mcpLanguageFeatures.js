  ...
  async _provideInlayHints(model, range) {
    ...
    function pushAnnotation(savedId, offset, saved) {
      const tooltip = new MarkdownString([
        createMarkdownCommandLink({ id: "workbench.mcp.editStoredInput", title: localize("edit", "Edit"), arguments: [savedId, model.uri, mcpConfigurationSection, inConfig.target] }),
        createMarkdownCommandLink({ id: "workbench.mcp.removeStoredInput", title: localize("clear", "Clear"), arguments: [inConfig.scope, savedId] }),
        createMarkdownCommandLink({ id: "workbench.mcp.removeStoredInput", title: localize("clearAll", "Clear All"), arguments: [inConfig.scope] })
      ].join(" | "), { isTrusted: true });
      const hint = {
