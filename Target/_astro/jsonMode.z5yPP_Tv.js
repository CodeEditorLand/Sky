import { m as Et } from "./editor.main.COpP3lv-.js";
		...
		if ((r && typeof r == "object") || typeof r == "function")
			for (let t of Nt(r))
				!Rt.call(e, t) &&
					...
					Lt(e, t, {
						get: () => r[t],
						enumerable: !(n = Ot(r, t)) || n.enumerable,
					});
		return e;
	},
	Dt = (e, r, i) => (Mt(e, r, "default"), i),
	f = {};
Dt(f, Et);
var Ft = 2 * 60 * 1e3,
	Ut = class {
	...
	function n(o, s) {
		let u = o.getText(),
			g = t(s, (v, d) => {
				...
				return k === 0
					? v.range.start.character - d.range.start.character
					: k;
			}),
			c = u.length;
	...
	_doValidate(e, r) {
		this._worker(e)
			...
			.then((i) => {
				...
				t &&
					t.getLanguageId() === r &&
					f.editor.setModelMarkers(t, r, n);
			})
			.then(void 0, (i) => {
				console.error(i);
			});
					...
					g = o.items.map((c) => {
						...
						return (
							...
							c.additionalTextEdits &&
								(v.additionalTextEdits =
									c.additionalTextEdits.map(B)),
...
function zt(e) {
	if (e) return Array.isArray(e) ? e.map(ot) : [ot(e)];
}
var _n = class {
	constructor(e) {
		this._worker = e;
	...
	Qt = class {
		...
		provideDocumentFormattingEdits(e, r, i) {
			...
			return this._worker(n).then((t) =>
				t.format(n.toString(), null, _t(r)).then((o) => {
	...
	Yt = class {
		...
		provideDocumentRangeFormattingEdits(e, r, i, n) {
			...
			return this._worker(t).then((o) =>
				o.format(t.toString(), pt(r), _t(i)).then((s) => {
...
var Gt = class {
		...
		provideColorPresentations(e, r, i) {
			...
			return this._worker(n)
				.then((t) =>
					t.getColorPresentations(n.toString(), r.color, pt(r.range)),
				)
				.then((t) => {
					if (t)
						return t.map((o) => {
				...
				.then((t) => {
					if (t)
						return t.map((o) => {
							...
							return (
								typeof o.kind < "u" && (s.kind = Kt(o.kind)), s
							);
						});
				});
		}
...
`)),
		...
		switch (l) {
			...
			case 47:
				...
				if (e.charCodeAt(n + 1) === 42) {
					...
					for (; n < L; ) {
						...
						n++,
							x(b) &&
								(b === 13 && e.charCodeAt(n) === 10 && n++,
								u++,
								(c = n));
					}
					return (
						I || (n++, (d = 1)), (t = e.substring(A, n)), (s = 13)
					);
				}
			...
			case 57:
				return (t += N()), (s = 11);
			default:
				for (; n < i && At(l); ) n++, (l = e.charCodeAt(n));
				if (o !== n) {
...
var ft = "delimiter.bracket.json",
	dt = "delimiter.array.json",
...
function gn(e, r, i, n = 0) {
	...
	for (;;) {
		...
		switch ((o && (v -= t), (o = t > 0), k)) {
			case 1:
				(g = y.push(g, 0)), (d = ft), (u = !1);
				break;
			case 2:
				(g = y.pop(g)), (d = ft), (u = !1);
				break;
			case 3:
				(g = y.push(g, 1)), (d = dt), (u = !1);
				break;
			case 4:
				(g = y.pop(g)), (d = dt), (u = !1);
				break;
		...
		(c.endState = new bt(i.getStateData(), s.getTokenError(), u, g)),
...
function En(e) {
	...
	function t() {
		...
		wt(i),
			...
			u.documentSymbols &&
				i.push(
					f.languages.registerDocumentSymbolProvider(s, new Jt(E)),
				),
			...
			u.selectionRanges &&
				i.push(
					f.languages.registerSelectionRangeProvider(s, new Ct(E)),
				);
	}
...
//# sourceMappingURL=jsonMode.z5yPP_Tv.js.map
