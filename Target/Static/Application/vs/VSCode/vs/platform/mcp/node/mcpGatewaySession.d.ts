...
import { JsonRpcMessage, JsonRpcResponse } from '../../../base/common/jsonRpcProtocol.js';
...
export declare class McpGatewaySession extends Disposable {
    ...
    constructor(id: string, _logService: ILogger, _onDidDispose: () => void, _toolInvoker: IMcpGatewayToolInvoker);
    attachSseClient(_req: http.IncomingMessage, res: http.ServerResponse): void;
    handleIncoming(message: JsonRpcMessage | JsonRpcMessage[]): Promise<JsonRpcResponse[]>;
    dispose(): void;
