...
import { isPromptFileVariableEntry, toPromptFileVariableEntry } from "../common/chatVariableEntries.js";
...
${baseMessage}`),
  ...
  async renderFollowups() {
    if (this.lastItem && isResponseVM(this.lastItem) && this.lastItem.isComplete && this.inputPart.currentMode === ChatMode.Ask) {
      ...
      this.inputPart.renderFollowups(void 0, void 0);
    }
    if (this.bodyDimension) {
      this.layout(this.bodyDimension.height, this.bodyDimension.width);
    }
  ...
  createInput(container, options) {
    ...
    this._register(autorun((r) => {
      ...
      const disabledTools = this.inputPart.attachmentModel.attachments.filter((a) => a.kind === "tool" && !toolIds.has(a.id) || a.kind === "toolset" && !toolSetIds.has(a.id)).map((a) => a.id);
