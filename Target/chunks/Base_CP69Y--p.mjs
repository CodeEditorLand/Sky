import { d as createAstro, c as createComponent, e as addAttribute, a as renderTemplate, s as spreadAttributes, f as renderSlotToString, g as renderAllHeadContent, u as unescapeHTML, b as renderScript, r as renderComponent, m as maybeRenderHead, h as renderSlot } from './astro/server_BqPYZAJa.mjs';
import 'kleur/colors';
/* empty css                          */
import 'clsx';
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "D:/Developer/node_modules/.pnpm/astro@5.6.1_@types+node@22._7240574c5f24c053262c5affc2796e17/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/Developer/node_modules/.pnpm/astro@5.6.1_@types+node@22._7240574c5f24c053262c5affc2796e17/node_modules/astro/components/ClientRouter.astro", void 0);

const $$Base = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="en" class="no-js" dir="ltr"> ${renderComponent($$result, "Head", Head, {}, { "default": ($$result2) => renderTemplate`${renderScript($$result2, "D:/Developer/Application/CodeEditorLand/Land/Element/Sky/Source/Function/Markup/Base.astro?astro&type=script&index=0&lang.ts")}${renderComponent($$result2, "Meta", $$Meta, {})}<link rel="preconnect" href="HTTPS://fonts.googleapis.com" crossorigin><link rel="preconnect" href="HTTPS://fonts.gstatic.com" crossorigin><link rel="manifest" href="/Manifest.json" crossorigin="use-credentials">${renderSlot($$result2, $$slots["Head"])}${renderComponent($$result2, "ClientRouter", $$ClientRouter, {})}` })}${maybeRenderHead()}<body aria-label=""> <div class="grow p-5 text-center"> <ul class="flex"> <li class="px-5"> <a href="/Editor">Editor</a> </li> <li class="px-5"> <a href="/VSCode">VSCode</a> </li> </ul> </div> <div class="grow"> ${renderSlot($$result, $$slots["default"])} </div> ${renderScript($$result, "D:/Developer/Application/CodeEditorLand/Land/Element/Sky/Source/Function/Markup/Base.astro?astro&type=script&index=1&lang.ts")} </body> </html>`;
