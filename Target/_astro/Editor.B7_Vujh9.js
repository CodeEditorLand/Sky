const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			...
			"_astro/Context.C6UhUywx.js",
			"_astro/Context.LKq552OA.js",
			"_astro/Anchor.BBFSX_Xr.js",
			"_astro/Merge.C1f6g_XE.js",
			"_astro/Button.T3KiANzs.js",
			"_astro/Copy.CLgEwybq.js",
			"_astro/Copy.BCBGr1zU.css",
		]),
) => i.map((i) => d[i]);
import { _ as F } from "./Editor.Cjw5oqMk.js";
import { e as K } from "./editor.main.CDmIYRKK.js";
import {
	createSignal as J,
	mergeProps as w,
	untrack as f,
...
`;
	...
	{ default: p } = await F(
		async () => {
			const { default: e } = await import("./Context.DyKYBtdv.js");
			return { default: e };
		},
	...
	{ default: V } = await F(
		async () => {
			const { default: e } = await import("./Context.BbTSrFKv.js");
			return { default: e };
		},
	...
	{ default: Pe } = await F(
		async () => {
			const { default: e } = await import("./Context.C6UhUywx.js");
			return { default: e };
		},
	...
	{ default: R } = await F(
		async () => {
			const { default: e } = await import("./Context.LKq552OA.js");
			return { default: e };
		},
	...
	{ default: Ve } = await F(
		async () => {
			const { default: e } = await import("./Anchor.BBFSX_Xr.js");
			return { default: e };
		},
	...
	{ default: je } = await F(
		async () => {
			const { default: e } = await import("./Button.T3KiANzs.js");
			return { default: e };
		},
	...
	{ default: Be, Fn: Ke } = await F(
		async () => {
			const { default: e, Fn: t } = await import("./Copy.CLgEwybq.js");
	...
	{ default: U } = await F(
		async () => {
			const { default: e } = await import("./Merge.C1f6g_XE.js");
			return { default: e };
		},
...
//# sourceMappingURL=Editor.B7_Vujh9.js.map
