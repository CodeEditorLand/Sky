...
export declare class LinuxUpdateService extends AbstractUpdateService {
    ...
    constructor(lifecycleMainService: ILifecycleMainService, configurationService: IConfigurationService, environmentMainService: IEnvironmentMainService, requestService: IRequestService, logService: ILogService, nativeHostMainService: INativeHostMainService, productService: IProductService, meteredConnectionService: IMeteredConnectionService);
