...
class SuggestWidgetAdaptor extends Disposable {
  ...
  getSuggestItemInfo() {
    ...
    if (typeof quickSuggestions === "object" && (quickSuggestions.other === "offWhenInlineCompletions" || quickSuggestions.comments === "offWhenInlineCompletions" || quickSuggestions.strings === "offWhenInlineCompletions")) {
      return void 0;
    }
