...
class FrontMatterHeader extends MarkdownExtensionsToken {
  ...
  static fromTokens(startMarkerTokens, contentTokens, endMarkerTokens) {
    ...
    return new FrontMatterHeader(range, FrontMatterMarker.fromTokens(startMarkerTokens), Text.fromTokens(contentTokens), FrontMatterMarker.fromTokens(endMarkerTokens));
  }
  /**
