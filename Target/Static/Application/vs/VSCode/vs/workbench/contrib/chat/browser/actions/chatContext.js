...
let ChatContextContributions = class ChatContextContributions2 extends Disposable {
  ...
  constructor(instantiationService, contextPickService, chatDebugService, contextKeyService, languageModelToolsService, chatWidgetService) {
    super();
...
let DebugEventsSnapshotContextValuePick = class DebugEventsSnapshotContextValuePick2 {
  static {
    __name(this, "DebugEventsSnapshotContextValuePick");
  }
