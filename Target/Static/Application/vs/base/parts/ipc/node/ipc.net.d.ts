...
export declare function upgradeToISocket(req: http.IncomingMessage, socket: Socket, { debugLabel, skipWebSocketFrames, disableWebSocketCompression, enableMessageSplitting, }: {
    debugLabel: string;
...
export declare class WebSocketNodeSocket extends Disposable implements ISocket, ISocketTracer {
    ...
    private readonly _maxSocketMessageLength;
    private _isEnded;
     ...
     */
    constructor(socket: NodeSocket, permessageDeflate: boolean, inflateBytes: VSBuffer | null, recordInflateBytes: boolean, enableMessageSplitting?: boolean);
    dispose(): void;
