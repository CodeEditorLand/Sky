...
`).join(`
`);this.editorService.openEditor({resource:void 0,contents:f,languageId:"markdown"}),this.telemetryService.publicLog2("openedChatCodeCitations")})),this.domNode=i.root}hasSameContent(t,n,o){return t.kind==="codeCitations"}};l=m([s(2,v),s(3,C)],l);export{l as ChatCodeCitationContentPart};
