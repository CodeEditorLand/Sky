...
const chatSlashCommandBackground = registerColor("chat.slashCommandBackground", { dark: "#34414b8f", light: "#d2ecff99", hcDark: Color.white, hcLight: badgeBackground }, localize("chat.slashCommandBackground", "The background color of a chat slash command."));
const chatSlashCommandForeground = registerColor("chat.slashCommandForeground", { dark: "#40A6FF", light: "#306CA2", hcDark: Color.black, hcLight: badgeForeground }, localize("chat.slashCommandForeground", "The foreground color of a chat slash command."));
