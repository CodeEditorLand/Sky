...
import { IChatPromptSlashCommand, IConfiguredHooksInfo, ICustomAgent, IPromptPath, IPromptsService, IAgentSkill, PromptsStorage, IPromptFileContext, IPromptFileResource, IResolvedAgentFile, Logger, IPromptDiscoveryLogEntry } from './promptsService.js';
...
export declare class PromptsService extends Disposable implements IPromptsService {
     ...
     */
    private readonly internalCustomizations;
    /**
