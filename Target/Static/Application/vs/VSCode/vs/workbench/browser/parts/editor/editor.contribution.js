...
}, TextCompareEditorActiveContext, 10, void 0, EditorContextKeys.hasChanges, true, true);
...
appendEditorToolItem({
  ...
  icon: nextChangeIcon
}, TextCompareEditorActiveContext, 11, void 0, EditorContextKeys.hasChanges, true, true);
appendEditorToolItem({
  id: DIFF_SWAP_SIDES,
