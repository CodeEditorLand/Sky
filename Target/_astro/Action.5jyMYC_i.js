const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			...
			"_astro/Editor.BFvCNeGE.js",
			"_astro/web.Bb4_WBG9.js",
			"_astro/editor.DYIhNL0M.css",
			"_astro/Context.Du15kom7.js",
		]),
) => i.map((i) => d[i]);
import { _ as a } from "./Editor.BFvCNeGE.js";
...
const { editor: _, languages: d } = await a(
	() => import("./editor.main.D0g8BD-5.js").then((t) => t.a),
