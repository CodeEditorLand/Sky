...
export declare class ModifiedBaseRange {
    ...
    */
    ...
    constructor(baseRange: MergeEditorLineRange, baseTextModel: ITextModel, input1Range: MergeEditorLineRange, input1TextModel: ITextModel, 
    /**
     * From base to input1
    */
    input1Diffs: readonly DetailedLineRangeMapping[], input2Range: MergeEditorLineRange, input2TextModel: ITextModel, 
    /**
     * From base to input2
    */
