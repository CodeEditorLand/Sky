...
(function(TerminalContextKeyStrings2) {
  ...
  TerminalContextKeyStrings2["SplitPaneActive"] = "terminalSplitPaneActive";
  ...
  TerminalContextKeyStrings2["DictationInProgress"] = "terminalDictationInProgress";
...
(function(TerminalContextKeys2) {
  ...
  TerminalContextKeys2.splitTerminalTabFocused = new RawContextKey("terminalSplitTerminal", false, localize("isSplitTerminalContextKey", "Whether the focused tab's terminal is a split terminal."));
  TerminalContextKeys2.splitTerminalActive = new RawContextKey("terminalSplitPaneActive", false, localize("splitPaneActive", "Whether the active terminal is a split pane."));
  ...
  TerminalContextKeys2.terminalDictationInProgress = new RawContextKey("terminalDictationInProgress", false);
  TerminalContextKeys2.shouldShowViewInlineActions = ContextKeyExpr.and(ContextKeyExpr.equals("view", TERMINAL_VIEW_ID), ContextKeyExpr.notEquals(`config.${"terminal.integrated.tabs.hideCondition"}`, "never"), ContextKeyExpr.not(
