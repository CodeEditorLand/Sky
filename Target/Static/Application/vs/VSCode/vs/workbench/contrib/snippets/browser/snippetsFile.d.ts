...
export declare class Snippet {
    ...
    constructor(isFileTemplate: boolean, scopes: string[], name: string, prefix: string, description: string, body: string, source: string, snippetSource: SnippetSource, snippetIdentifier: string, include?: string[] | undefined, exclude?: string[] | undefined, extensionId?: ExtensionIdentifier | undefined);
