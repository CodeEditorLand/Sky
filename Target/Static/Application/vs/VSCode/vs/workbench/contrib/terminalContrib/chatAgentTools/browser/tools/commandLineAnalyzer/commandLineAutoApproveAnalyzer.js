...
let CommandLineAutoApproveAnalyzer = class CommandLineAutoApproveAnalyzer2 extends Disposable {
  ...
  async analyze(options) {
    ...
    const deniedSubCommandResult = deniedSubCommandResultIndex !== -1 ? subCommandResults[deniedSubCommandResultIndex] : void 0;
    if (deniedSubCommandResult) {
      ...
      denialDetails = {
        ...
        ruleSourceText: isAutoApproveRule(deniedSubCommandResult.rule) ? deniedSubCommandResult.rule.sourceText : void 0
      };
      ...
      denialDetails = {
        ...
        ruleSourceText: isAutoApproveRule(commandLineResult.rule) ? commandLineResult.rule.sourceText : void 0
      };
    } else {
