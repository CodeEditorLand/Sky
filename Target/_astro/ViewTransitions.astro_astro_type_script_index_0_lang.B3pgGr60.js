...
async function de(e, t, n, o, r, s, u, a, c) {
	...
	return (
		document.dispatchEvent(f) &&
			...
			f.defaultPrevented ||
				(le(se),
				f.navigationType !== "traverse" && x({ scrollX, scrollY }))),
		f
	);
}
function me(e, t) {
...
const W = (e, t, n, o, r) => {
	...
	if (e.href !== location.href && !r)
		if (n.history === "replace") {
			...
			he({ ...n.state, index: ++b, scrollX: 0, scrollY: 0 }, "", e.href);
	if (
		((document.title = u),
		(A = e),
...
function ve(e) {
	...
	const t = history.state,
		n = t.index,
		o = n > b ? "forward" : "back";
	(b = n), j(o, A, new URL(location.href), {}, t);
}
const X = () => {
	history.state &&
...
function Se() {
	...
	N(() => {
		for (const t of document.getElementsByTagName("a"))
			E.has(t) ||
				(v(t, "viewport") && (E.add(t), (e ??= Le()), e.observe(t)));
	});
}
function Le() {
	const e = new WeakMap();
...
function S(e, t) {
	...
	if (Pe(e, n))
		if ((K.add(e), HTMLScriptElement.supports?.("speculationrules"))) ke(e);
		else if (
...
(D || xe() !== "none") &&
	...
	Te({ prefetchAll: !0 }));
//# sourceMappingURL=ViewTransitions.astro_astro_type_script_index_0_lang.B3pgGr60.js.map
