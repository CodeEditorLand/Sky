...
let InlineTextModelCollection = class InlineTextModelCollection2 extends Disposable {
  static {
    __name(this, "InlineTextModelCollection");
  }
...
class InlineTextModelReferenceCollection extends ReferenceCollection {
  static {
    __name(this, "InlineTextModelReferenceCollection");
  }
  constructor(modelService) {
    super();
