...
${renderScript($$result, "D:/Developer/Application/CodeEditorLand/EcoSystem/node_modules/astro/components/ViewTransitions.astro?astro&type=script&index=0&lang.ts")}`;
...
const $$Base = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" class="no-js" dir="ltr">
	${renderComponent($$result, "Head", Head, {}, { "default": ($$result2) => renderTemplate`
		${renderScript($$result2, "D:/Developer/Application/CodeEditorLand/EcoSystem/Elements/Sky/Source/Layout/Base.astro?astro&type=script&index=0&lang.ts")}
		...
		${renderComponent($$result2, "ViewTransitions", $$ViewTransitions, {})}
	` })}
	${maybeRenderHead()}<body>
		<div class="grow" id="swup">
...
export { $$Base as $ };
//# sourceMappingURL=Base_BOrs_0Zd.mjs.map
