...
class ViewModelLinesFromProjectedModel {
  ...
  constructor(editorId, model, domLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, options, tabSize) {
  ...
  setWrappingSettings(options) {
    const equalFontInfo = this.options.get(
      59
    ...
    const equalWrappingStrategy = this.options.get(
      156
    ...
    const equalWrappingInfo = this.options.get(
      166
    ...
    const equalWrappingIndent = this.options.get(
      155
    ...
    const equalWordBreak = this.options.get(
      146
  ...
  createLineBreaksComputer(_context) {
    const lineBreaksComputerFactory = this.options.get(
      156
      /* EditorOption.wrappingStrategy */
    ) === "advanced" ? this._domLineBreaksComputerFactory : this._monospaceLineBreaksComputerFactory;
    const context = _context ?? {
      getLineContent: /* @__PURE__ */ __name((lineNumber) => {
        return this.model.getLineContent(lineNumber);
      }, "getLineContent"),
      getLineInjectedText: /* @__PURE__ */ __name((lineNumber) => {
...
class ViewModelLinesFromModelAsIs {
  ...
  createLineBreaksComputer() {
    const result = [];
    return {
      addRequest: /* @__PURE__ */ __name((lineNumber, previousLineBreakData) => {
        result.push(null);
      }, "addRequest"),
