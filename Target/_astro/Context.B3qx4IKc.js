const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			...
			"_astro/Socket.hnio5b3_.js",
			"_astro/Context.C2cu0PLS.js",
			"_astro/Editor.CHcRbLoL.js",
			"_astro/State.BgPJvHxe.js",
			"_astro/Status.D-oWqTOz.js",
...
const i = e({
	...
	State: (
		await a(
			async () => {
				const { default: t } = await import("./State.BgPJvHxe.js");
				return { default: t };
			},
	...
	Status: (
		await a(
			async () => {
				const { default: t } = await import("./Status.D-oWqTOz.js");
				return { default: t };
			},
...
//# sourceMappingURL=Context.B3qx4IKc.js.map
