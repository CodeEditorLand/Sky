...
export declare const enum GitHubPullRequestState {
    Open = "open",
    Closed = "closed",
    Merged = "merged"
}
...
export declare const enum MergeBlockerKind {
...
export declare const enum GitHubCheckStatus {
    Queued = "queued",
    InProgress = "in_progress",
    Completed = "completed"
}
export declare const enum GitHubCheckConclusion {
    Success = "success",
    Failure = "failure",
    Neutral = "neutral",
    Cancelled = "cancelled",
...
export declare const enum GitHubCIOverallStatus {
    Pending = "pending",
    Success = "success",
    Failure = "failure",
    Neutral = "neutral"
