...
const MAX_CONSOLE_LOG_ENTRIES = 1e3;
const consoleLogStore = /* @__PURE__ */ new Map();
function locatorKey(locator) {
  return locator.browserViewId ?? locator.webviewId;
}
__name(locatorKey, "locatorKey");
let NativeBrowserElementsMainService = class NativeBrowserElementsMainService2 extends Disposable {
  ...
  async startConsoleSession(windowId, token, locator, cancelAndDetachId) {
    ...
    const onConsoleMessage = /* @__PURE__ */ __name((_event, level, message, _line, _sourceId) => {
    ...
    const onIpcMessage = /* @__PURE__ */ __name((_event, channel, closedCancelAndDetachId) => {
    ...
    const onTargetDestroyed = /* @__PURE__ */ __name(() => {
      cleanupListeners();
    }, "onTargetDestroyed");
