const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			...
			"_astro/Context.BUex93Nh.js",
			"_astro/Context.DtApzLJH.js",
			"_astro/Anchor.afKGCOWs.js",
			"_astro/Merge.CihF0fIl.js",
			"_astro/Button.CPqykquI.js",
			"_astro/Copy.DSDuzYr3.js",
...
import { e as editor } from "./editor.main.803Y2rvB.js";
...
var K = template("<div><p>Edit your <!> here:</p><br>"),
	B = template(
		"<div class=w-full><div class=Editor><code class=Monaco></code><input>",
	),
	V = template("<div class=Error><span>&nbsp;&nbsp;&nbsp;"),
	W = template("<input type=hidden>"),
	pe = ({ Type: o } = { Type: "HTML" }) => {
		const [i, { Form: u, Field: b }] = createForm(),
			a = crypto.randomUUID();
		createEffect(
			on(
				r.Editors[0],
				(e) => {
					setValue(i, "Content", e.get(a)?.Content ?? "", {
						shouldFocus: !1,
						shouldTouched: !1,
					}),
						validate(i);
		...
		const m = createSignal$1(q(o));
		createEffect(
			on(y.Messages[0], (e) => e?.get("Type") && m[1](e?.get("Type")), {
				defer: !1,
			}),
		);
		let f, t;
		return (
			...
			onMount(() => {
				f instanceof HTMLElement &&
					...
					createEffect(
						on(m[0], (e) => t.getModel()?.setValue(e), {
							defer: !1,
						}),
					),
					y.Socket[0]()?.send(
						JSON.stringify({
							Key: h.Items[0]()?.get("Key")?.[0](),
							Identifier: h.Items[0]()?.get("Identifier")?.[0](),
							From: "Content",
							View: o,
						}),
					));
			...
			(() => {
				...
				return (
					insert(
						...
						createComponent(For, {
							get each() {
								return Array.from(r.Editors[0]().entries());
							},
							children: (l, s) => [
								createComponent(R, {
									Action: () => {
										r.Editors[0]().forEach((n, d) => {
											(n.Hidden = l[0] !== d),
												r.Editors[1](
													T(
														r.Editors[0](),
...
`;
	...
	{ default: r } = await __vitePreload(
		async () => {
			const { default: r } = await import("./Context.CdSYDZO5.js");
			return { default: r };
		},
		true ? __vite__mapDeps([0, 1, 2]) : void 0,
	),
	{ default: y } = await __vitePreload(
		async () => {
			const { default: y } = await import("./Context.BoDya5e6.js");
			return { default: y };
		},
		true ? __vite__mapDeps([3, 1, 2]) : void 0,
	),
	{ default: J } = await __vitePreload(
		async () => {
			const { default: J } = await import("./Context.BUex93Nh.js");
			return { default: J };
		},
	...
	{ default: h } = await __vitePreload(
		async () => {
			const { default: h } = await import("./Context.DtApzLJH.js");
			return { default: h };
		},
	...
	{ default: R } = await __vitePreload(
		async () => {
			const { default: R } = await import("./Anchor.afKGCOWs.js");
			return { default: R };
		},
		true ? __vite__mapDeps([6, 2, 7, 1]) : void 0,
	),
	{ default: ge } = await __vitePreload(
		async () => {
			const { default: ge } = await import("./Button.CPqykquI.js");
			return { default: ge };
		},
		true ? __vite__mapDeps([8, 1, 2]) : void 0,
	),
	{ default: he, Fn: Ce } = await __vitePreload(
		async () => {
			const { default: he, Fn: Ce } = await import("./Copy.DSDuzYr3.js");
			return { default: he, Fn: Ce };
		},
		true ? __vite__mapDeps([9, 1, 2, 10]) : void 0,
	),
	{ default: T } = await __vitePreload(
		async () => {
			const { default: T } = await import("./Merge.CihF0fIl.js");
			return { default: T };
		},
...
//# sourceMappingURL=Editor.BteC2H78.js.map
