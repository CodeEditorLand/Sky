...
var FileDownload_1;
let BrowserFileUpload = class BrowserFileUpload2 {
  static {
...
let ExternalFileImport = class ExternalFileImport2 {
  static {
    ...
    if (folders.length > 0 && target.isRoot) {
      ...
      const buttons = [
        {
          ...
          run: /* @__PURE__ */ __name(() => ImportChoice.Copy, "run")
        }
      ];
      let message;
      ...
      if (folders.some((folder) => workspaceFolderSchemas.indexOf(folder.uri.scheme) >= 0)) {
        buttons.unshift({
          ...
          run: /* @__PURE__ */ __name(() => ImportChoice.Add, "run")
        });
...
let FileDownload = class FileDownload2 {
  static {
