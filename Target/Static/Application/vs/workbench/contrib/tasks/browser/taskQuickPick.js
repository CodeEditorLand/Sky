...
let TaskQuickPick = TaskQuickPick_1 = class TaskQuickPick2 extends Disposable {
  static {
  ...
  _createTaskEntry(task, extraButtons = []) {
    ...
    const entry = { label: TaskQuickPick_1.getTaskLabelWithIcon(task, this._guessTaskLabel(task)), description: this._taskService.getTaskDescription(task), task, detail: this._showDetail() ? task.configurationProperties.detail : void 0, buttons };
