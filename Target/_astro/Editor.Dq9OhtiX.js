...
let __tla = (async ()=>{
    ...
    createSignal = function(value, options) {
    ...
    delegateEvents = function(eventNames, document = window.document) {
    ...
    spread = function(node, props = {}, isSVG, skipChildren) {
        const prevProps = {};
        {
    ...
    insert = function(parent, accessor, marker, initial) {
