...
import 'kleur/colors';
import { $ as $$Base } from '../chunks/Base_D4Ow4ASc.mjs';
...
const $$VSCode = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Base, {}, { "default": ($$result2) => renderTemplate`
	...
	${renderScript($$result2, "D:/Developer/Application/CodeEditorLand/EcoSystem/Elements/Sky/Source/pages/VSCode.astro?astro&type=script&index=0&lang.ts")}
` })}`;
...
export { page };
//# sourceMappingURL=vscode.astro.mjs.map
