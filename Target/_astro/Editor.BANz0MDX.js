const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"_astro/Context.DqU2-PD9.js",
			"_astro/Editor.1x_WqB4B.js",
			"_astro/solid.-melTDdq.js",
			"_astro/Context.DfQTo1LS.js",
			"_astro/Context.DrvIB6ru.js",
			"_astro/Context.-xlZplyP.js",
			"_astro/Anchor.ChdP6L_8.js",
			"_astro/Merge.jilOBFaO.js",
			"_astro/Button.DQBLmxq8.js",
			"_astro/Copy.Dodm3G6m.js",
			"_astro/Copy.BCBGr1zU.css",
		]),
) => i.map((i) => d[i]);
import { _ as F } from "./Editor.1x_WqB4B.js";
import { e as K } from "./editor.main.Bp5ERJVr.js";
import {
	createSignal as J,
	mergeProps as w,
	untrack as f,
...
`;
	...
	{ default: p } = await F(
		async () => {
			const { default: e } = await import("./Context.DqU2-PD9.js");
			return { default: e };
		},
	...
	{ default: V } = await F(
		async () => {
			const { default: e } = await import("./Context.DfQTo1LS.js");
			return { default: e };
		},
	...
	{ default: Pe } = await F(
		async () => {
			const { default: e } = await import("./Context.DrvIB6ru.js");
			return { default: e };
		},
	...
	{ default: R } = await F(
		async () => {
			const { default: e } = await import("./Context.-xlZplyP.js");
			return { default: e };
		},
	...
	{ default: Ve } = await F(
		async () => {
			const { default: e } = await import("./Anchor.ChdP6L_8.js");
			return { default: e };
		},
	...
	{ default: je } = await F(
		async () => {
			const { default: e } = await import("./Button.DQBLmxq8.js");
			return { default: e };
		},
	...
	{ default: Be, Fn: Ke } = await F(
		async () => {
			const { default: e, Fn: t } = await import("./Copy.Dodm3G6m.js");
	...
	{ default: U } = await F(
		async () => {
			const { default: e } = await import("./Merge.jilOBFaO.js");
			return { default: e };
		},
...
//# sourceMappingURL=Editor.BANz0MDX.js.map
