...
suite("isPowerShell", () => {
  ...
  suite("PowerShell with full paths", () => {
    ...
    test("should detect nested path with powershell", () => {
      ok(isPowerShell(
        "/some/deep/path/to/powershell.exe",
        1
        /* OperatingSystem.Windows */
      ));
    });
...
suite("dedupeRules", () => {
  ...
  __name(createMockRule, "createMockRule");
