...
class ProblemsAccessibilityHelp {
  static {
    __name(this, "ProblemsAccessibilityHelp");
  }
  constructor() {
    this.type = "help";
    this.priority = 105;
...
class ProblemsAccessibilityHelpProvider extends Disposable {
  static {
    __name(this, "ProblemsAccessibilityHelpProvider");
  }
  constructor(_keybindingService) {
    super();
    this._keybindingService = _keybindingService;
    this.id = "problemsFilterHelp";
  ...
  _describeCommand(commandId) {
    ...
    return kb?.getAriaLabel() ?? void 0;
  }
  onClose() {
  }
}
export {
  ProblemsAccessibilityHelp
};
