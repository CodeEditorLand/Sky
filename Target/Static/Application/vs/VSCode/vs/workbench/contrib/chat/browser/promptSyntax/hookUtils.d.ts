...
import { IHookCommand } from '../../common/promptSyntax/hookSchema.js';
 ...
 */
export declare function findHookCommandInYaml(content: string, commandText: string): ITextEditorSelection | undefined;
/**
