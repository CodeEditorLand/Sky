const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/Context.DNXab-rS.js","_astro/Editor.C9B_yFY6.js","_astro/solid.f9AvF4Qv.js","_astro/Context.C5lr4NT9.js","_astro/Context.pG7R-Yt5.js","_astro/Context.oDUqRsZz.js","_astro/Anchor.BDXCcMdI.js","_astro/Merge.Dw1gOiV8.js","_astro/Editor.CdlKhxrg.css","_astro/Button.B9GvUbmj.js","_astro/Copy.GHS26ysh.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './Editor.C9B_yFY6.js';
import { e as editor } from './editor.main.BxXZFlHO.js';
...
function Form(props) {
  ...
  return /* @__PURE__ */ React.createElement("form", { novalidate: true, ...other, ref: props.of.internal.element.set, onSubmit: async (event) => {
 ...
 */
export default () => ({});
`;default:return ""}},w=({Content:r,Field:n},d)=>{d&&(d.preventDefault(),c.Socket[0]()?.send(JSON.stringify({Key:l.Items[0]()?.get("Key")?.[0](),Identifier:l.Items[0]()?.get("Identifier")?.[0](),To:n,Input:r})));},{default:o}=await __vitePreload(async () => { const {default:o} = await import('./Context.DNXab-rS.js');return {default:o}},true?__vite__mapDeps([0,1,2]):void 0),{default:c}=await __vitePreload(async () => { const {default:c} = await import('./Context.C5lr4NT9.js');return {default:c}},true?__vite__mapDeps([3,1,2]):void 0),{default:b}=await __vitePreload(async () => { const {default:b} = await import('./Context.pG7R-Yt5.js');return {default:b}},true?__vite__mapDeps([4,1,2]):void 0),{default:l}=await __vitePreload(async () => { const {default:l} = await import('./Context.oDUqRsZz.js');return {default:l}},true?__vite__mapDeps([5,1,2]):void 0),{default:T}=await __vitePreload(async () => { const {default:T} = await import('./Anchor.BDXCcMdI.js');return {default:T}},true?__vite__mapDeps([6,7,1,2,8]):void 0),{default:A}=await __vitePreload(async () => { const {default:A} = await import('./Button.B9GvUbmj.js');return {default:A}},true?__vite__mapDeps([9,1,2,8]):void 0),{default:k,Fn:O}=await __vitePreload(async () => { const {default:k,Fn:O} = await import('./Copy.GHS26ysh.js');return {default:k,Fn:O}},true?__vite__mapDeps([10,1,2,8]):void 0),{default:h}=await __vitePreload(async () => { const {default:h} = await import('./Merge.Dw1gOiV8.js');return {default:h}},true?__vite__mapDeps([7,1,2]):void 0);
...
//# sourceMappingURL=Editor.CKcvGz5q.js.map
