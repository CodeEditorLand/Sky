...
let TimelineTreeRenderer = class TimelineTreeRenderer2 {
  ...
  constructor(commands, viewContainerLocation, instantiationService, themeService) {
    ...
    this._hoverDelegate = this.instantiationService.createInstance(WorkbenchHoverDelegate, this.viewContainerLocation === 1 ? "mouse" : "element", {
      instantHover: this.viewContainerLocation !== 1
