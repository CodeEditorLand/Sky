const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			...
			"_astro/Context.4FjCbzR8.js",
			"_astro/Context.DIzf7vsw.js",
			"_astro/Anchor.CjS16S1n.js",
			"_astro/Merge.BGVZFXMF.js",
			"_astro/Button.D5XJYHCt.js",
			"_astro/Copy.DkuGfXgI.js",
			"_astro/Copy.D8OFgVAP.css",
		]),
) => i.map((i) => d[i]);
import { _ as __vitePreload } from "./Editor.G0rPb_Kj.js";
import { e as editor } from "./editor.main.gOk32hJF.js";
import {
	createSignal as createSignal$1,
	mergeProps,
	untrack,
	batch,
	createEffect,
...
function removeInvalidNames(form, names) {
	getFieldArrayNames(form, false).forEach((fieldArrayName) => {
		const lastIndex =
			untrack(getFieldArrayStore(form, fieldArrayName).items.get).length -
			1;
		names
			.filter(
				(name) =>
			...
			fieldArrayNames.map(async (name) => {
				...
				if (!shouldActive || untrack(fieldArray.active.get)) {
					...
					for (const validation of fieldArray.validate) {
						localError = await validation(
							untrack(fieldArray.items.get),
						);
			...
			},
			{
				...
				ref(element) {
					...
					createEffect(() => {
						if (
							element.type !== "radio" &&
							getField().startValue.get() === void 0 &&
							untrack(getField().value.get) === void 0
						) {
...
var H = ({ Type: r } = { Type: "HTML" }) => {
	const [n, { Form: d, Field: f }] = createForm(),
		i = crypto.randomUUID();
	createEffect(
		on(
			o.Editors[0],
			(e) => {
				setValue(n, "Content", e.get(i)?.Content ?? "", {
					shouldFocus: !1,
					shouldTouched: !1,
				}),
					validate(n);
	...
	const s = createSignal$1(E(r));
	createEffect(
		on(c.Messages[0], (e) => e?.get("Type") && s[1](e?.get("Type")), {
			defer: !1,
		}),
	);
	let u, t;
	return (
		...
		onMount(() => {
			u instanceof HTMLElement &&
				...
				t.getModel()?.setEOL(editor.EndOfLineSequence.LF),
				t.onKeyDown((e) => {
					e.ctrlKey &&
						e.code === "KeyS" &&
						(e.preventDefault(), validate(n), n.element?.submit());
				}),
				...
				createEffect(
					on(s[0], (e) => t.getModel()?.setValue(e), { defer: !1 }),
				),
				c.Socket[0]()?.send(
					JSON.stringify({
		...
		createComponent(
			...
			{
				class:
					!o.Editors[0]()?.get(i)?.Hidden && b.Data[0]()?.get("Name")
						? ""
						: "hidden",
			},
			createComponent(
			...
			createComponent("br", null),
			createComponent(
				d,
				{ method: "post", onSubmit: w },
				createComponent(
					f,
					{
						name: "Content",
						validate: [required(`Please enter some ${r}.`)],
					},
					(e, a) =>
						createComponent(
							"div",
				...
				createComponent(f, { name: "Field" }, (e, a) =>
					createComponent("input", {
						type: "hidden",
						...a,
						value: r,
...
`;
	...
	{ default: o } = await __vitePreload(
		async () => {
			const { default: o } = await import("./Context.CFyhfv8p.js");
			return { default: o };
		},
	...
	{ default: c } = await __vitePreload(
		async () => {
			const { default: c } = await import("./Context.BNo3vInW.js");
			return { default: c };
		},
		true ? __vite__mapDeps([3, 1, 2]) : void 0,
	),
	{ default: b } = await __vitePreload(
		async () => {
			const { default: b } = await import("./Context.4FjCbzR8.js");
			return { default: b };
		},
		true ? __vite__mapDeps([4, 1, 2]) : void 0,
	),
	{ default: l } = await __vitePreload(
		async () => {
			const { default: l } = await import("./Context.DIzf7vsw.js");
			return { default: l };
		},
		true ? __vite__mapDeps([5, 1, 2]) : void 0,
	),
	{ default: T } = await __vitePreload(
		async () => {
			const { default: T } = await import("./Anchor.CjS16S1n.js");
			return { default: T };
		},
		true ? __vite__mapDeps([6, 7, 1, 2]) : void 0,
	),
	{ default: A } = await __vitePreload(
		async () => {
			const { default: A } = await import("./Button.D5XJYHCt.js");
			return { default: A };
		},
		true ? __vite__mapDeps([8, 1, 2]) : void 0,
	),
	{ default: k, Fn: O } = await __vitePreload(
		async () => {
			const { default: k, Fn: O } = await import("./Copy.DkuGfXgI.js");
			return { default: k, Fn: O };
		},
		true ? __vite__mapDeps([9, 1, 2, 10]) : void 0,
	),
	{ default: h } = await __vitePreload(
		async () => {
			const { default: h } = await import("./Merge.BGVZFXMF.js");
			return { default: h };
		},
...
//# sourceMappingURL=Editor.Dv6Qdj3l.js.map
