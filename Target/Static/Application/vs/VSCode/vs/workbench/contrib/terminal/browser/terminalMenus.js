...
function getTerminalActionBarArgs(location, profiles, defaultProfileName, contributedProfiles, terminalService, dropdownMenu, disposableStore, configurationService) {
  const shouldElevateAiProfiles = configurationService.getValue(
  ...
  const [aiProfiles, otherProfiles] = shouldElevateAiProfiles ? splitProfiles(profiles) : [[], profiles];
  const [aiContributedProfiles, otherContributedProfiles] = shouldElevateAiProfiles ? splitContributedProfiles(contributedProfiles) : [[], contributedProfiles];
...
__name(splitProfiles, "splitProfiles");
...
__name(splitContributedProfiles, "splitContributedProfiles");
...
__name(addProfileActions, "addProfileActions");
...
__name(addContributedProfileActions, "addContributedProfileActions");
export {
