...
export declare class InsertCursorAbove extends EditorAction {
    constructor();
    run(accessor: ServicesAccessor, editor: ICodeEditor, args: InsertCursorArgs): void;
}
...
export declare class FocusNextCursor extends EditorAction {
    constructor();
    run(accessor: ServicesAccessor, editor: ICodeEditor, args: FocusCursorArgs): void;
}
