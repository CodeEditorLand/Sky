...
` +
	...
	function ns(e) {
		return e instanceof rs
			? !0
			: e instanceof Error && e.name === xt && e.message === xt;
	}
	class rs extends Error {
		constructor() {
			super(xt), (this.name = this.message);
		}
	}
	...
	(function (e) {
		...
		e.from = l;
		function* o(p) {
			for (let x = p.length - 1; x >= 0; x--) yield p[x];
		}
		e.reverse = o;
		function u(p) {
		...
		function f(p, x) {
			let N = 0;
			for (const A of p) if (x(A, N++)) return !0;
			return !1;
		}
		e.some = f;
		function h(p, x) {
			for (const N of p) if (x(N)) return N;
		}
		e.find = h;
		function* d(p, x) {
			for (const N of p) x(N) && (yield N);
		}
		e.filter = d;
		function* m(p, x) {
			let N = 0;
			for (const A of p) yield x(A, N++);
		}
		e.map = m;
		function* g(p, x) {
			let N = 0;
		...
		function v(p, x, N) {
			let A = N;
			for (const E of p) A = x(A, E);
			return A;
		}
		e.reduce = v;
		function* L(p, x, N = p.length) {
			for (
				x < 0 && (x += p.length),
		...
		e.slice = L;
		function C(p, x = Number.POSITIVE_INFINITY) {
			const N = [];
			if (x === 0) return [N, p];
		...
		async function S(p) {
			const x = [];
			for await (const N of p) x.push(N);
	...
	(function (e) {
			...
			return (b, R = null, y) => {
				...
				return (
					(T = w(
						(q) => {
							if (!k)
								return T ? T.dispose() : (k = !0), b.call(R, q);
						},
						null,
						y,
					)),
		...
		e.once = n;
		function r(w, b, R) {
			return c((y, k = null, T) => w((q) => y.call(k, b(q)), null, T), R);
		}
		e.map = r;
		function s(w, b, R) {
			return c(
		...
		function i(w, b, R) {
			return c(
				(y, k = null, T) => w((q) => b(q) && y.call(k, q), null, T),
				R,
			);
		}
		e.filter = i;
		...
		function o(...w) {
			return (b, R = null, y) => {
				const k = is(...w.map((T) => T((q) => b.call(R, q))));
				return f(k, y);
			};
		}
		e.any = o;
		...
		function c(w, b) {
			...
			const y = {
				...
				k = new se(y);
			return b?.add(k), k.event;
		}
		function f(w, b) {
			return b instanceof Array ? b.push(w) : b && b.add(w), w;
		}
		function h(w, b, R = 100, y = !1, k = !1, T, q) {
			let X,
				Y,
				He,
				bt = 0,
		...
		e.latch = m;
		function g(w, b, R) {
			return [e.filter(w, b, R), e.filter(w, (y) => !b(y), R)];
		}
		e.split = g;
		function _(w, b = !1, R = [], y) {
			let k = R.slice(),
				T = w((Y) => {
					k ? k.push(Y) : X.fire(Y);
				});
			y && y.add(T);
			const q = () => {
					k?.forEach((Y) => X.fire(Y)), (k = null);
				},
				X = new se({
					onWillAddFirstListener() {
						T || ((T = w((Y) => X.fire(Y))), y && y.add(T));
					},
		...
		class C {
			...
			forEach(b) {
				return this.steps.push((R) => (b(R), R)), this;
			}
			filter(b) {
				return this.steps.push((R) => (b(R) ? R : L)), this;
			}
			reduce(b, R) {
				let y = R;
				return this.steps.push((k) => ((y = b(y, k)), y)), this;
			}
			latch(b = (R, y) => R === y) {
				let R = !0,
					y;
				return (
					this.steps.push((k) => {
						const T = R || !b(k, y);
						return (R = !1), (y = k), T ? k : L;
					}),
					this
				);
			}
			evaluate(b) {
				for (const R of this.steps) if (((b = R(b)), b === L)) break;
				return b;
			}
		}
		function S(w, b, R = (y) => y) {
			const y = (...X) => q.fire(R(...X)),
				k = () => w.on(b, y),
				T = () => w.removeListener(b, y),
				q = new se({
		...
		function p(w, b, R = (y) => y) {
			const y = (...X) => q.fire(R(...X)),
				k = () => w.addEventListener(b, y),
				T = () => w.removeEventListener(b, y),
				q = new se({
					onWillAddFirstListener: k,
					onDidRemoveLastListener: T,
				});
		...
		class E {
			constructor(b, R) {
				...
				(this.emitter = new se(y)), R && R.add(this.emitter);
			}
			beginUpdate(b) {
				this._counter++;
			}
			...
			return (b, R, y) => {
				...
				const q = {
					...
					endUpdate() {
						k--,
							k === 0 &&
								(w.reportChanges(), T && ((T = !1), b.call(R)));
					},
				...
				return (
					y instanceof ye ? y.add(X) : Array.isArray(y) && y.push(X),
					X
				);
			};
		}
	...
	let os = -1;
	class nt {
		constructor(t, n, r = (nt._idPool++).toString(16).padStart(3, "0")) {
	...
	class vt {
		static create() {
			var t;
			const n = new Error();
			return new vt((t = n.stack) !== null && t !== void 0 ? t : "");
		}
		constructor(t) {
			this.value = t;
		}
...
`),
	...
	class se {
				...
				((t = this._event) !== null && t !== void 0) ||
					(this._event = (n, r, s) => {
						...
						if (
							...
							const v =
									(i =
										...
										: ["UNKNOWN stack", -1],
								L = new cs(
									`${_}. HINT: Stack shows most frequent listener (${v[1]}-times)`,
									v[0],
								);
							return (
								(
						...
						this._leakageMon &&
							...
							((d.stack = vt.create()),
							(m = this._leakageMon.check(
								d.stack,
								this._size + 1,
							))),
							this._listeners
								? this._listeners instanceof wt
									? (((h = this._deliveryQueue) !== null &&
											h !== void 0) ||
											(this._deliveryQueue = new fs()),
										(this._listeners = [
											this._listeners,
											d,
										]))
								...
								: ((u =
									...
									(f =
										...
										c === void 0
											? void 0
											: c.onDidAddFirstListener) ===
										null ||
										f === void 0 ||
										f.call(c, this)),
							this._size++;
						const g = et(() => {
							m?.(), this._removeListener(d);
						});
						return (
							s instanceof ye
								? s.add(g)
								: Array.isArray(s) && s.push(g),
							g
						);
					}),
				this._event
		...
		fire(t) {
			...
			if (
				...
				if (this._listeners instanceof wt)
					this._deliver(this._listeners, t);
				else {
					const l = this._deliveryQueue;
					l.enqueue(this, t, this._listeners.length),
						this._deliverQueue(l);
				}
	...
	function Lt(e) {
		const t = [];
		for (const n of ms(e)) typeof e[n] == "function" && t.push(n);
		return t;
	}
	function gs(e, t) {
		const n = (s) =>
	...
	typeof Le.vscode < "u" && typeof Le.vscode.process < "u"
		? (Q = Le.vscode.process)
		: typeof process < "u" &&
			typeof ((Nt = process == null ? void 0 : process.versions) ===
				null || Nt === void 0
				? void 0
				: Nt.node) == "string" &&
			(Q = process);
	const ps =
		typeof ((St = Q?.versions) === null || St === void 0
			? void 0
			: St.electron) == "string" && Q?.type === "renderer";
	if (typeof Q == "object") {
		(Ct = Q.platform === "win32"),
			(At = Q.platform === "darwin"),
			(Rt = Q.platform === "linux"),
			Rt && Q.env.SNAP && Q.env.SNAP_REVISION,
		...
		if (e)
			try {
				...
				(rt = t.locale),
					(tn = t.osLocale),
					(yt = n || Me),
					(xs = t._translationsConfigFile);
			} catch {}
	} else
		typeof navigator == "object" && !ps
			? ((ie = navigator.userAgent),
				(Ct = ie.indexOf("Windows") >= 0),
				(At = ie.indexOf("Macintosh") >= 0),
				(ie.indexOf("Macintosh") >= 0 ||
					ie.indexOf("iPad") >= 0 ||
					ie.indexOf("iPhone") >= 0) &&
					navigator.maxTouchPoints &&
					navigator.maxTouchPoints > 0,
				(Rt = ie.indexOf("Linux") >= 0),
				ie?.indexOf("Mobi") >= 0,
				H(
					{
				...
				(rt = Me),
				(yt = rt),
				(tn = navigator.language))
			: console.error("Unable to resolve platform.");
	const ze = Ct,
		vs = At,
		ue = ie,
		ws = typeof Le.postMessage == "function" && !Le.importScripts;
	(() => {
		if (ws) {
			const e = [];
	...
	const Ls = !!(ue && ue.indexOf("Chrome") >= 0);
	ue && ue.indexOf("Firefox") >= 0,
		!Ls && ue && ue.indexOf("Safari") >= 0,
		ue && ue.indexOf("Edg/") >= 0,
	...
	class Ss {
		constructor(t, n) {
			(this.lastCache = void 0),
				...
				typeof t == "function"
					? ((this._fn = t), (this._computeKey = Ns))
	...
	(ke = Ne),
		(Ne.ambiguousCharacterData = new nn(() =>
			JSON.parse(
		...
		(Ne.cache = new Ss({ getCacheKey: JSON.stringify }, (e) => {
			function t(c) {
				const f = new Map();
	...
	class qs {
			...
			const s = new se({
				onWillAddFirstListener: () => {
					(r = String(++this._lastSentReq)),
						...
						this._send(new Vs(this._workerId, r, t, n));
				},
				onDidRemoveLastListener: () => {
					this._pendingEmitters.delete(r),
						this._send(new Bs(this._workerId, r)),
						(r = null);
				},
			});
			return s.event;
		...
		_handleRequestMessage(t) {
			...
			this._handler.handleMessage(t.method, t.args).then(
				(s) => {
					this._send(new sn(this._workerId, n, s, void 0));
				},
				(s) => {
					s.detail instanceof Error && (s.detail = Kt(s.detail)),
						this._send(new sn(this._workerId, n, void 0, Kt(s)));
				},
			);
		}
		_handleSubscribeEventMessage(t) {
			const n = t.req,
				r = this._handler.handleEvent(
					...
					this._send(new Is(this._workerId, n, s));
				});
	...
	function an(e) {
		return e[0] === "o" && e[1] === "n" && rn(e.charCodeAt(2));
	}
	function ln(e) {
		return /^onDynamic/.test(e) && rn(e.charCodeAt(9));
	}
	function Us(e, t, n) {
		const r = (l) =>
				function () {
	...
	class Hs {
		...
		_handleMessage(t, n) {
			if (t === Ds) return this.initialize(n[0], n[1], n[2], n[3]);
			if (
		...
		initialize(t, n, r, s) {
			...
			return this._requestHandlerFactory
				? ((this._requestHandler = this._requestHandlerFactory(o)),
					Promise.resolve(Lt(this._requestHandler)))
				: (n &&
					...
					new Promise((u, c) => {
						...
						f(
							...
							(h) => {
								if (
									((this._requestHandler = h.create(o)),
									!this._requestHandler)
								) {
									c(new Error("No RequestHandler!"));
									return;
								}
								u(Lt(this._requestHandler));
							},
							c,
						);
					}));
	...
	function Ws(e, t) {
		t = on(149417, t);
		for (let n = 0, r = e.length; n < r; n++) t = on(e.charCodeAt(n), t);
		return t;
	}
	class un {
		constructor(t) {
	...
	function zs(e, t, n) {
		return new ge(new un(e), new un(t)).ComputeDiff(n).changes;
	}
	class Fe {
		static Assert(t, n) {
	...
	class ge {
		...
		static _getElements(t) {
			...
			if (ge._isStringArray(n)) {
				...
				for (let s = 0, i = n.length; s < i; s++) r[s] = Ws(n[s], 0);
				return [n, r, !0];
			}
		...
		WALKTRACE(t, n, r, s, i, l, o, u, c, f, h, d, m, g, _, v, L, C) {
			let S = null,
				p = null,
				x = new cn(),
				N = n,
			...
			do {
				...
				w === N || (w < A && c[w - 1] < c[w + 1])
					? ((h = c[w + 1]),
						(g = h - E - s),
						h < I && x.MarkNextChange(),
						(I = h),
						x.AddModifiedElement(h + 1, g),
						(E = w + 1 - t))
					: ((h = c[w - 1] + 1),
						(g = h - E - s),
						h < I && x.MarkNextChange(),
						(I = h - 1),
						x.AddOriginalElement(h, g + 1),
						(E = w - 1 - t)),
					G >= 0 &&
			...
			if (((S = x.getReverseChanges()), C[0])) {
				let w = m[0] + 1,
					b = v[0] + 1;
				if (S !== null && S.length > 0) {
					const R = S[S.length - 1];
					(w = Math.max(w, R.getOriginalEnd())),
						(b = Math.max(b, R.getModifiedEnd()));
				}
				p = [new me(w, d - w + 1, b, _ - b + 1)];
			} else {
				(x = new cn()),
					(N = l),
					(A = o),
				...
				do {
					...
					w === N || (w < A && f[w - 1] >= f[w + 1])
						? ((h = f[w + 1] - 1),
							...
							h > I && x.MarkNextChange(),
							(I = h + 1),
							x.AddOriginalElement(h + 1, g + 1),
							(E = w + 1 - i))
						: ((h = f[w - 1]),
							(g = h - E - u),
							h > I && x.MarkNextChange(),
							(I = h),
							x.AddModifiedElement(h + 1, g + 1),
							(E = w - 1 - i)),
						G >= 0 &&
		...
		ComputeRecursionPoint(t, n, r, s, i, l, o) {
			...
			for (let E = 1; E <= g / 2 + 1; E++) {
				let I = 0,
					G = 0;
				(f = this.ClipDiagonalBound(C - E, E, C, _)),
					(h = this.ClipDiagonalBound(C + E, E, C, _));
				for (let b = f; b <= h; b += 2) {
					b === f || (b < h && v[b - 1] < v[b + 1])
						? (u = v[b + 1])
						: (u = v[b - 1] + 1),
					...
					for (
						;
						u < n && c < s && this.ElementsAreEqual(u + 1, c + 1);
					)
						u++, c++;
					if (
						((v[b] = u),
						u + c > I + G && ((I = u), (G = c)),
						!A && Math.abs(b - S) <= E - 1 && u >= L[b])
					)
						return (
							(i[0] = u),
							(l[0] = c),
				...
				if (
					...
					!this.ContinueProcessingPredicate(I, w)
				)
					return (
						(o[0] = !0),
						(i[0] = I),
				...
				(d = this.ClipDiagonalBound(S - E, E, S, _)),
					(m = this.ClipDiagonalBound(S + E, E, S, _));
				for (let b = d; b <= m; b += 2) {
					b === d || (b < m && L[b - 1] >= L[b + 1])
						? (u = L[b + 1] - 1)
						: (u = L[b - 1]),
					...
					for (; u > t && c > r && this.ElementsAreEqual(u, c); )
						u--, c--;
					if (((L[b] = u), A && Math.abs(b - C) <= E && u <= v[b]))
						return (
							(i[0] = u),
							(l[0] = c),
							R >= v[b] && E <= 1448
					...
					if (l < 5 && c < 20 && d < 20) {
						...
						if (m) {
							...
							(g !== s.originalStart + s.originalLength ||
								_ !== s.modifiedStart + s.modifiedLength) &&
								((s.originalLength = g - s.originalStart),
								(s.modifiedLength = _ - s.modifiedStart),
								(i.originalStart = g + l),
								(i.modifiedStart = _ + l),
		...
		_OriginalRegionIsBoundary(t, n) {
			...
			if (n > 0) {
				const r = t + n;
				if (
					this._OriginalIsBoundary(r - 1) ||
					this._OriginalIsBoundary(r)
				)
					return !0;
			}
			return !1;
		...
		_ModifiedRegionIsBoundary(t, n) {
			...
			if (n > 0) {
				const r = t + n;
				if (
					this._ModifiedIsBoundary(r - 1) ||
					this._ModifiedIsBoundary(r)
				)
					return !0;
			}
			return !1;
		...
		ConcatenateChanges(t, n) {
			...
			if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
				...
				return (
					Pe.Copy(t, 0, s, 0, t.length),
					Pe.Copy(n, 0, s, t.length, n.length),
					s
				);
			}
		}
	...
	if (typeof Mt < "u" && typeof Mt.process < "u") {
		...
		typeof process < "u"
			? (De = {
					...
					cwd() {
						return hn.VSCODE_CWD || process.cwd();
					},
				})
			: (De = {
					get platform() {
						return ze ? "win32" : vs ? "darwin" : "linux";
					},
					get arch() {},
					get env() {
						return {};
	...
	function Ys(e, t) {
		if (e === null || typeof e != "object") throw new fn(t, "Object", e);
	}
	function $(e, t) {
		if (typeof e != "string") throw new fn(t, "string", e);
	}
	const xe = Os === "win32";
	function P(e) {
		return e === j || e === K;
	...
	const Z = {
			...
			relative(e, t) {
				...
				if (
					n === r ||
					((e = n.toLowerCase()), (t = r.toLowerCase()), e === t)
				)
					return "";
				let s = 0;
	...
	class Se {
		...
		static file(t) {
			let n = W;
			if (
				(ze && (t = t.replace(/\\/g, ae)), t[0] === ae && t[1] === ae)
			) {
	...
	class Te extends Se {
		...
		toString(t = !1) {
			return t
				? Pt(this, !0)
				: (this._formatted || (this._formatted = Pt(this, !1)),
					this._formatted);
		}
		toJSON() {
			const t = { $mid: 1 };
			return (
				this._fsPath && ((t.fsPath = this._fsPath), (t._sep = mn)),
	...
	function bn(e, t, n) {
		...
		for (let i = 0; i < e.length; i++) {
			...
			if (
				...
				o !== void 0
					? (s !== -1 &&
							((r += encodeURIComponent(e.substring(s, i))),
							(s = -1)),
						(r += o))
					: s === -1 && (s = i);
			}
	...
	function ai(e) {
		...
		for (let n = 0; n < e.length; n++) {
			const r = e.charCodeAt(n);
			r === 35 || r === 63
				? (t === void 0 && (t = e.substr(0, n)), (t += gn[r]))
				: t !== void 0 && (t += e[n]);
		}
		return t !== void 0 ? t : e;
	}
	...
	function _n(e) {
		try {
			...
			return e.length > 3 ? e.substr(0, 3) + _n(e.substr(3)) : e;
		}
	}
	const xn = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
	function at(e) {
		return e.match(xn) ? e.replace(xn, (t) => _n(t)) : e;
	}
	class J {
		constructor(t, n) {
		...
		static plusRange(t, n) {
			...
			return (
				...
				n.endLineNumber > t.endLineNumber
					...
					: n.endLineNumber === t.endLineNumber
						? ((i = n.endLineNumber),
							(l = Math.max(n.endColumn, t.endColumn)))
	...
	function* oi(e, t) {
		let n, r;
		for (const s of e)
			r !== void 0 && t(r, s) ? n.push(s) : (n && (yield n), (n = [s])),
				(r = s);
		n && (yield n);
	}
	function ui(e, t) {
	...
	function _i(e = "") {
		let t = "(-?\\d*\\.\\d\\w*)|([^";
		for (const n of bi) e.indexOf(n) >= 0 || (t += "\\" + n);
	...
	const Nn = new as();
	Nn.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
	function Dt(e, t, n, r, s) {
		if (((t = Ln(t)), s || (s = Ke.first(Nn)), n.length > s.maxLen)) {
			let c = e - s.maxLen / 2;
			return (
				c < 0 ? (c = 0) : (r += c),
	...
	class Tt {
		constructor(t) {
			...
			(this._defaultValue = n),
				(this._asciiMap = Tt._createAsciiMap(n)),
				(this._map = new Map());
		}
			...
			for (let i = 1, l = t.getLineCount(); i <= l; i++) {
				...
				for (; c < u; ) {
					...
					if (d === 13) {
						...
						S === 1 &&
							(s.push(ut._createLink(r, o, i, f, c)), (L = !0));
					} else if (d === 12) {
						let S;
						C === 91 ? ((g = !0), (S = 0)) : (S = r.get(C)),
							S === 1 ? (L = !0) : (d = 13);
					} else (d = n.nextState(d, C)), d === 0 && (L = !0);
					L &&
						((d = 1),
						(m = !1),
						(g = !1),
				...
				d === 13 && s.push(ut._createLink(r, o, i, f, u));
			}
			return s;
		}
	}
	...
	It.INSTANCE = new It();
	const Sn = Object.freeze(function (e, t) {
	...
	(function (e) {
		function t(n) {
			return n === e.None || n === e.Cancelled || n instanceof ht
				? !0
				: !n || typeof n != "object"
					? !1
	...
	class ht {
		...
		get onCancellationRequested() {
			return this._isCancelled
				? Sn
				: (this._emitter || (this._emitter = new se()),
					this._emitter.event);
		}
		dispose() {
	...
	(function () {
		...
		for (const s of t) {
			...
			if (
				(r[l] || ((r[l] = !0), (Ai[o] = l), (Ri[o.toLowerCase()] = l)),
				!n[u])
			) {
				if (((n[u] = !0), !c))
					throw new Error(
	...
	(function (e) {
		...
		function s(o) {
			return Ut.keyCodeToStr(o);
		}
		e.toUserSettingsGeneral = s;
		function i(o) {
			return qt.strToKeyCode(o) || Ut.strToKeyCode(o);
		}
	...
	class ki {
		...
		registerFactory(t, n) {
			var r;
			(r = this._factories.get(t)) === null ||
				r === void 0 ||
				r.dispose();
			const s = new Fi(this, t, n);
			return (
	...
	class Ti {
		...
		set(t, n, r = 0) {
			...
			if (s) (s.value = n), r !== 0 && this.touch(s, r);
				...
				switch (
					((s = { key: t, value: n, next: void 0, previous: void 0 }),
					r)
				) {
					case 0:
						this.addItemLast(s);
	...
	function Hi(e, t, n, r, s) {
		return qi(e, t, n, r, s) && Ui(e, t, n, r, s);
	}
	class Wi {
		constructor(t, n) {
		...
		next(t) {
			...
			do {
				...
				const s = r.index,
					i = r[0].length;
				if (
					s === this._prevMatchStartIndex &&
					i === this._prevMatchLength
				) {
					if (i === 0) {
						ks(t, n, this._searchRegex.lastIndex) > 65535
				...
				if (
					...
					!this._wordSeparators ||
						Hi(this._wordSeparators, t, n, s, i))
				)
					return r;
			} while (r);
			return null;
	...
	class $i {
		static computeUnicodeHighlights(t, n, r) {
			...
			o === "allNonBasicAscii"
				? (u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
				: (u = new RegExp(`${Oi(Array.from(o))}`, "g"));
			const c = new Wi(null, u),
				f = [];
			let h = !1,
				d,
				m = 0,
			...
			e: for (let v = s, L = i; v <= L; v++) {
				...
				do
					if (((d = c.next(C)), d)) {
						...
						if (x + 1 < S) {
							const I = C.charCodeAt(x - 1);
							Et(I) && x++;
						}
						const N = C.substring(p, x);
						let A = Dt(p + 1, wn, C, 0);
						A && A.endColumn <= p + 1 && (A = null);
						const E = l.shouldHighlightNonBasicASCII(
							N,
							A ? A.word : null,
						);
						if (E !== 0) {
	...
	function Oi(e, t) {
		return `[${Cs(e.map((r) => String.fromCodePoint(r)).join(""))}]`;
	}
	class Fr {
		constructor(t) {
			(this.options = t),
...
` ||
	...
	function Ot(e, t, n = 0, r = e.length) {
		let s = n,
			i = r;
		for (; s < i; ) {
			const l = Math.floor((s + i) / 2);
	...
	class D {
		...
		mapToLineArray(t) {
			const n = [];
			for (
				let r = this.startLineNumber;
				r < this.endLineNumberExclusive;
				r++
			)
				n.push(t(r));
			return n;
		...
		getIntersection(t) {
			...
			for (
				...
				o && !o.isEmpty && n.push(o),
					i.endLineNumberExclusive < l.endLineNumberExclusive
						? r++
						: s++;
			}
			return new ce(n);
	...
	class he extends le {
		static fromRangeMappings(t) {
			const n = D.join(
					t.map((s) => D.fromRangeInclusive(s.originalRange)),
				),
		...
		withInnerChangesFromLineRanges() {
			return new he(this.original, this.modified, [
				this.toRangeMapping(),
			]);
		}
	}
	class ve {
		...
		toTextEdit(t) {
			...
			return new Xi(this.originalRange, n);
		}
	}
	const Qi = 3;
	class Ji {
		...
		static createFromDiffResult(t, n, r, s, i, l, o) {
			...
			if (
				...
				if (m.getElements().length > 0 && g.getElements().length > 0) {
					let _ = Dr(m, g, i, !0).changes;
					o && (_ = Zi(_)), (d = []);
					for (let v = 0, L = _.length; v < L; v++)
						d.push(Be.createFromDiffChange(_[v], m, g));
				}
			}
		...
		constructor(t, n, r) {
			(this.shouldComputeCharChanges = r.shouldComputeCharChanges),
				...
				(this.shouldIgnoreTrimWhitespace =
					r.shouldIgnoreTrimWhitespace),
				(this.shouldMakePrettyDiff = r.shouldMakePrettyDiff),
				(this.originalLines = t),
				(this.modifiedLines = n),
				(this.original = new Tr(t)),
				(this.modified = new Tr(n)),
				(this.continueLineDiff = Vr(r.maxComputationTime)),
...
`);
	...
	class ta {
		compute(t, n, r = Qe.instance, s) {
			...
			const i = new Xt(t.length, n.length),
				l = new Xt(t.length, n.length),
				o = new Xt(t.length, n.length);
			for (let g = 0; g < t.length; g++)
				for (let _ = 0; _ < n.length; _++) {
					if (!r.isValid()) return fe.trivialTimedOut(t, n);
					const v = g === 0 ? 0 : i.get(g - 1, _),
						L = _ === 0 ? 0 : i.get(g, _ - 1);
					let C;
					t.getElement(g) === n.getElement(_)
						? (g === 0 || _ === 0
								? (C = 0)
								: (C = i.get(g - 1, _ - 1)),
							g > 0 &&
							...
							(C += s ? s(g, _) : 1))
						: (C = -1);
					const S = Math.max(v, L, C);
					if (S === C) {
						const p = g > 0 && _ > 0 ? o.get(g - 1, _ - 1) : 0;
						o.set(g, _, p + 1), l.set(g, _, 3);
					} else
						S === v
							? (o.set(g, _, 0), l.set(g, _, 1))
							: S === L && (o.set(g, _, 0), l.set(g, _, 2));
					i.set(g, _, S);
				}
			const u = [];
			let c = t.length,
			...
			function h(g, _) {
				(g + 1 !== c || _ + 1 !== f) &&
					u.push(new z(new V(g + 1, c), new V(_ + 1, f))),
					(c = g),
					(f = _);
			}
			let d = t.length - 1,
	...
	class Ir {
		compute(t, n, r = Qe.instance) {
			...
			u.set(0, l(0, 0));
			const c = new ra();
			c.set(0, u.get(0) === 0 ? null : new Br(null, 0, 0, u.get(0)));
			let f = 0;
			e: for (;;) {
				if ((o++, !r.isValid())) return fe.trivialTimedOut(s, i);
				const _ = -Math.min(o, i.length + (o % 2)),
					v = Math.min(o, s.length + (o % 2));
				for (f = _; f <= v; f += 2) {
					const L = f === v ? -1 : u.get(f + 1),
						C = f === _ ? -1 : u.get(f - 1) + 1,
						S = Math.min(Math.max(L, C), s.length),
						p = S - f;
					if (S > s.length || p > i.length) continue;
					const x = l(S, p);
					u.set(f, x);
					const N = S === L ? c.get(f + 1) : c.get(f - 1);
					if (
						(c.set(f, x !== S ? new Br(N, S, p, x - S) : N),
			...
			let m = s.length,
				g = i.length;
			for (;;) {
				const _ = h ? h.x + h.length : 0,
					v = h ? h.y + h.length : 0;
				if (
					((_ !== m || v !== g) &&
						d.push(new z(new V(_, m), new V(v, g))),
					!h)
				)
					break;
	...
	class gt {
		...
		getBoundaryScore(t) {
			const n = Ur(t > 0 ? this.elements[t - 1] : -1),
				r = Ur(t < this.elements.length ? this.elements[t] : -1);
			if (n === 7 && r === 8) return 0;
			if (n === 8) return 150;
			let s = 0;
			return (
		...
		findWordContaining(t) {
			if (t < 0 || t >= this.elements.length || !Jt(this.elements[t]))
				return;
			let n = t;
			for (; n > 0 && Jt(this.elements[n - 1]); ) n--;
			let r = t;
			for (; r < this.elements.length && Jt(this.elements[r]); ) r++;
			return new V(n, r);
		}
		countLinesIn(t) {
			return (
	...
	const sa = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 };
	function qr(e) {
		return sa[e];
	}
	function Ur(e) {
	...
	function ia(e, t, n, r, s, i) {
		let { moves: l, excludedChanges: o } = la(e, t, n, i);
		if (!i.isValid()) return [];
...
`).length >= 15 && aa(h, (m) => m.length >= 2) >= 2
	...
	function oa(e, t, n, r, s, i) {
		...
		const u = [];
		e.sort(lt((d) => d.modified.startLineNumber, ot));
		for (const d of e) {
			let m = [];
			for (
				...
				o.forEach(_, ({ range: C }) => {
					...
					const S = { modifiedLineRange: v, originalLineRange: C };
					u.push(S), L.push(S);
				}),
					(m = L);
			}
		...
		u.sort(fi(lt((d) => d.modifiedLineRange.length, ot)));
		const c = new ce(),
			f = new ce();
		for (const d of u) {
			const m =
				...
				_ = f.subtractFrom(d.originalLineRange).getWithDelta(m),
				v = g.getIntersection(_);
			for (const L of v.ranges) {
				if (L.length < 3) continue;
				const C = L,
					S = L.delta(-m);
				l.push(new le(S, C)), c.addRange(C), f.addRange(S);
			}
		}
		l.sort(lt((d) => d.original.startLineNumber, ot));
		const h = new je(e);
		for (let d = 0; d < l.length; d++) {
			const m = l[d],
				...
				v = Math.max(
					...
					m.modified.startLineNumber - _.modified.startLineNumber,
				),
			...
			let x;
			for (x = 0; x < S; x++) {
				const N = m.original.endLineNumberExclusive + x,
					A = m.modified.endLineNumberExclusive + x;
				if (
					N > r.length ||
					A > s.length ||
					c.contains(A) ||
	...
	function Hr(e, t, n) {
		...
		const s = new Ir().compute(
			new gt([e], new V(0, 1), !1),
			new gt([t], new V(0, 1), !1),
			n,
		);
		let i = 0;
		...
		function o(f) {
			let h = 0;
			for (let d = 0; d < e.length; d++) Qt(f.charCodeAt(d)) || h++;
			return h;
		}
	...
	function ua(e) {
		...
		e.sort(lt((n) => n.original.startLineNumber, ot));
		const t = [e[0]];
		for (let n = 1; n < e.length; n++) {
			const r = t[t.length - 1],
				s = e[n],
				i =
					s.original.startLineNumber -
					r.original.endLineNumberExclusive,
				l =
					s.modified.startLineNumber -
	...
	function Wr(e, t, n) {
		let r = n;
		return (r = zr(e, t, r)), (r = zr(e, t, r)), (r = ha(e, t, r)), r;
	}
	function zr(e, t, n) {
		...
		function l(u, c) {
			...
			for (; r.length > 0; ) {
				...
				if (
					...
					break;
				const C = e.findWordContaining(v.seq1Range.start),
					S = t.findWordContaining(v.seq2Range.start),
					p = new z(C, S),
					x = p.intersect(v);
				if (
					((g += x.seq1Range.length),
			...
			g + _ < ((d.seq1Range.length + d.seq2Range.length) * 2) / 3 &&
				s.push(d),
	...
	function ba(e, t, n) {
		...
		do {
			...
			for (let u = 1; u < r.length; u++) {
				let h = function (m, g) {
					...
					return (
						Math.pow(
							Math.pow(w(C * 40 + S), 1.5) +
								Math.pow(w(p * 40 + x), 1.5),
							1.5,
						) +
							Math.pow(
								Math.pow(w(N * 40 + A), 1.5) +
									Math.pow(w(E * 40 + I), 1.5),
								1.5,
							) >
						(G ** 1.5) ** 1.5 * 1.3
					);
		...
		return (
			ci(r, (o, u, c) => {
				...
				const _ = z.fromOffsetPairs(
						o ? o.getEndExclusives() : ne.zero,
						c ? c.getStarts() : ne.max,
					),
					v = f.intersect(_);
				l.length > 0 &&
				v.getStarts().equals(l[l.length - 1].getEndExclusives())
	...
	class Or {
		...
		getBoundaryScore(t) {
			const n = t === 0 ? 0 : Gr(this.lines[t - 1]),
				r = t === this.lines.length ? 0 : Gr(this.lines[t]);
			return 1e3 - (n + r);
		}
		getText(t) {
...
`);
	...
	class _a {
		constructor() {
			(this.dynamicProgrammingDiffing = new ta()),
				(this.myersDiffingAlgorithm = new Ir());
		}
		computeDiff(t, n, r) {
			if (t.length <= 1 && li(t, n, (x, N) => x === N))
				return new mt([], [], !1);
			if (
			...
			const s =
					r.maxComputationTimeMs === 0
						? Qe.instance
						: new ea(r.maxComputationTimeMs),
				i = !r.ignoreTrimWhitespace,
				l = new Map();
			function o(x) {
				let N = l.get(x);
				return N === void 0 && ((N = l.size), l.set(x, N)), N;
			}
			const u = t.map((x) => o(x.trim())),
				c = n.map((x) => o(x.trim())),
				f = new Or(u, t),
				h = new Or(c, n),
				d =
						...
						for (let N = 0; N < x; N++) {
							...
							if (t[A] !== n[E]) {
								const I = this.refineDiff(
									t,
									n,
									new z(new V(A, A + 1), new V(E, E + 1)),
									s,
									i,
								);
								for (const G of I.mappings) _.push(G);
								I.hitTimeout && (g = !0);
							}
						}
				};
			let L = 0,
				C = 0;
			for (const x of m) {
				dt(() => x.seq1Range.start - L === x.seq2Range.start - C);
				const N = x.seq1Range.start - L;
				v(N),
					(L = x.seq1Range.endExclusive),
					(C = x.seq2Range.endExclusive);
				const A = this.refineDiff(t, n, x, s, i);
				A.hitTimeout && (g = !0);
				for (const E of A.mappings) _.push(E);
			}
			v(t.length - L);
			const S = jr(_, t, n);
			let p = [];
			return (
				r.computeMoves && (p = this.computeMoves(S, t, n, u, c, s, i)),
				dt(() => {
					function x(A, E) {
						if (A.lineNumber < 1 || A.lineNumber > E.length)
							return !1;
						const I = E[A.lineNumber - 1];
						return !(A.column < 1 || A.column > I.length + 1);
					}
					function N(A, E) {
						return !(
							A.startLineNumber < 1 ||
							A.startLineNumber > E.length + 1 ||
							A.endLineNumberExclusive < 1 ||
							A.endLineNumberExclusive > E.length + 1
						);
					}
					for (const A of S) {
						...
						for (const E of A.innerChanges)
							if (
								!(
									x(E.modifiedRange.getStartPosition(), n) &&
									x(E.modifiedRange.getEndPosition(), n) &&
									x(E.originalRange.getStartPosition(), t) &&
									x(E.originalRange.getEndPosition(), t)
								)
							)
								return !1;
		...
		computeMoves(t, n, r, s, i, l, o) {
			return ia(t, n, r, s, i, l).map((f) => {
				const h = this.refineDiff(
					...
					d = jr(h.mappings, n, r, !0);
				return new Gi(f, d);
			});
		}
		refineDiff(t, n, r, s, i) {
			const l = new gt(t, r.seq1Range, i),
				o = new gt(n, r.seq2Range, i),
				u =
	...
	const Xr = { getLegacy: () => new Ji(), getDefault: () => new _a() };
	function we(e, t) {
	...
	class B {
		...
		constructor(t) {
			if (t)
				if (t instanceof O) this.rgba = t;
					...
					(this._hsva = t), (this.rgba = Ue.toRGBA(t));
		...
		getRelativeLuminance() {
			const t = B._relativeLuminanceForComponent(this.rgba.r),
				n = B._relativeLuminanceForComponent(this.rgba.g),
				r = B._relativeLuminanceForComponent(this.rgba.b),
	...
	(B.white = new B(new O(255, 255, 255, 1))),
		(B.black = new B(new O(0, 0, 0, 1))),
		(B.red = new B(new O(255, 0, 0, 1))),
		(B.blue = new B(new O(0, 0, 255, 1))),
		(B.green = new B(new O(0, 255, 0, 1))),
		(B.cyan = new B(new O(0, 255, 255, 1))),
		(B.lightgrey = new B(new O(211, 211, 211, 1))),
		(B.transparent = new B(new O(0, 0, 0, 0))),
		(function (e) {
			(function (t) {
				(function (n) {
					function r(m) {
						...
						if (g === 9) {
							const _ =
								...
								C =
									16 * d(m.charCodeAt(7)) +
									d(m.charCodeAt(8));
							return new e(new O(_, v, L, C / 255));
						}
						if (g === 4) {
							const _ = d(m.charCodeAt(1)),
								v = d(m.charCodeAt(2)),
								L = d(m.charCodeAt(3));
							return new e(
								new O(16 * _ + _, 16 * v + v, 16 * L + L),
							);
						}
						if (g === 5) {
							const _ = d(m.charCodeAt(1)),
	...
	function Jr(e, t, n) {
		...
		const s = t[0].values(),
			i = Qr(s);
		return { range: e, color: Yt(i[0], i[1], i[2], n ? i[3] : 1) };
	}
	function Yr(e, t, n) {
		if (!e || t.length !== 1) return;
		const s = t[0].values(),
			i = Qr(s),
			l = new B(new re(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
		return { range: e, color: Yt(l.rgba.r, l.rgba.g, l.rgba.b, l.rgba.a) };
	}
	function Ye(e, t) {
	...
	function Aa(e, t, n) {
		...
		if (r) {
			...
			if (l.endColumn > l.startColumn) {
				const o = { range: l, ...Kr(r[1]), shouldBeInComments: !0 };
	...
	function Kr(e) {
		...
		return (e = e.replace(La, "")), { text: e, hasSeparatorLine: t };
	}
	class Ra extends gi {
		get uri() {
			return this._uri;
		...
		findMatches(t) {
			...
			for (let r = 0; r < this._lines.length; r++) {
				const s = this._lines[r],
					...
					l = s.matchAll(t);
				for (const o of l)
					(o.index || o.index === 0) && (o.index = o.index + i),
						n.push(o);
			}
			return n;
		}
		...
		getWordAtPosition(t, n) {
			const r = Dt(t.column, Ln(n), this._lines[t.lineNumber - 1], 0);
			return r
		...
		getValueInRange(t) {
			...
			return (
				i.push(this._lines[s].substring(0, t.endColumn - 1)), i.join(n)
			);
		}
		offsetAt(t) {
			return (
	...
	class Ce {
		...
		async computeUnicodeHighlights(t, n, r) {
			...
			return s
				? $i.computeUnicodeHighlights(s, n, r)
				: {
						ranges: [],
						hasMore: !1,
		...
		static computeDiff(t, n, r, s) {
			const i = s === "advanced" ? Xr.getDefault() : Xr.getLegacy(),
				l = t.getLinesContent(),
				o = n.getLinesContent(),
		...
		async computeMoreMinimalEdits(t, n, r) {
			...
			for (let u = 1; u < n.length; u++)
				F.getEndPosition(n[o].range).equals(
					F.getStartPosition(n[u].range),
				)
			...
			for (let { range: u, text: c, eol: f } of n) {
				if ((typeof f == "number" && (l = f), F.isEmpty(u) && !c))
					continue;
				...
				for (const g of d) {
					const _ = s.positionAt(m + g.originalStart),
						v = s.positionAt(
		...
		async navigateValueSet(t, n, r, s, i) {
			...
			return It.INSTANCE.navigateValueSet(n, u, c, f, r);
		}
		loadForeignModule(t, n, r) {
			const l = {
				host: gs(r, (o, u) => this._host.fhr(o, u)),
				getMirrorModels: () => this._getModels(),
			};
			return this._foreignModuleFactory
				? ((this._foreignModule = this._foreignModuleFactory(l, n)),
					Promise.resolve(Lt(this._foreignModule)))
	...
	(Ce._diffLimit = 1e5),
		...
		typeof importScripts == "function" && (globalThis.monaco = Di());
	let Zt = !1;
	function ya(e) {
		if (Zt) return;
		Zt = !0;
...
//# sourceMappingURL=editor.worker-C8ykIlSb.js.map
