...
const terminalConfiguration = {
  ...
  properties: {
    ...
    [
      ...
      markdownDescription: localize("terminal.integrated.customGlyphs", "Whether to draw custom glyphs for block element and box drawing characters instead of using the font, which typically yields better rendering with continuous lines. Note that this doesn't work when {0} is disabled.", `\`#${"terminal.integrated.gpuAcceleration"}#\``),
      type: "boolean",
      default: true
    },
    [
