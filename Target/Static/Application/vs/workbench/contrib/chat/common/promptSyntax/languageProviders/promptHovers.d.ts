...
export declare class PromptHoverProvider implements HoverProvider {
    ...
    constructor(promptsService: IPromptsService, languageModelToolsService: ILanguageModelToolsService, languageModelsService: ILanguageModelsService, chatModeService: IChatModeService);
    private createHover;
