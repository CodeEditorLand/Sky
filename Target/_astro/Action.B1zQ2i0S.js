const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"_astro/editor.main.CWPB94uA.js",
			"_astro/Editor.BgVRqB_U.js",
			"_astro/web.DQiSwLIO.js",
			"_astro/editor.CGcvjaqs.css",
			"_astro/Context.BGeE8JOf.js",
		]),
) => i.map((i) => d[i]);
import { _ as a } from "./Editor.BgVRqB_U.js";
...
const { editor: _, languages: d } = await a(
	() => import("./editor.main.CWPB94uA.js").then((t) => t.a),
