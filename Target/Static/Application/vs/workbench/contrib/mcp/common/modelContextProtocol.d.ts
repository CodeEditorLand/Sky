...
export declare namespace MCP {
     ...
     * @internal
     */
    interface URLElicitationRequiredError extends Omit<JSONRPCError, "error"> {
        error: Error & {
    ...
    /** @internal */
    type ServerResult = EmptyResult | InitializeResult | CompleteResult | GetPromptResult | ListPromptsResult | ListResourceTemplatesResult | ListResourcesResult | ReadResourceResult | CallToolResult | ListToolsResult | GetTaskResult | GetTaskPayloadResult | ListTasksResult | CancelTaskResult;
}
