const u = { context: void 0, registry: void 0 };
function C(e) {
	u.context = e;
}
function He() {
	return {
		...u.context,
		id: `${u.context.id}${u.context.count++}-`,
		count: 0,
	};
}
const pe = (e, t) => e === t,
...
function Ae(e, t, n) {
	...
	let l = null,
		...
		c = !1,
		a = "initialValue" in r,
		b = typeof s == "function" && O(s);
	const w = new Set(),
		[A, $] = (r.storage || N)(r.initialValue),
		[k, L] = N(void 0),
		[F, J] = N(void 0, { equals: !1 }),
		[ce, ae] = N(a ? "ready" : "unresolved");
	if (u.context) {
		f = `${u.context.id}${u.context.count++}`;
		let g;
	...
	function v(g, p, m, _) {
		return (
			l === g &&
				...
				(g === o || p === o) &&
					r.onHydrated &&
					queueMicrotask(() => r.onHydrated(_, { value: p })),
				(o = ee),
				_e(p, m)),
			p
		);
	...
	function z(g = !0) {
		...
		const m = o !== ee ? o : S(() => i(p, { value: A(), refetching: g }));
		return Ie(m)
			? ((l = m),
				"value" in m
					? (m.status === "success"
...
function ue(e, t) {
	...
	return { id: n, Provider: Ye(n), defaultValue: e };
}
function X(e) {
	return h && h.context && h.context[e.id] !== void 0
		? h.context[e.id]
		: e.defaultValue;
}
function Ee(e) {
...
function j(e, t) {
	...
	try {
		...
		n || (E = null), (x = null), Te(s);
	}
}
function Ke(e) {
	if ((x && (Pe(x), (x = null)), e)) return;
	const t = E;
	(E = null), t.length && j(() => me(t), !1);
}
function Pe(e) {
...
function Ze(e) {
	...
	const [o, f] = N(!1),
		...
		a = Ce();
	if (u.context && u.load) {
		const A = u.context.id + u.context.count;
		let $ = u.load(A);
		if (
			($ &&
				(typeof $ != "object" || $.status !== "success"
					? (i = $)
					: u.gather(A)),
			i && i !== "$$f")
		) {
			const [k, L] = N(void 0, { equals: !1 });
			(r = k),
				i.then(
					() => {
						if (u.done) return L();
...
const wt = Object.freeze(
	...
	tt = new Set(["innerHTML", "textContent", "innerText", "children"]),
	nt = Object.assign(Object.create(null), {
		className: "class",
		htmlFor: "for",
	}),
	...
	return (
		fe((r) => {
			(i = r),
				t === document
					? e()
					: gt(t, e(), t.firstChild ? null : void 0, n);
		}, s.owner),
		() => {
			i(), (t.textContent = "");
		}
...
function at(e, t, n = {}) {
	...
	for (r = 0, l = i.length; r < l; r++) {
		const o = i[r];
		!o || o === "undefined" || t[o] || (he(e, o, !1), delete n[o]);
	}
...
function At(e, t = {}, n, s) {
	...
	return (
		...
		T(() => (typeof t.ref == "function" ? ht(t.ref, e) : (t.ref = e))),
		T(() => yt(e, t, n, !0, i, !0)),
		i
	);
}
...
function yt(e, t, n, s, i = {}, r = !1) {
	t || (t = {});
	for (const l in i)
		if (!(l in t)) {
			if (l === "children") continue;
			i[l] = ge(e, l, null, i[l], n, r);
		}
	for (const l in t) {
		if (l === "children") continue;
		const o = t[l];
		i[l] = ge(e, l, o, i[l], n, r);
	}
}
function bt(e, t, n = {}) {
	(u.completed = globalThis._$HY.completed),
		...
		be(t, n.renderId);
	const s = lt(e, t, [...t.childNodes], n);
	return (u.context = null), s;
}
function St(e) {
	let t, n;
	return !u.context || !(t = u.registry.get((n = mt())))
		? e()
...
function ge(e, t, n, s, i, r) {
	let l, o, f, d, c;
	if (t === "style") return dt(e, n, s);
	if (t === "classList") return at(e, n, s);
	if (n === s) return s;
	if (t === "ref") r || n(e);
...
//# sourceMappingURL=web.Bb4_WBG9.js.map
