...
let MainThreadChatSessionItemController = class MainThreadChatSessionItemController2 extends Disposable {
  static {
    __name(this, "MainThreadChatSessionItemController");
  }
  constructor(proxy, chatSessionType, handle, chatService) {
    super();
...
let MainThreadChatSessions = class MainThreadChatSessions2 extends Disposable {
  ...
  constructor(_extHostContext, _agentSessionsService, _chatSessionsService, _chatService, _chatWidgetService, _chatTodoListService, _dialogService, _editorService, editorGroupService, _logService, _instantiationService) {
    super();
...
function warnOnUntitledSessionResource(resource) {
...
__name(warnOnUntitledSessionResource, "warnOnUntitledSessionResource");
export {
  MainThreadChatSessions,
