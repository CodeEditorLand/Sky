...
export declare class TelemetryService extends Disposable implements ITelemetryService {
    ...
    constructor(environmentService: INativeWorkbenchEnvironmentService, productService: IProductService, sharedProcessService: ISharedProcessService, storageService: IStorageService, configurationService: IConfigurationService, requestService: IRequestService);
