  ...
  _savePartsSplash() {
    ...
    this._partSplashService.saveWindowSplash({
      ...
      layoutInfo: !this._shouldSaveLayoutInfo() ? void 0 : {
        ...
        titleBarHeight: this._layoutService.isVisible("workbench.parts.titlebar", mainWindow) ? dom.getTotalHeight(assertReturnsDefined(this._layoutService.getContainer(
          mainWindow,
        ...
        ) ? dom.getTotalWidth(assertReturnsDefined(this._layoutService.getContainer(
          mainWindow,
          "workbench.parts.activitybar"
          /* Parts.ACTIVITYBAR_PART */
        ))) : 0,
        ...
        auxiliaryBarWidth: this._layoutService.isAuxiliaryBarMaximized() ? Number.MAX_SAFE_INTEGER : this._layoutService.isVisible(
        ...
        statusBarHeight: this._layoutService.isVisible("workbench.parts.statusbar", mainWindow) ? dom.getTotalHeight(assertReturnsDefined(this._layoutService.getContainer(
          mainWindow,
