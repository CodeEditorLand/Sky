...
class SplitEditorUpAction extends ExecuteCommandAction {
  ...
  static {
    this.LABEL = localize("splitEditorGroupUp", "Split Editor Up");
  }
  constructor() {
    super({
      id: SPLIT_EDITOR_UP,
...
class SplitEditorDownAction extends ExecuteCommandAction {
  ...
  static {
    this.LABEL = localize("splitEditorGroupDown", "Split Editor Down");
  }
  constructor() {
    super({
...
let CloseEditorAction = class CloseEditorAction2 extends Action {
  static {
  ...
  static {
    this.LABEL = localize("closeEditor", "Close Editor");
  }
...
let UnpinEditorAction = class UnpinEditorAction2 extends Action {
  static {
  ...
  static {
    this.LABEL = localize("unpinEditor", "Unpin Editor");
  }
  constructor(id, label, commandService) {
...
let CloseEditorTabAction = class CloseEditorTabAction2 extends Action {
  static {
  ...
  static {
    this.LABEL = localize("closeOneEditor", "Close");
  }
...
class AbstractCloseAllAction extends Action2 {
  ...
  async run(accessor) {
    ...
    for (const { editor, groupId } of editorService.getEditors(1, { excludeSticky: this.excludeSticky })) {
      ...
      ) && filesConfigurationService.getAutoSaveMode(editor).mode === 3) {
        dirtyAutoSaveOnFocusChangeEditors.add({ editor, groupId });
      } else if (isNative && (isWindows || isLinux) && !editor.hasCapability(
        4
        /* EditorInputCapabilities.Untitled */
      ) && filesConfigurationService.getAutoSaveMode(editor).mode === 4) {
...
class CloseAllEditorsAction extends AbstractCloseAllAction {
  ...
  static {
    this.LABEL = localize2("closeAllEditors", "Close All Editors");
  }
  constructor() {
    super({
...
class CloseEditorsInOtherGroupsAction extends Action2 {
  ...
  async run(accessor, context) {
    ...
    await Promise.all(editorGroupService.getGroups(
      1
...
class MinimizeOtherGroupsAction extends Action2 {
  ...
  async run(accessor) {
    const editorGroupService = accessor.get(IEditorGroupsService);
    editorGroupService.arrangeGroups(
      1
      /* GroupsArrangement.EXPAND */
    );
  }
}
...
class NavigateForwardAction extends Action2 {
  ...
  static {
    this.LABEL = localize("navigateForward", "Go Forward");
  }
  constructor() {
    super({
      ...
      keybinding: {
        weight: 200,
        win: { primary: 512 | 17, secondary: [
          123
          /* KeyCode.BrowserForward */
        ] },
        mac: { primary: 256 | 1024 | 88, secondary: [
          123
          /* KeyCode.BrowserForward */
        ] },
        linux: { primary: 2048 | 1024 | 88, secondary: [
          123
          /* KeyCode.BrowserForward */
        ] }
      },
...
class NavigateBackwardsAction extends Action2 {
  ...
  static {
    this.LABEL = localize("navigateBack", "Go Back");
  }
  constructor() {
    super({
      ...
      keybinding: {
        weight: 200,
        win: { primary: 512 | 15, secondary: [
          122
          /* KeyCode.BrowserBack */
        ] },
        mac: { primary: 256 | 88, secondary: [
          122
          /* KeyCode.BrowserBack */
        ] },
        linux: { primary: 2048 | 512 | 88, secondary: [
          122
          /* KeyCode.BrowserBack */
        ] }
      },
...
class NavigatePreviousAction extends Action2 {
  ...
  async run(accessor) {
    const historyService = accessor.get(IHistoryService);
    await historyService.goPrevious(
      0
      /* GoFilter.NONE */
    );
  }
...
class ClearEditorHistoryWithoutConfirmAction extends Action2 {
  static {
    __name(this, "ClearEditorHistoryWithoutConfirmAction");
  }
  constructor() {
    super({
...
class MoveEditorToStartAction extends ExecuteCommandAction {
  static {
    __name(this, "MoveEditorToStartAction");
  }
  constructor() {
    super({
...
class MoveEditorToEndAction extends ExecuteCommandAction {
  static {
    __name(this, "MoveEditorToEndAction");
  }
  constructor() {
    super({
...
class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
  ...
  static {
    this.LABEL = localize("splitEditorToLeftGroup", "Split Editor into Left Group");
  }
  constructor() {
    super({
...
class AbstractCreateEditorGroupAction extends Action2 {
  ...
  async run(accessor) {
    ...
    const focusNewGroup = layoutService.hasFocus(
