const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"_astro/Context.BgTFgBDv.js",
			"_astro/Editor.CHcRbLoL.js",
			"_astro/solid.-melTDdq.js",
			"_astro/Context.B3qx4IKc.js",
			"_astro/Context.CHX42vij.js",
			"_astro/Context.BhUTlJ8-.js",
			"_astro/Anchor.DsugRIlK.js",
			"_astro/Merge.VBOSsp_p.js",
			"_astro/Button.79xLmvVJ.js",
			"_astro/Copy._WtbhJYu.js",
			"_astro/Copy.BCBGr1zU.css",
		]),
) => i.map((i) => d[i]);
import { _ as F } from "./Editor.CHcRbLoL.js";
import { e as K } from "./editor.main.Co7B9I8B.js";
import {
	createSignal as J,
	mergeProps as w,
	untrack as f,
...
`;
	...
	{ default: p } = await F(
		async () => {
			const { default: e } = await import("./Context.BgTFgBDv.js");
			return { default: e };
		},
	...
	{ default: V } = await F(
		async () => {
			const { default: e } = await import("./Context.B3qx4IKc.js");
			return { default: e };
		},
	...
	{ default: Pe } = await F(
		async () => {
			const { default: e } = await import("./Context.CHX42vij.js");
			return { default: e };
		},
	...
	{ default: R } = await F(
		async () => {
			const { default: e } = await import("./Context.BhUTlJ8-.js");
			return { default: e };
		},
	...
	{ default: Ve } = await F(
		async () => {
			const { default: e } = await import("./Anchor.DsugRIlK.js");
			return { default: e };
		},
	...
	{ default: je } = await F(
		async () => {
			const { default: e } = await import("./Button.79xLmvVJ.js");
			return { default: e };
		},
	...
	{ default: Be, Fn: Ke } = await F(
		async () => {
			const { default: e, Fn: t } = await import("./Copy._WtbhJYu.js");
	...
	{ default: U } = await F(
		async () => {
			const { default: e } = await import("./Merge.VBOSsp_p.js");
			return { default: e };
		},
...
//# sourceMappingURL=Editor.CaFSRIh9.js.map
