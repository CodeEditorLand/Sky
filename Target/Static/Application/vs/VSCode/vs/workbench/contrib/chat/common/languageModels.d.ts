...
export interface ILanguageModelChatProvider {
    ...
    sendChatRequest(modelId: string, messages: IChatMessage[], from: ExtensionIdentifier | undefined, options: {
        [name: string]: unknown;
...
export interface ILanguageModelChat {
    ...
    sendChatRequest(messages: IChatMessage[], from: ExtensionIdentifier | undefined, options: {
        [name: string]: unknown;
    }, token: CancellationToken): Promise<ILanguageModelChatResponse>;
...
export interface ILanguageModelsService {
    ...
    sendChatRequest(modelId: string, from: ExtensionIdentifier | undefined, messages: IChatMessage[], options: {
        [name: string]: any;
    }, token: CancellationToken): Promise<ILanguageModelChatResponse>;
