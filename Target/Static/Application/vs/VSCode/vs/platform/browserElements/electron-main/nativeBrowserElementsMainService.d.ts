...
export declare class NativeBrowserElementsMainService extends Disposable implements INativeBrowserElementsMainService {
    ...
    getFocusedElementData(windowId: number | undefined, rect: IRectangle, _token: CancellationToken, locator: IBrowserTargetLocator, _cancellationId?: number): Promise<IElementData | undefined>;
