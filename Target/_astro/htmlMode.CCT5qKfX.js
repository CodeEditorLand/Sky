import { m as lt } from "./editor.main.D0g8BD-5.js";
import "./Editor.BFvCNeGE.js";
import "./web.Bb4_WBG9.js"; /*!-----------------------------------------------------------------------------
		...
		if ((n && typeof n == "object") || typeof n == "function")
			for (let t of ht(n))
				!vt.call(e, t) &&
					...
					ft(e, t, {
						get: () => n[t],
						enumerable: !(r = gt(n, t)) || r.enumerable,
					});
		return e;
	},
	mt = (e, n, i) => (pt(e, n, "default"), i),
	c = {};
mt(c, lt);
var _t = 2 * 60 * 1e3,
	Qe = class {
...
(function (e) {
	...
	function i(r) {
		...
		return (
			(a.objectLiteral(t) &&
				b.is(t.position) &&
				(a.string(t.label) || a.typedArray(t.label, G.is)) &&
				(t.kind === void 0 || T.is(t.kind)) &&
				t.textEdits === void 0) ||
	...
	function r(o, s) {
		let u = o.getText(),
			f = t(s, (g, _) => {
				...
				return w === 0
					? g.range.start.character - _.range.start.character
					: w;
			}),
			d = u.length;
	...
	_doValidate(e, n) {
		this._worker(e)
			...
			.then((i) => {
				...
				t &&
					t.getLanguageId() === n &&
					c.editor.setModelMarkers(t, n, r);
			})
			.then(void 0, (i) => {
				console.error(i);
			});
...
function Rt(e) {
	if (e) return Array.isArray(e) ? e.map(Be) : [Be(e)];
}
var Je = class {
	constructor(e) {
		this._worker = e;
	...
	nt = class {
		...
		provideDocumentFormattingEdits(e, n, i) {
			...
			return this._worker(r).then((t) =>
				t.format(r.toString(), null, ot(n)).then((o) => {
	...
	it = class {
		...
		provideDocumentRangeFormattingEdits(e, n, i, r) {
			...
			return this._worker(t).then((o) =>
				o.format(t.toString(), Te(n), ot(i)).then((s) => {
...
var Ut = class {
		...
		provideColorPresentations(e, n, i) {
			...
			return this._worker(r)
				.then((t) =>
					t.getColorPresentations(r.toString(), n.color, Te(n.range)),
				)
				.then((t) => {
					if (t)
						return t.map((o) => {
				...
				.then((t) => {
					if (t)
						return t.map((o) => {
							...
							return (
								typeof o.kind < "u" && (s.kind = Ct(o.kind)), s
							);
						});
				});
		}
...
function Vt(e) {
	...
	let r = e.languageId;
	c.languages.registerCompletionItemProvider(r, new ut(i)),
		c.languages.registerHoverProvider(r, new Ge(i)),
		c.languages.registerDocumentHighlightProvider(r, new Je(i)),
		c.languages.registerLinkProvider(r, new rt(i)),
		c.languages.registerFoldingRangeProvider(r, new at(i)),
		c.languages.registerDocumentSymbolProvider(r, new Ke(i)),
		c.languages.registerSelectionRangeProvider(r, new st(i)),
		c.languages.registerRenameProvider(r, new Ze(i)),
		r === "html" &&
			(c.languages.registerDocumentFormattingEditProvider(r, new nt(i)),
...
function Wt(e) {
	...
	function o() {
		...
		ct(i),
			...
			u.hovers && i.push(c.languages.registerHoverProvider(s, new Ge(t))),
			u.documentHighlights &&
				i.push(
					c.languages.registerDocumentHighlightProvider(s, new Je(t)),
				),
			u.links && i.push(c.languages.registerLinkProvider(s, new rt(t))),
			u.documentSymbols &&
				i.push(
					c.languages.registerDocumentSymbolProvider(s, new Ke(t)),
				),
			u.rename &&
				i.push(c.languages.registerRenameProvider(s, new Ze(t))),
			u.foldingRanges &&
				i.push(c.languages.registerFoldingRangeProvider(s, new at(t))),
			u.selectionRanges &&
				i.push(
					c.languages.registerSelectionRangeProvider(s, new st(t)),
				),
...
export {
	...
	St as DefinitionAdapter,
	Nt as DiagnosticsAdapter,
	Ut as DocumentColorAdapter,
...
//# sourceMappingURL=htmlMode.CCT5qKfX.js.map
