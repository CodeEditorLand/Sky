...
class GhostTextWidgetWarning {
  static {
    __name(this, "GhostTextWidgetWarning");
  }
  static from(warning) {
    if (!warning) {
      return void 0;
...
let GhostTextView = class GhostTextView2 extends Disposable {
  ...
  constructor(_editor, _data, options, _languageService) {
    ...
    this._additionalLinesWidget = this._register(new AdditionalLinesWidget(this._editor, derivedOpts({ owner: this, equalsFn: equalsIfDefinedC(thisEqualsC()) }, (reader) => {
      const uiState = this._state.read(reader);
      return uiState ? new AdditionalLinesData(uiState.lineNumber, uiState.additionalLines, uiState.additionalReservedLineCount) : void 0;
...
class AdditionalLinesData {
  static {
    __name(this, "AdditionalLinesData");
  }
