...
class CellFocusIndicator extends CellContentPart {
  ...
  constructor(notebookEditor, titleToolbar, top, left, right, bottom) {
    ...
    this.right = right;
    this.bottom = bottom;
    this.codeFocusIndicator = new FastDomNode(DOM.append(this.left.domNode, DOM.$(".codeOutput-focus-indicator-container", void 0, DOM.$(".codeOutput-focus-indicator.code-focus-indicator"))));
    this.outputFocusIndicator = new FastDomNode(DOM.append(this.left.domNode, DOM.$(".codeOutput-focus-indicator-container", void 0, DOM.$(".codeOutput-focus-indicator.output-focus-indicator"))));
