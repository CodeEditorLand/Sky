import { h as F, r as I, c as d, S as L } from "./web.Bb4_WBG9.js";
var R =
	(t) =>
	(u, l, s, { client: a }) => {
				...
				const e = document.createTreeWalker(
					...
					(n) =>
						n === t
							...
							: n.nodeName === "ASTRO-SLOT"
								? NodeFilter.FILTER_ACCEPT
								: n.nodeName === "ASTRO-ISLAND"
		...
		const { default: f, ...E } = r,
			T = t.dataset.solidRenderId,
			N = c(
				() => {
					const e = () => d(u, { ...l, ...E, children: f });
					return i
						? d(L, {
								get children() {
									return e();
...
export { R as default };
//# sourceMappingURL=client.pEnc5leR.js.map
