...
(function(InlineChatConfigKeys2) {
  ...
  InlineChatConfigKeys2["HideOnRequest"] = "inlineChat.hideOnRequest";
...
const CTX_INLINE_CHAT_HAS_AGENT2 = new RawContextKey("inlineChatHasEditsAgent", false, localize("inlineChatHasEditsAgent", "Whether an agent for inliine for interactive editors exists"));
