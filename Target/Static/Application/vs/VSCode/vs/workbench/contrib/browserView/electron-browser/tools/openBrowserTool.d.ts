...
export declare const OpenPageToolId = "open_browser_page";
export declare const OpenBrowserToolData: IToolData;
export interface IOpenBrowserToolParams {
    url: string;
}
export declare class OpenBrowserTool implements IToolImpl {
