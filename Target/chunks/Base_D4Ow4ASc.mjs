...
const $$Base = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="en" class="no-js" dir="ltr">
	${renderComponent($$result, "Head", Head, {}, { "default": ($$result2) => renderTemplate`
		${renderComponent($$result2, "Meta", $$Meta, {})}

		<link rel="manifest" href="/site.webmanifest" crossorigin="use-credentials">

		

		${renderSlot($$result2, $$slots["StyleHead"])}

		${renderSlot($$result2, $$slots["ScriptHead"])}
	` })}
	${maybeRenderHead()}<body aria-label="">
		...
		${renderScript($$result, "D:/Developer/Application/CodeEditorLand/EcoSystem/Elements/Sky/Source/Function/Markup/Base.astro?astro&type=script&index=0&lang.ts")}
	</body>
</html>`;
}, "D:/Developer/Application/CodeEditorLand/EcoSystem/Elements/Sky/Source/Function/Markup/Base.astro", void 0);

export { $$Base as $ };
//# sourceMappingURL=Base_D4Ow4ASc.mjs.map
