import { c as createComponent, s as spreadAttributes, b as renderSlotToString, d as renderAllHeadContent, u as unescapeHTML, e as createAstro, r as renderTemplate, f as addAttribute, g as renderScript, a as renderComponent, m as maybeRenderHead, h as renderSlot } from './astro/server_CrPdPs7a.mjs';
import 'kleur/colors';
...
const $$Astro$1 = createAstro("http://localhost");
const $$ViewTransitions = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$ViewTransitions;
  const { fallback = "animate" } = Astro2.props;
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "D:/Developer/Application/CodeEditorLand/EcoSystem/node_modules/astro/components/ViewTransitions.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/Developer/Application/CodeEditorLand/EcoSystem/node_modules/astro/components/ViewTransitions.astro", void 0);

const $$Astro = createAstro("http://localhost");
const $$Base = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Base;
  const {
    Title = "\u{1F30C}\u2001Sky\u2001\u2014",
    Description = "The sky is a dynamic container for rendering views from frameworks like SolidJS and React."
  } = Astro2.props;
  return renderTemplate`<html lang="en" class="no-js" dir="ltr"> ${renderComponent($$result, "Head", Head, {}, { "default": ($$result2) => renderTemplate`${renderScript($$result2, "D:/Developer/Application/CodeEditorLand/EcoSystem/Elements/Sky/Source/Layout/Base.astro?astro&type=script&index=0&lang.ts")}<title>${Title}</title><meta charset="utf-8"><meta name="description"${addAttribute(Description, "content")}><meta name="viewport" content="width=device-width,initial-scale=1.0"><meta name="theme-color" content="#ffffff"><meta name="format-detection" content="telephone=no"><meta name="twitter:dnt" content="on"><link rel="preconnect" href="https://fonts.googleapis.com" crossorigin><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link rel="manifest" href="/site.webmanifest" crossorigin="use-credentials">${renderComponent($$result2, "ViewTransitions", $$ViewTransitions, {})}` })}${maybeRenderHead()}<body> <div class="grow" id="swup"> ${renderSlot($$result, $$slots["default"])} </div> </body></html>`;
}, "D:/Developer/Application/CodeEditorLand/EcoSystem/Elements/Sky/Source/Layout/Base.astro", void 0);

export { $$Base as $ };
//# sourceMappingURL=Base_CjG9Jtey.mjs.map
