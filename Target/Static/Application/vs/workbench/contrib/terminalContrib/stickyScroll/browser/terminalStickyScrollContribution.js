...
let TerminalStickyScrollContribution = class TerminalStickyScrollContribution2 extends Disposable {
  ...
  _tryEnable() {
    if (this._shouldBeEnabled()) {
      ...
      this._overlay.value = this._instantiationService.createInstance(TerminalStickyScrollOverlay, this._ctx.instance, this._xterm, this._instantiationService.createInstance(TerminalInstanceColorProvider, this._ctx.instance.targetRef), this._ctx.instance.capabilities.get(
        2
