...
let MultiDiffEditorInput = class MultiDiffEditorInput2 extends EditorInput {
  static {
  ...
  static fromSerialized(data, instantiationService) {
    return instantiationService.createInstance(MultiDiffEditorInput_1, URI.parse(data.multiDiffSourceUri), data.label, data.resources?.map((resource) => new MultiDiffEditorItem(resource.originalUri ? URI.parse(resource.originalUri) : void 0, resource.modifiedUri ? URI.parse(resource.modifiedUri) : void 0, resource.goToFileUri ? URI.parse(resource.goToFileUri) : void 0)), false);
  }
  static {
...
let MultiDiffEditorResolverContribution = class MultiDiffEditorResolverContribution2 extends Disposable {
  static {
