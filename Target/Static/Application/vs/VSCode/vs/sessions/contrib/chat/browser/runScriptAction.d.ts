...
export declare class RunScriptContribution extends Disposable implements IWorkbenchContribution {
    ...
    constructor(_activeSessionService: ISessionsManagementService, _keybindingService: IKeybindingService, _quickInputService: IQuickInputService, _sessionsConfigService: ISessionsConfigurationService);
