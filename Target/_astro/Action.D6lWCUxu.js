const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"_astro/editor.main.CwGewecy.js",
			"_astro/Editor.CqBgoZbz.js",
			"_astro/web.Bb4_WBG9.js",
			"_astro/editor.Cp6PkmXt.css",
			"_astro/Context.DI5GpdXg.js",
		]),
) => i.map((i) => d[i]);
import { _ as a } from "./Editor.CqBgoZbz.js";
...
const { editor: _, languages: d } = await a(
	() => import("./editor.main.CwGewecy.js").then((t) => t.a),
