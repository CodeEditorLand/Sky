		...
		if ((n && typeof n == "object") || typeof n == "function")
			for (let t of nt(n))
				!it.call(e, t) &&
					...
					tt(e, t, {
						get: () => n[t],
						enumerable: !(r = rt(n, t)) || r.enumerable,
					});
		return e;
	},
	at = (e, n, i) => (ot(e, n, "default"), i),
	d = {};
at(d, et);
var st = 2 * 60 * 1e3,
	ut = class {
	...
	Pt = class {
		...
		provideDocumentFormattingEdits(e, n, i) {
			...
			return this._worker(r).then((t) =>
				t.format(r.toString(), null, Ye(n)).then((o) => {
	...
	Dt = class {
		...
		provideDocumentRangeFormattingEdits(e, n, i, r) {
			...
			return this._worker(t).then((o) =>
				o.format(t.toString(), Qe(n), Ye(i)).then((s) => {
...
var Mt = class {
		...
		provideColorPresentations(e, n, i) {
			...
			return this._worker(r)
				.then((t) =>
					t.getColorPresentations(r.toString(), n.color, Qe(n.range)),
				)
				.then((t) => {
					if (t)
						return t.map((o) => {
				...
				.then((t) => {
					if (t)
						return t.map((o) => {
							...
							return (
								typeof o.kind < "u" && (s.kind = yt(o.kind)), s
							);
						});
				});
		}
	...
	function o() {
		...
		Ze(i),
			...
			u.documentHighlights &&
				i.push(
					d.languages.registerDocumentHighlightProvider(s, new wt(t)),
				),
			u.definitions &&
			...
			u.documentSymbols &&
				i.push(
					d.languages.registerDocumentSymbolProvider(s, new At(t)),
				),
			u.rename &&
				i.push(d.languages.registerRenameProvider(s, new Et(t))),
			...
			u.selectionRanges &&
				i.push(
					d.languages.registerSelectionRangeProvider(s, new Ft(t)),
				),
...
//# sourceMappingURL=cssMode.DdJ1AAON.js.map
