...
let TerminalLinkManager = class TerminalLinkManager2 extends DisposableStore {
  ...
  constructor(_xterm, _processInfo, capabilities, _linkResolver, _configurationService, _instantiationService, notificationService, _telemetryService, terminalConfigurationService, _logService, _tunnelService) {
    ...
    this._openers.set("LocalFolderOutsideWorkspace", localFolderOutsideWorkspaceOpener);
    ...
    this._openers.set("Url", this._instantiationService.createInstance(TerminalUrlLinkOpener, !!this._processInfo.remoteAuthority, localFileOpener, localFolderInWorkspaceOpener, localFolderOutsideWorkspaceOpener));
    ...
    this._xterm.options.linkHandler = {
      ...
      activate: /* @__PURE__ */ __name(async (event, text) => {
