...
const $$Editor = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Base, { "Font": ["/Font/AlbertSans/800.css"] }, { "default": ($$result2) => renderTemplate`
...
//# sourceMappingURL=Editor_BguiaikP.mjs.map
