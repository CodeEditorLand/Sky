...
class EditorFindAccessibilityHelp {
  static {
    __name(this, "EditorFindAccessibilityHelp");
  }
  constructor() {
    this.priority = 105;
...
class EditorFindAccessibilityHelpProvider extends Disposable {
  static {
    __name(this, "EditorFindAccessibilityHelpProvider");
  }
  constructor(_findController) {
    super();
    this._findController = _findController;
    this.id = "editorFindHelp";
  ...
  provideContent() {
    ...
    if (isReplaceVisible) {
      ...
      if (searchString) {
        ...
        if (matchCount !== void 0 && matchPosition !== void 0) {
          if (matchCount === 0) {
