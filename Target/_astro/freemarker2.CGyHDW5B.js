import { m as f } from "./editor.main.D0g8BD-5.js";
		...
		if ((n && typeof n == "object") || typeof n == "function")
			for (let o of x(n))
				!$.call(t, o) &&
					...
					F(t, o, {
						get: () => n[o],
						enumerable: !(e = b(n, o)) || e.enumerable,
					});
		return t;
	},
	E = (t, n, _) => (v(t, n, "default"), _),
	r = {};
E(r, f);
var d = [
		"assign",
...
var T = { conf: l(a), language: i(a, k) },
	h = { conf: l(u), language: i(u, k) },
	S = { conf: l(a), language: i(a, p) },
	P = { conf: l(u), language: i(u, p) },
	y = { conf: g(), language: A(k) },
	I = { conf: g(), language: A(p) };
export {
	S as TagAngleInterpolationBracket,
	T as TagAngleInterpolationDollar,
	I as TagAutoInterpolationBracket,
	y as TagAutoInterpolationDollar,
	P as TagBracketInterpolationBracket,
	h as TagBracketInterpolationDollar,
};
//# sourceMappingURL=freemarker2.CGyHDW5B.js.map
