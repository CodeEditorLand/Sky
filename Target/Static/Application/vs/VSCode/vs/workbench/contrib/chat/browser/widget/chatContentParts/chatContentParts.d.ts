...
export declare class InlineTextModelCollection extends Disposable {
    ...
    acquire(uri: URI, value: string, languageSelection: ILanguageSelection | null, isForSimpleWidget: boolean): import("../../../../../../base/common/lifecycle.js").IReference<ITextModel>;
}
