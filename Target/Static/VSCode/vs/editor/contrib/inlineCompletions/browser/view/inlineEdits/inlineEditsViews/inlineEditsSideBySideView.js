...
let InlineEditsSideBySideView = class extends Disposable {
  ...
  previewEditor = this._register(this._instantiationService.createInstance(
  ...
  _previewEditorObs = observableCodeEditor(this.previewEditor);
  _activeViewZones = [];
  ...
  _originalDisplayRange = this._uiState.map((s) => s?.originalDisplayRange);
  ...
  _originalBackgroundColor = observableFromEvent(this, this._themeService.onDidColorThemeChange, () => {
