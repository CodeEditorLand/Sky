...
declare const enum ChangesVersionMode {
...
export declare class ChangesViewPane extends ViewPane {
    ...
    private readonly versionModeObs;
    private readonly versionModeContextKey;
